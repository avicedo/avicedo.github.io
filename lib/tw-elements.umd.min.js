...
(function (B, _t) {
  typeof exports == "object" && typeof module < "u"
    ...
    ? define(["exports"], _t)
    : ((B = typeof globalThis < "u" ? globalThis : B || self), _t((B.te = {})));
})(this, function (B) {
  "use strict";
  var ED = Object.defineProperty;
  var CD = (B, _t, M) =>
    _t in B
      ? ED(B, _t, { enumerable: !0, configurable: !0, writable: !0, value: M })
      : (B[_t] = M);
  var we = (B, _t, M) => (CD(B, typeof _t != "symbol" ? _t + "" : _t, M), M);
  const _t = (() => {
      const i = {};
      let t = 1;
      return {
        set(e, s, n) {
          typeof e[s] > "u" && ((e[s] = { key: s, id: t }), t++),
            (i[e[s].id] = n);
        },
        get(e, s) {
    ...
    R_ = (i) =>
      i == null
        ...
        : {}.toString
            ...
            .toLowerCase(),
    Gt = (i) => {
      do i += Math.floor(Math.random() * L_);
    ...
    P_ = (i) => {
      ...
      return !s && !n
        ...
        : ((t = t.split(",")[0]),
          (e = e.split(",")[0]),
          (Number.parseFloat(t) + Number.parseFloat(e)) * $_);
    },
    rc = (i) => {
      i.dispatchEvent(new Event(Rr));
    },
    Ni = (i) =>
      !i || typeof i != "object"
        ? !1
        : (typeof i.jquery < "u" && (i = i[0]), typeof i.nodeType < "u"),
    Ne = (i) =>
      Ni(i)
        ? i.jquery
          ? i[0]
    ...
    oe = (i) => {
      ...
      if (i.style && i.parentNode && i.parentNode.style) {
        const t = getComputedStyle(i),
          e = getComputedStyle(i.parentNode);
        return (
    ...
    hc = (i, t, e = !0) => {
      ...
      let o = !1;
      const r = ({ target: a }) => {
        a === t && ((o = !0), t.removeEventListener(Rr, r), ai(i));
      };
      t.addEventListener(Rr, r),
        setTimeout(() => {
          o || rc(t);
        }, n);
    },
    ...
    Br = {};
  let uc = 1;
  const W_ = { mouseenter: "mouseover", mouseleave: "mouseout" },
    V_ = /^(mouseenter|mouseleave)/i,
    pc = new Set([
      "click",
      "dblclick",
      "mouseup",
  ...
  function fc(i, t) {
    return (t && `${t}::${uc++}`) || i.uidEvent || uc++;
  }
  function _c(i) {
    const t = fc(i);
    return (i.uidEvent = t), (Br[t] = Br[t] || {}), Br[t];
  }
  function z_(i, t) {
    return function e(s) {
      return (
        (s.delegateTarget = i), e.oneOff && g.off(i, s.type, t), t.apply(i, [s])
      );
    };
  }
  function Y_(i, t, e) {
  ...
  function mc(i, t, e) {
    const s = typeof t == "string",
      n = s ? e : t;
    let o = vc(i);
    return pc.has(o) || (o = i), [s, n, o];
  }
  function bc(i, t, e, s, n) {
    if (typeof t != "string" || !i) return;
    if ((e || ((e = s), (s = null)), V_.test(t))) {
      const p = (f) =>
        function (b) {
          if (
            !b.relatedTarget ||
  ...
  function j_(i, t, e, s) {
    ...
    Object.keys(n).forEach((o) => {
      if (o.includes(s)) {
        const r = n[o];
        Hr(i, t, e, r.originalHandler, r.delegationSelector);
      }
    });
  }
  function vc(i) {
    return (i = i.replace(H_, "")), W_[i] || i;
  }
  const g = {
      on(i, t, e, s) {
        bc(i, t, e, s, !1);
      ...
      off(i, t, e, s) {
        ...
        Object.keys(h).forEach((d) => {
          const u = d.replace(F_, "");
          if (!a || t.includes(u)) {
            const p = h[d];
            Hr(i, l, r, p.originalHandler, p.delegationSelector);
          }
        });
      },
      trigger(i, t, e) {
    ...
    li = {
      on(i, t, e, s) {
        const n = t.split(" ");
        for (let o = 0; o < n.length; o++) g.on(i, n[o], e, s);
      },
      off(i, t, e, s) {
        const n = t.split(" ");
        for (let o = 0; o < n.length; o++) g.off(i, n[o], e, s);
      },
    },
    K_ = "5.1.3";
  class qt {
    constructor(t) {
      (t = Ne(t)),
        t &&
          ((this._element = t),
          M.setData(this._element, this.constructor.DATA_KEY, this));
    }
    dispose() {
    ...
    static getInstance(t) {
      return M.getData(Ne(t), this.DATA_KEY);
    }
  ...
  class Wn extends qt {
    ...
    toggle() {
      this._element.setAttribute(
        "aria-pressed",
        this._element.classList.toggle(X_)
      );
    }
  ...
  var gt = "top",
    ...
    Wi = "popper",
    xc = "reference",
    Wr = Hi.reduce(function (i, t) {
      return i.concat([t + "-" + ci, t + "-" + Fi]);
    }, []),
    Vr = [].concat(Hi, [ws]).reduce(function (i, t) {
      return i.concat([t, t + "-" + ci, t + "-" + Fi]);
    }, []),
    Tc = "beforeRead",
    Ec = "read",
    Cc = "afterRead",
    ...
    return (
      ...
      function () {
        Object.keys(t.elements).forEach(function (s) {
          var n = t.elements[s],
            o = t.attributes[s] || {},
            r = Object.keys(t.styles.hasOwnProperty(s) ? t.styles[s] : e[s]),
  ...
  function zi(i, t, e) {
    ...
    t &&
      Mt(i) &&
      ((n = (i.offsetWidth > 0 && Vi(s.width) / i.offsetWidth) || 1),
      (o = (i.offsetHeight > 0 && Vi(s.height) / i.offsetHeight) || 1));
    var r = hi(i) ? It(i) : window,
      a = r.visualViewport,
      l = !Ic() && e,
      c = (s.left + (l && a ? a.offsetLeft : 0)) / n,
      h = (s.top + (l && a ? a.offsetTop : 0)) / o,
      d = s.width / n,
      u = s.height / o;
    return {
      width: d,
  ...
  function Kr(i) {
    ...
    return (
      ...
      { x: i.offsetLeft, y: i.offsetTop, width: e, height: s }
    );
  }
  function Mc(i, t) {
  ...
  function Qt(i) {
    return It(i).getComputedStyle(i);
  }
  function Z_(i) {
    return ["table", "td", "th"].indexOf(re(i)) >= 0;
  }
  function Be(i) {
    return (
      (hi(i) ? i.ownerDocument : i.document) || window.document
    ).documentElement;
  }
  function Yn(i) {
    return re(i) === "html"
      ? i
      : i.assignedSlot || i.parentNode || (zr(i) ? i.host : null) || Be(i);
  }
  function Lc(i) {
    return !Mt(i) || Qt(i).position === "fixed" ? null : i.offsetParent;
  }
  function Q_(i) {
  ...
  function ks(i) {
    for (var t = It(i), e = Lc(i); e && Z_(e) && Qt(e).position === "static"; )
      e = Lc(e);
    return e &&
      (re(e) === "html" || (re(e) === "body" && Qt(e).position === "static"))
      ? t
      : e || Q_(i) || t;
  }
  function Ur(i) {
  ...
  function ng(i, t) {
    ...
    return { x: Vi(e * n) / n || 0, y: Vi(s * n) / n || 0 };
  }
  function Bc(i) {
    var t,
      e = i.popper,
    ...
    if (c) {
      ...
      if (
        ...
        (b -= k - s.height), (b *= l ? 1 : -1);
      }
      if (n === mt || ((n === gt || n === Ot) && o === Fi)) {
        E = Dt;
        var D =
          d && A === C && C.visualViewport ? C.visualViewport.width : A[S];
        (p -= D - s.width), (p *= l ? 1 : -1);
      }
    }
    var O = Object.assign({ position: a }, c && sg),
      I = h === !0 ? ng({ x: p, y: b }, It(e)) : { x: p, y: b };
    if (((p = I.x), (b = I.y), l)) {
      var R;
...
`,
  ...
  function rg(i) {
    var t = i.state,
      ...
      r = s.resize,
      a = r === void 0 ? !0 : r,
      l = It(t.elements.popper),
      c = [].concat(t.scrollParents.reference, t.scrollParents.popper);
    return (
      o &&
        c.forEach(function (h) {
          h.addEventListener("scroll", e.update, jn);
        }),
      a && l.addEventListener("resize", e.update, jn),
      function () {
        o &&
          c.forEach(function (h) {
            h.removeEventListener("scroll", e.update, jn);
          }),
          a && l.removeEventListener("resize", e.update, jn);
      }
    );
  }
  const Gr = {
  ...
  var ag = { left: "right", right: "left", bottom: "top", top: "bottom" };
  function Kn(i) {
    return i.replace(/left|right|bottom|top/g, function (t) {
      return ag[t];
    });
  }
  var lg = { start: "end", end: "start" };
  function Hc(i) {
  ...
  function Zr(i) {
    return zi(Be(i)).left + qr(i).scrollLeft;
  }
  function cg(i, t) {
    var e = It(i),
      s = Be(i),
    ...
    return { width: o, height: r, x: a + Zr(i), y: l };
  }
  function hg(i) {
    var t,
      e = Be(i),
      ...
      l = -s.scrollTop;
    return (
      Qt(n || e).direction === "rtl" &&
        (a += di(e.clientWidth, n ? n.clientWidth : 0) - o),
  ...
  function Fc(i) {
    return ["html", "body", "#document"].indexOf(re(i)) >= 0
  ...
  function Os(i, t) {
    ...
    t === void 0 && (t = []);
    var s = Fc(i),
      n = s === ((e = i.ownerDocument) == null ? void 0 : e.body),
      o = It(s),
      r = n ? [o].concat(o.visualViewport || [], Qr(s) ? s : []) : s,
      a = t.concat(r);
    return n ? a : a.concat(Os(Yn(r)));
  }
  function Jr(i) {
  ...
  function Wc(i, t, e) {
    return t === Fr ? Jr(cg(i, e)) : hi(t) ? dg(t, e) : Jr(hg(Be(i)));
  }
  function ug(i) {
    var t = Os(Yn(i)),
      e = ["absolute", "fixed"].indexOf(Qt(i).position) >= 0,
      s = e && Mt(i) ? ks(i) : i;
    return hi(s)
      ? t.filter(function (n) {
          return hi(n) && Mc(n, s) && re(n) !== "body";
        })
      : [];
  }
  function pg(i, t, e, s) {
    var n = t === "clippingParents" ? ug(i) : [].concat(t),
      o = [].concat(n, [e]),
      r = o[0],
      a = o.reduce(function (l, c) {
        var h = Wc(i, c, s);
        return (
          (l.top = di(h.top, l.top)),
          (l.right = zn(h.right, l.right)),
          (l.bottom = zn(h.bottom, l.bottom)),
          (l.left = di(h.left, l.left)),
          l
        );
      }, Wc(i, r, s));
    return (
  ...
  function ji(i, t) {
    ...
    var e = t,
      ...
      b = e.padding,
      v = b === void 0 ? 0 : b,
      y = Rc(typeof v != "number" ? v : Pc(v, Hi)),
      x = u === Wi ? xc : Wi,
      E = i.rects.popper,
      T = i.elements[f ? x : u],
      C = pg(hi(T) ? T : T.contextElement || Be(i.elements.popper), l, h, r),
      A = zi(i.elements.reference),
      w = Vc({ reference: A, element: E, strategy: "absolute", placement: n }),
      S = Jr(Object.assign({}, E, w)),
      k = u === Wi ? S : A,
      D = {
    ...
    if (u === Wi && O) {
      ...
      Object.keys(D).forEach(function (R) {
        var X = [Dt, Ot].indexOf(R) >= 0 ? 1 : -1,
          $ = [gt, Ot].indexOf(R) >= 0 ? "y" : "x";
        D[R] += I[$] * X;
      });
    }
    return D;
    ...
    if (!t.modifiersData[s]._skip) {
      for (
        var n = e.mainAxis,
          ...
          x = y === v,
          E = l || (x || !f ? [Kn(v)] : _g(v)),
          T = [v].concat(E).reduce(function (Ae, Xt) {
            return Ae.concat(
              Zt(Xt) === ws
                ? fg(t, {
                    placement: Xt,
        ...
        if (
          (o && se.push(z[I] <= 0),
          a && se.push(z[j] <= 0, z[Kt] <= 0),
          se.every(function (Ae) {
            return Ae;
          }))
        ) {
          (k = O), (S = !1);
      ...
      if (S)
        for (
          var ne = f ? 3 : 1,
            oi = function (Xt) {
              var Re = T.find(function (Lr) {
                var Ri = w.get(Lr);
                if (Ri)
                  return Ri.slice(0, Xt).every(function (ic) {
                    return ic;
                  });
              });
      ...
      t.placement !== k &&
        ((t.modifiersData[s]._skip = !0), (t.placement = k), (t.reset = !0));
    }
  }
  const zc = {
    name: "flip",
  ...
  function jc(i) {
    return [gt, Dt, Ot, mt].some(function (t) {
      return i[t] >= 0;
    });
  }
  function mg(i) {
    var t = i.state,
      ...
      r = ji(t, { elementContext: "reference" }),
      a = ji(t, { altBoundary: !0 }),
      l = Yc(r, s),
      c = Yc(a, n, o),
      h = jc(l),
      d = jc(c);
  ...
  function bg(i, t, e) {
    ...
    return (
      (r = r || 0),
      (a = (a || 0) * n),
      [mt, Dt].indexOf(s) >= 0 ? { x: a, y: r } : { x: r, y: a }
    );
  }
  function vg(i) {
    var t = i.state,
      ...
      n = e.offset,
      o = n === void 0 ? [0, 0] : n,
      r = Vr.reduce(function (h, d) {
        return (h[d] = bg(d, t.rects, o)), h;
      }, {}),
      a = r[t.placement],
      l = a.x,
      c = a.y;
  ...
  function Tg(i) {
    var t = i.state,
      ...
      f = e.tetherOffset,
      b = f === void 0 ? 0 : f,
      v = ji(t, { boundary: l, rootBoundary: c, padding: d, altBoundary: h }),
      y = Zt(t.placement),
      x = Yi(t.placement),
      E = !x,
      T = Ur(y),
    ...
    if (A) {
      if (o) {
        var R,
          ...
          Ut = x === ci ? -S[z] : -w[z],
          Ce = t.elements.arrow,
          Ae = p && Ce ? Kr(Ce) : { width: 0, height: 0 },
          Xt = t.modifiersData["arrow#persistent"]
          ...
          Ri = Ss(0, w[z], Ae[z]),
          ic = E
            ? w[z] / 2 - ne - Ri - Re - D.mainAxis
            : oi - Ri - Re - D.mainAxis,
          mD = E
            ? -w[z] / 2 + ne + Ri + Lr + D.mainAxis
            : Ut + Ri + Lr + D.mainAxis,
          sc = t.elements.arrow && ks(t.elements.arrow),
          bD = sc ? (T === "y" ? sc.clientTop || 0 : sc.clientLeft || 0) : 0,
          T_ = (R = O == null ? void 0 : O[T]) != null ? R : 0,
          vD = j + ic - T_ - bD,
          yD = j + mD - T_,
          E_ = Ss(p ? zn(Kt, vD) : Kt, j, p ? di(se, yD) : se);
        (A[T] = E_), (I[T] = E_ - j);
      }
      if (a) {
        var C_,
          ...
          A_ = Pi + v[xD],
          w_ = Pi - v[TD],
          nc = [gt, mt].indexOf(y) !== -1,
          k_ = (C_ = O == null ? void 0 : O[C]) != null ? C_ : 0,
          S_ = nc ? A_ : Pi - w[$r] - S[$r] - k_ + D.altAxis,
          O_ = nc ? Pi + w[$r] + S[$r] - k_ - D.altAxis : w_,
          D_ = p && nc ? J_(S_, Pi, O_) : Ss(p ? S_ : A_, Pi, p ? O_ : w_);
        (A[C] = D_), (I[C] = D_ - Pi);
      }
      t.modifiersData[s] = I;
    }
  ...
  function Cg(i) {
    return i === It(i) || !Mt(i) ? qr(i) : Eg(i);
  }
  function Ag(i) {
    var t = i.getBoundingClientRect(),
      e = Vi(t.width) / i.offsetWidth || 1,
      s = Vi(t.height) / i.offsetHeight || 1;
    return e !== 1 || s !== 1;
  }
  function wg(i, t, e) {
    e === void 0 && (e = !1);
    ...
    return (
      (s || (!s && !e)) &&
        ((re(t) !== "body" || Qr(o)) && (a = Cg(t)),
        Mt(t)
          ? ((l = zi(t, !0)), (l.x += t.clientLeft), (l.y += t.clientTop))
          : o && (l.x = Zr(o))),
      {
  ...
  function He(i) {
    for (
      var t = arguments.length, e = new Array(t > 1 ? t - 1 : 0), s = 1;
      s < t;
      s++
    )
      e[s - 1] = arguments[s];
    ...
    i.forEach(function (t) {
      []
        ...
        .forEach(function (e) {
          switch (e) {
            ...
            case "fn":
              typeof t.fn != "function" &&
                console.error(
                  He(ui, t.name, '"fn"', '"function"', '"' + String(t.fn) + '"')
                );
              break;
            case "effect":
              t.effect != null &&
          ...
          t.requires &&
            t.requires.forEach(function (s) {
              i.find(function (n) {
                return n.name === s;
              }) == null && console.error(He(Dg, String(t.name), s, s));
            });
        });
    });
  }
  ...
  function Un(i) {
    ...
    return function (a, l, c) {
      ...
      var h = {
        ...
        p = {
          ...
          setOptions: function (y) {
            ...
            b(),
              (h.options = Object.assign({}, o, h.options, x)),
              (h.scrollParents = {
                reference: hi(a)
                  ? Os(a)
                  : a.contextElement
            ...
            var E = Sg(Lg([].concat(s, h.options.modifiers)));
            if (
              ((h.orderedModifiers = E.filter(function (O) {
                return O.enabled;
              })),
              {}.NODE_ENV !== "production")
            ) {
              var T = Mg([].concat(E, h.options.modifiers), function (O) {
                var I = O.name;
                return I;
              });
              if ((Ig(T), Zt(h.options.placement) === ws)) {
                var C = h.orderedModifiers.find(function (O) {
                  var I = O.name;
                  return I === "flip";
                });
                C ||
          ...
          forceUpdate: function () {
            if (!u) {
              var y = h.elements,
                ...
                E = y.popper;
              if (!Qc(x, E)) {
                ({}).NODE_ENV !== "production" && console.error(qc);
                return;
              }
              (h.rects = {
                reference: wg(x, ks(E), h.options.strategy === "fixed"),
                popper: Kr(E),
              }),
                (h.reset = !1),
              ...
              for (var T = 0, C = 0; C < h.orderedModifiers.length; C++) {
      ...
      if (!Qc(a, l))
        return {}.NODE_ENV !== "production" && console.error(qc), p;
      ...
      function f() {
        h.orderedModifiers.forEach(function (v) {
          ...
          if (typeof T == "function") {
            var C = T({ state: h, name: y, instance: p, options: E }),
              A = function () {};
            d.push(C || A);
          }
        });
  ...
  var Rg = Un(),
    Pg = [Gr, ta, Xr, Yr],
    Ng = Un({ defaultModifiers: Pg }),
    Bg = [Gr, ta, Xr, Yr, Uc, zc, Xc, Nc, Kc],
    pi = Un({ defaultModifiers: Bg });
  ...
  const _ = {
    setDataAttribute(i, t, e) {
      i.setAttribute(`data-te-${ia(t)}`, e);
    },
    removeDataAttribute(i, t) {
      i.removeAttribute(`data-te-${ia(t)}`);
    },
    getDataAttributes(i) {
      if (!i) return {};
      const t = {};
    ...
    getDataAttribute(i, t) {
      return ea(i.getAttribute(`data-te-${ia(t)}`));
    },
    offset(i) {
    ...
    addClass(i, t) {
      sa(t).forEach((e) => !i.classList.contains(e) && i.classList.add(e));
    },
    addStyle(i, t) {
    ...
    removeClass(i, t) {
      sa(t).forEach((e) => i.classList.contains(e) && i.classList.remove(e));
    },
    hasClass(i, t) {
  ...
  const Hg = 3,
    m = {
      ...
      parents(i, t) {
        const e = [];
        let s = i.parentNode;
        for (; s && s.nodeType === Node.ELEMENT_NODE && s.nodeType !== Hg; )
      ...
      focusableChildren(i) {
        const t = [
          ...
          .join(", ");
        return this.find(t, i).filter((e) => !ri(e) && oe(e));
      },
    },
    na = "dropdown",
    fi = ".te.dropdown",
    ...
    Gg = "dropend",
    qg = "dropstart",
    Zg = "[data-te-navbar-ref]",
    qn = "[data-te-dropdown-toggle-ref]",
    aa = "[data-te-dropdown-menu-ref]",
    Qg = "[data-te-navbar-nav-ref]",
    Jg =
      "[data-te-dropdown-menu-ref] [data-te-dropdown-item-ref]:not(.disabled):not(:disabled)",
    tm = st() ? "top-end" : "top-start",
    em = st() ? "top-start" : "top-end",
    im = st() ? "bottom-end" : "bottom-start",
    sm = st() ? "bottom-start" : "bottom-end",
    nm = st() ? "left-start" : "right-start",
    om = st() ? "right-start" : "left-start",
    rm = [{ opacity: "0" }, { opacity: "1" }],
    am = [{ opacity: "1" }, { opacity: "0" }],
    Zn = { duration: 550, iterations: 1, easing: "ease", fill: "both" },
    lm = {
      offset: [0, 2],
  ...
  class Bt extends qt {
    constructor(t, e) {
      ...
      (this._animationCanPlay = this._config.dropdownAnimation === "on" && !s),
        (this._didInit = !1),
        this._init();
    }
    static get Default() {
    ...
    show() {
      if (ri(this._element) || this._isShown(this._menu)) return;
      const t = { relatedTarget: this._element };
      if (g.trigger(this._element, Yg, t).defaultPrevented) return;
      const s = Bt.getParentFromElement(this._element);
      this._inNavbar
        ? _.setDataAttribute(this._menu, "popper", "none")
        : this._createPopper(s),
        "ontouchstart" in document.documentElement &&
          !s.closest(Qg) &&
          []
            .concat(...document.body.children)
            .forEach((n) => g.on(n, "mouseover", Fn)),
        this._element.focus(),
        this._element.setAttribute("aria-expanded", !0),
        this._menu.setAttribute(`data-te-dropdown-${Fe}`, ""),
        this._animationCanPlay && this._menu.animate(rm, Zn),
        this._element.setAttribute(`data-te-dropdown-${Fe}`, ""),
        setTimeout(
          () => {
            g.trigger(this._element, jg, t);
          },
          this._animationCanPlay ? Zn.duration : 0
        );
    }
    hide() {
      if (ri(this._element) || !this._isShown(this._menu)) return;
    ...
    _init() {
      this._didInit ||
        (g.on(document, ih, qn, Bt.dataApiKeydownHandler),
        g.on(document, ih, aa, Bt.dataApiKeydownHandler),
        g.on(document, Kg, Bt.clearMenus),
        g.on(document, Ug, Bt.clearMenus),
        (this._didInit = !0));
    }
    _completeHide(t) {
      (this._fadeOutAnimate && this._fadeOutAnimate.playState === "running") ||
        g.trigger(this._element, Vg, t).defaultPrevented ||
        ("ontouchstart" in document.documentElement &&
          []
            .concat(...document.body.children)
            .forEach((s) => g.off(s, "mouseover", Fn)),
        this._animationCanPlay &&
          (this._fadeOutAnimate = this._menu.animate(am, Zn)),
        setTimeout(
          () => {
            this._popper && this._popper.destroy(),
              this._menu.removeAttribute(`data-te-dropdown-${Fe}`),
              this._element.removeAttribute(`data-te-dropdown-${Fe}`),
              this._element.setAttribute("aria-expanded", "false"),
              _.removeDataAttribute(this._menu, "popper"),
              g.trigger(this._element, zg, t);
          },
          this._animationCanPlay ? Zn.duration : 0
        ));
    }
    _getConfig(t) {
      if (
        ...
        P(na, t, this.constructor.DefaultType),
    ...
    _createPopper(t) {
      ...
      this._config.reference === "parent"
        ? (e = t)
        : Ni(this._config.reference)
        ? (e = Ne(this._config.reference))
      ...
      (this._popper = pi(e, this._menu, s)),
        n && _.setDataAttribute(this._menu, "popper", "static");
    }
    _isShown(t = this._element) {
      return (
        t.dataset[`teDropdown${Fe.charAt(0).toUpperCase() + Fe.slice(1)}`] ===
        ""
      );
    }
    _getMenuElement() {
      return m.next(this._element, aa)[0];
    }
    _getPlacement() {
      const t = this._element.parentNode;
      if (t.dataset.teDropdownPosition === Gg) return nm;
      if (t.dataset.teDropdownPosition === qg) return om;
      const e =
        getComputedStyle(this._menu)
          .getPropertyValue("--te-position")
          .trim() === "end";
      return t.dataset.teDropdownPosition === Xg ? (e ? em : tm) : e ? sm : im;
    }
    _detectNavbar() {
      return this._element.closest(Zg) !== null;
    }
    _getOffset() {
    ...
    _selectMenuItem({ key: t, target: e }) {
      const s = m.find(Jg, this._menu).filter(oe);
      s.length && dc(s, e, t === Gn, !s.includes(e)).focus();
    }
    static jQueryInterface(t) {
      return this.each(function () {
    ...
    static clearMenus(t) {
      if (t && (t.button === Fg || (t.type === "keyup" && t.key !== eh)))
        return;
      const e = m.find(qn);
      for (let s = 0, n = e.length; s < n; s++) {
        const o = Bt.getInstance(e[s]);
    ...
    static dataApiKeydownHandler(t) {
      if (
        /input|textarea/i.test(t.target.tagName)
          ? t.key === th ||
            (t.key !== Xn &&
              ((t.key !== Gn && t.key !== ra) || t.target.closest(aa)))
          : !Wg.test(t.key)
      )
        return;
      const e =
        this.dataset[
          `teDropdown${Fe.charAt(0).toUpperCase() + Fe.slice(1)}`
        ] === "";
      if (
        (!e && t.key === Xn) ||
        (t.preventDefault(), t.stopPropagation(), ri(this))
      )
        return;
      const s = this.matches(qn) ? this : m.prev(this, qn)[0],
        n = Bt.getOrCreateInstance(s);
      if (t.key === Xn) {
        n.hide();
        return;
      }
      if (t.key === ra || t.key === Gn) {
        e || n.show(), n._selectMenuItem(t);
        return;
      }
      (!e || t.key === th) && Bt.clearMenus();
    }
  }
  const la = "collapse",
    sh = "te.collapse",
    Qn = `.${sh}`,
    nh = { toggle: !0, parent: null },
    hm = { toggle: "boolean", parent: "(null|element)" },
    dm = `show${Qn}`,
    um = `shown${Qn}`,
    pm = `hide${Qn}`,
    fm = `hidden${Qn}`,
    ca = "data-te-collapse-show",
    oh = "data-te-collapse-collapsed",
    Jn = "data-te-collapse-collapsing",
    _m = "data-te-collapse-horizontal",
    Ki = "data-te-collapse-item",
    rh = `:scope [${Ki}] [${Ki}]`,
    gm = "width",
    mm = "height",
    bm =
      "[data-te-collapse-item][data-te-collapse-show], [data-te-collapse-item][data-te-collapse-collapsing]",
    ah = "[data-te-collapse-init]",
    vm = {
      visible: "!visible",
      hidden: "hidden",
      baseTransition:
  ...
  class ae extends qt {
    constructor(t, e, s) {
      super(t),
        ...
        (this._config = this._getConfig(e)),
        (this._classes = this._getClasses(s)),
        (this._triggerArray = []);
      const n = m.find(ah);
    ...
    show() {
      ...
      if (this._config.parent) {
        const h = m.find(rh, this._config.parent);
        t = m.find(bm, this._config.parent).filter((d) => !h.includes(d));
      }
      const s = m.findOne(this._selector);
      if (t.length) {
        const h = t.find((d) => s !== d);
        if (((e = h ? ae.getInstance(h) : null), e && e._isTransitioning))
          return;
      }
      if (g.trigger(this._element, dm).defaultPrevented) return;
      t.forEach((h) => {
        s !== h && ae.getOrCreateInstance(h, { toggle: !1 }).hide(),
          e || M.setData(h, sh, null);
      });
      ...
      _.removeClass(this._element, this._classes.visible),
        _.removeClass(this._element, this._classes.hidden),
        _.addClass(this._element, r),
        this._element.removeAttribute(Ki),
        this._element.setAttribute(Jn, ""),
      ...
      const a = () => {
          (this._isTransitioning = !1),
            _.removeClass(this._element, this._classes.hidden),
            _.removeClass(this._element, r),
            _.addClass(this._element, this._classes.visible),
            this._element.removeAttribute(Jn),
            this._element.setAttribute(Ki, ""),
            this._element.setAttribute(ca, ""),
            (this._element.style[o] = ""),
            g.trigger(this._element, um);
        },
    ...
    hide() {
      if (
        ...
        !this._isShown() ||
        g.trigger(this._element, pm).defaultPrevented
      )
        return;
      ...
      const o = () => {
        (this._isTransitioning = !1),
          _.removeClass(this._element, s),
          _.addClass(this._element, this._classes.visible),
          _.addClass(this._element, this._classes.hidden),
          this._element.removeAttribute(Jn),
          this._element.setAttribute(Ki, ""),
          g.trigger(this._element, fm);
      };
      (this._element.style[e] = ""), this._queueCallback(o, this._element, !0);
    }
    _isShown(t = this._element) {
      return t.hasAttribute(ca);
    }
    _getConfig(t) {
      return (
        (t = { ...nh, ..._.getDataAttributes(this._element), ...t }),
        (t.toggle = !!t.toggle),
        (t.parent = Ne(t.parent)),
        P(la, t, hm),
        t
      );
    }
    _getClasses(t) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...vm, ...e, ...t }), P(la, t, ym), t;
    }
    _getDimension() {
      return this._element.hasAttribute(_m) ? gm : mm;
    }
    _initializeChildren() {
      if (!this._config.parent) return;
      const t = m.find(rh, this._config.parent);
      m.find(ah, this._config.parent)
    ...
    _addAriaAndCollapsedClass(t, e) {
      t.length &&
        t.forEach((s) => {
          e ? s.removeAttribute(oh) : s.setAttribute(`${oh}`, ""),
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        const s = ae.getOrCreateInstance(this, e);
        if (typeof t == "string") {
  ...
  const lh = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
    ch = ".sticky-top";
  class Ds {
    constructor() {
    ...
    hide() {
      ...
      this._disableOverFlow(),
        ...
        this._setElementAttributes(lh, "paddingRight", (e) => e + t),
        this._setElementAttributes(ch, "marginRight", (e) => e - t);
    }
    _disableOverFlow() {
    ...
    reset() {
      this._resetElementAttributes(this._element, "overflow"),
        ...
        this._resetElementAttributes(lh, "paddingRight"),
        this._resetElementAttributes(ch, "marginRight");
    }
    _saveInitialAttribute(t, e) {
      const s = t.style[e];
      s && _.setDataAttribute(t, e, s);
    }
    _resetElementAttributes(t, e) {
      const s = (n) => {
        const o = _.getDataAttribute(n, e);
        typeof o > "u"
          ? n.style.removeProperty(e)
          : (_.removeDataAttribute(n, e), (n.style[e] = o));
      };
      this._applyManipulationCallback(t, s);
    }
    _applyManipulationCallback(t, e) {
      Ni(t) ? e(t) : m.find(t, this._element).forEach(e);
    }
    isOverflowing() {
  ...
  class ha {
    ...
    show(t) {
      ...
      this._append(), this._config.isAnimated && Bi(this._getElement());
      ...
      _.removeClass(this._getElement(), "opacity-0"),
        _.addClass(this._getElement(), e),
    ...
    _getConfig(t) {
      return (
        (t = { ...xm, ...(typeof t == "object" ? t : {}) }),
        (t.rootElement = Ne(t.rootElement)),
        P(hh, t, Tm),
        t
      );
    }
    ...
    dispose() {
      this._isAppended &&
        (g.off(this._element, dh),
        this._element.remove(),
        (this._isAppended = !1));
    }
    _emulateAnimation(t) {
      hc(t, this._getElement(), this._config.isAnimated);
    }
  }
  class Is {
    constructor(t, e = {}, s) {
  ...
  const uh = "offcanvas",
    ...
    Em = `load${Ui}.data-api`,
    Cm = "Escape",
    ph = { backdrop: !0, keyboard: !0, scroll: !1 },
    Am = { backdrop: "boolean", keyboard: "boolean", scroll: "boolean" },
    fh = "show",
    wm = "[data-te-offcanvas-init][data-te-offcanvas-show]",
    km = `show${Ui}`,
    Sm = `shown${Ui}`,
    Om = `hide${Ui}`,
    Dm = `hidden${Ui}`,
    Im = `keydown.dismiss${Ui}`;
  class Ms extends qt {
    constructor(t, e) {
      super(t),
        (this._config = this._getConfig(e)),
    ...
    show(t) {
      if (
        this._isShown ||
        g.trigger(this._element, km, { relatedTarget: t }).defaultPrevented
      )
        return;
      (this._isShown = !0),
        (this._element.style.visibility = "visible"),
        this._backdrop.show(),
        this._config.scroll || new Ds().hide(),
        this._element.removeAttribute("aria-hidden"),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
        this._element.setAttribute(`data-te-offcanvas-${fh}`, "");
      const s = () => {
        this._config.scroll || this._focustrap.trap(),
          g.trigger(this._element, Sm, { relatedTarget: t });
      };
      this._queueCallback(s, this._element, !0);
    }
    hide() {
      if (!this._isShown || g.trigger(this._element, Om).defaultPrevented)
        return;
      this._focustrap.disable(),
        this._element.blur(),
        (this._isShown = !1),
        this._element.removeAttribute(`data-te-offcanvas-${fh}`),
        this._backdrop.hide();
      const e = () => {
        this._element.setAttribute("aria-hidden", !0),
          ...
          this._config.scroll || new Ds().reset(),
          g.trigger(this._element, Dm);
      };
    ...
    _init() {
      this._didInit ||
        (g.on(window, Em, () =>
          m.find(wm).forEach((t) => Ms.getOrCreateInstance(t).show())
        ),
        (this._didInit = !0));
    }
    _getConfig(t) {
    ...
    _initializeFocusTrap() {
      return new Is(this._element, {
        event: "keydown",
        condition: (t) => t.key === "Tab",
      });
    }
    _addEventListeners() {
      g.on(this._element, Im, (t) => {
        this._config.keyboard && t.key === Cm && this.hide();
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  const da = "alert",
    ...
    Mm = `close${_h}`,
    Lm = `closed${_h}`,
    Ls = "data-te-alert-show",
    $m = { animation: "boolean", autohide: "boolean", delay: "number" },
    gh = { animation: !0, autohide: !0, delay: 1e3 },
    Rm = {
      fadeIn:
    ...
    Pm = { fadeIn: "string", fadeOut: "string" };
  class to extends qt {
    constructor(t, e, s) {
      super(t),
        (this._element = t),
    ...
    close() {
      if (g.trigger(this._element, Mm).defaultPrevented) return;
      let e = 0;
      this._config.animation &&
        ((e = 300), _.addClass(this._element, this._classes.fadeOut)),
        this._element.removeAttribute(Ls),
        setTimeout(() => {
          this._queueCallback(
    ...
    show() {
      if (this._element) {
        if (
          ...
          !this._element.hasAttribute(Ls) &&
            (_.removeClass(this._element, "hidden"),
            _.addClass(this._element, "block"),
            oe(this._element)))
        ) {
          const t = (e) => {
            _.removeClass(this._element, "hidden"),
              _.addClass(this._element, "block"),
              g.off(e.target, "animationend", t);
          };
          this._element.setAttribute(Ls, ""),
            g.on(this._element, "animationend", t);
        }
        this._config.animation &&
          (_.removeClass(this._element, this._classes.fadeOut),
          _.addClass(this._element, this._classes.fadeIn));
      }
    }
    hide() {
      if (this._element && this._element.hasAttribute(Ls)) {
        this._element.removeAttribute(Ls);
        const t = (e) => {
          _.addClass(this._element, "hidden"),
            _.removeClass(this._element, "block"),
            this._timeout !== null &&
              (clearTimeout(this._timeout), (this._timeout = null)),
            g.off(e.target, "animationend", t);
        };
        g.on(this._element, "animationend", t),
          _.removeClass(this._element, this._classes.fadeIn),
          _.addClass(this._element, this._classes.fadeOut);
      }
    }
    _getConfig(t) {
      return (
        ...
        P(da, t, this.constructor.DefaultType),
        t
      );
    }
    _getClasses(t) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...Rm, ...e, ...t }), P(da, t, Pm), t;
    }
    _setupAutohide() {
    ...
    _destroyElement() {
      this._element.remove(), g.trigger(this._element, Lm), this.dispose();
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  const ua = "carousel",
    ...
    eb = `load${Lt}${mh}`,
    ib = `click${Lt}${mh}`,
    vh = "data-te-carousel-init",
    bi = "data-te-carousel-active",
    sb = "data-te-carousel-item-end",
    fa = "data-te-carousel-item-start",
    nb = "data-te-carousel-item-next",
    ob = "data-te-carousel-item-prev",
    rb = "data-te-carousel-pointer-event",
    ab = "[data-te-carousel-init]",
    yh = "[data-te-carousel-active]",
    _a = "[data-te-carousel-item]",
    Xi = `${yh}${_a}`,
    lb = `${_a} img`,
    cb = "[data-te-carousel-item-next], [data-te-carousel-item-prev]",
    hb = "[data-te-carousel-indicators]",
    db = "[data-te-target]",
    ub = "[data-te-slide], [data-te-slide-to]",
    pb = "touch",
    fb = "pen";
  class le extends qt {
    constructor(t, e, s) {
      super(t),
        ...
        (this._config = this._getConfig(e)),
        (this._classes = this._getClasses(s)),
        (this._indicatorsElement = m.findOne(hb, this._element)),
    ...
    pause(t) {
      t || (this._isPaused = !0),
        m.findOne(cb, this._element) && (rc(this._element), this.cycle(!0)),
    ...
    to(t) {
      this._activeElement = m.findOne(Xi, this._element);
      const e = this._getItemIndex(this._activeElement);
      if (t > this._items.length - 1 || t < 0) return;
      if (this._isSliding) {
        g.one(this._element, pa, () => this.to(t));
        return;
      }
      if (e === t) {
    ...
    _init() {
      this._didInit ||
        (g.on(document, ib, ub, le.dataApiClickHandler),
        g.on(window, eb, () => {
          const t = m.find(ab);
          for (let e = 0, s = t.length; e < s; e++)
            le.carouselInterface(t[e], le.getInstance(t[e]));
        }),
        (this._didInit = !0));
    }
    _getConfig(t) {
    ...
    _getClasses(t) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...Vm, ...e, ...t }), P(ua, t, zm), t;
    }
    _enableCycle() {
      if (this._config.ride) {
        if (this._isSliding) {
          g.one(this._element, pa, () => this.cycle());
          return;
        }
        this.cycle();
      }
    ...
    _applyInitialClasses() {
      const t = m.findOne(Xi, this._element);
    ...
    _handleSwipe() {
      ...
      (this.touchDeltaX = 0), e && this._slide(e > 0 ? $s : mi);
    }
    _setActiveElementClass() {
      (this._activeElement = m.findOne(Xi, this._element)),
        _.addClass(this._activeElement, "hidden");
    }
    _addEventListeners() {
      this._config.keyboard && g.on(this._element, Km, (t) => this._keydown(t)),
        this._config.pause === "hover" &&
          (g.on(this._element, Um, (t) => this.pause(t)),
          g.on(this._element, Xm, (t) => this._enableCycle(t))),
        this._config.touch &&
          this._touchSupported &&
    ...
    _addTouchEventListeners() {
      const t = (o) =>
          this._pointerEvent && (o.pointerType === fb || o.pointerType === pb),
        e = (o) => {
          t(o)
          ...
          t(o) && (this.touchDeltaX = o.clientX - this.touchStartX),
            ...
            this._config.pause === "hover" &&
              ...
              (this.touchTimeout = setTimeout(
                ...
                Hm + this._config.interval
              )));
        };
      m.find(lb, this._element).forEach((o) => {
        g.on(o, tb, (r) => r.preventDefault());
      }),
        this._pointerEvent
          ? (g.on(this._element, Qm, (o) => e(o)),
            g.on(this._element, Jm, (o) => n(o)),
            this._element.classList.add(this._classes.pointer),
            this._element.setAttribute(`${rb}`, ""))
          : (g.on(this._element, Gm, (o) => e(o)),
            g.on(this._element, qm, (o) => s(o)),
            g.on(this._element, Zm, (o) => n(o)));
    }
    _keydown(t) {
    ...
    _getItemIndex(t) {
      return (
        (this._items = t && t.parentNode ? m.find(_a, t.parentNode) : []),
        this._items.indexOf(t)
      );
    }
    _getItemByOrder(t, e) {
      const s = t === _i;
      return dc(this._items, e, s, this._config.wrap);
    }
    _triggerSlideEvent(t, e) {
      const s = this._getItemIndex(t),
        n = this._getItemIndex(m.findOne(Xi, this._element));
      return g.trigger(this._element, jm, {
        relatedTarget: t,
        direction: e,
        from: n,
        to: s,
    ...
    _setActiveIndicatorElement(t) {
      if (this._indicatorsElement) {
        const e = m.findOne(yh, this._indicatorsElement);
        e.removeAttribute(bi),
          e.removeAttribute("aria-current"),
          e.classList.remove("!opacity-100");
        const s = m.find(db, this._indicatorsElement);
        for (let n = 0; n < s.length; n++)
          if (
            Number.parseInt(s[n].getAttribute("data-te-slide-to"), 10) ===
            this._getItemIndex(t)
          ) {
            s[n].setAttribute(`${bi}`, ""),
              s[n].setAttribute("aria-current", "true"),
              s[n].classList.add("!opacity-100");
            break;
          }
      }
    }
    _updateInterval() {
      const t = this._activeElement || m.findOne(Xi, this._element);
      if (!t) return;
    ...
    _slide(t, e) {
      const s = this._directionToOrder(t),
        ...
        p = h === fa ? this._classes.slideLeft : this._classes.slideRight,
        f = h !== fa ? this._classes.slideLeft : this._classes.slideRight;
      if (r && r.hasAttribute(bi)) {
        this._isSliding = !1;
        return;
      }
      if (
      ...
      if (this._element.hasAttribute(vh)) {
        r.setAttribute(`${d}`, ""),
      ...
      } else n.removeAttribute(bi), n.classList.remove(this._classes.block), r.setAttribute(`${bi}`, ""), r.classList.add(this._classes.block), (this._isSliding = !1), v();
      l && this.cycle();
    }
    _directionToOrder(t) {
      return [$s, mi].includes(t)
        ? st()
          ? t === mi
            ? gi
            : _i
    ...
    static carouselInterface(t, e) {
      const s = le.getOrCreateInstance(t, e);
      let { _config: n } = s;
    ...
    static dataApiClickHandler(t) {
      const e = Pe(this);
      if (!e || !e.hasAttribute(vh)) return;
      const s = { ..._.getDataAttributes(e), ..._.getDataAttributes(this) },
        n = this.getAttribute("data-te-slide-to");
      n && (s.interval = !1),
        le.carouselInterface(e, s),
        n && le.getInstance(e).to(n),
        t.preventDefault();
    }
  }
  const ga = "modal",
    Jt = ".te.modal",
    xh = "Escape",
    Th = { backdrop: !0, keyboard: !0, focus: !0 },
    _b = {
    ...
    mb = { show: "string", static: "string", staticProperties: "string" },
    bb = `hide${Jt}`,
    vb = `hidePrevented${Jt}`,
    yb = `hidden${Jt}`,
    xb = `show${Jt}`,
    ...
    Eh = `resize${Jt}`,
    Ch = `click.dismiss${Jt}`,
    Ah = `keydown.dismiss${Jt}`,
    Eb = `mouseup.dismiss${Jt}`,
    wh = `mousedown.dismiss${Jt}`,
    kh = "data-te-modal-open",
    Sh = "data-te-open",
    Rs = "[data-te-modal-dialog-ref]",
    Cb = "[data-te-modal-body-ref]";
  class eo extends qt {
    constructor(t, e, s) {
      super(t),
        (this._config = this._getConfig(e)),
        (this._classes = this._getClasses(s)),
        (this._dialog = m.findOne(Rs, this._element)),
        (this._backdrop = this._initializeBackDrop()),
        (this._focustrap = this._initializeFocusTrap()),
        (this._isShown = !1),
        (this._ignoreBackdropClick = !1),
        (this._isTransitioning = !1),
        (this._scrollBar = new Ds());
    }
    static get Default() {
      return Th;
    }
    ...
    show(t) {
      this._isShown ||
        this._isTransitioning ||
        g.trigger(this._element, xb, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        this._isAnimated() && (this._isTransitioning = !0),
        this._scrollBar.hide(),
        document.body.setAttribute(kh, "true"),
        this._adjustDialog(),
        this._setEscapeEvent(),
        this._setResizeEvent(),
        g.on(this._dialog, wh, () => {
          g.one(this._element, Eb, (s) => {
    ...
    hide() {
      if (
        !this._isShown ||
        this._isTransitioning ||
        g.trigger(this._element, bb).defaultPrevented
      )
        return;
      this._isShown = !1;
      ...
      e && (this._isTransitioning = !0),
        ...
        this._setResizeEvent(),
        this._focustrap.disable(),
        m.findOne(Rs, this._element).classList.remove(this._classes.show),
        g.off(this._element, Ch),
        g.off(this._dialog, wh),
        this._queueCallback(() => this._hideModal(), this._element, e),
        this._element.removeAttribute(Sh);
    }
    dispose() {
      [window, this._dialog].forEach((t) => g.off(t, Jt)),
    ...
    _getClasses(t) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...gb, ...e, ...t }), P(ga, t, mb), t;
    }
    _showElement(t) {
      const e = this._isAnimated(),
        s = m.findOne(Cb, this._dialog);
      (!this._element.parentNode ||
        ...
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
        this._element.setAttribute(`${Sh}`, "true"),
        (this._element.scrollTop = 0);
      const n = m.findOne(Rs, this._element);
      ...
      const o = () => {
        this._config.focus && this._focustrap.trap(),
          (this._isTransitioning = !1),
          g.trigger(this._element, Tb, { relatedTarget: t });
      };
    ...
    _setEscapeEvent() {
      this._isShown
        ? g.on(document, Ah, (t) => {
            this._config.keyboard && t.key === xh
              ? (t.preventDefault(), this.hide())
              : !this._config.keyboard &&
                t.key === xh &&
                this._triggerBackdropTransition();
          })
        : g.off(this._element, Ah);
    }
    _setResizeEvent() {
      this._isShown
        ? g.on(window, Eh, () => this._adjustDialog())
        : g.off(window, Eh);
    }
    _hideModal() {
      const t = m.findOne(Rs, this._element);
      t.classList.remove(this._classes.show),
        ...
        (this._isTransitioning = !1),
        this._backdrop.hide(() => {
          document.body.removeAttribute(kh),
            this._resetAdjustments(),
            this._scrollBar.reset(),
            g.trigger(this._element, yb);
        });
    }
    _showBackdrop(t) {
      g.on(this._element, Ch, (e) => {
    ...
    _triggerBackdropTransition() {
      if (g.trigger(this._element, vb).defaultPrevented) return;
      const { classList: e, scrollHeight: s, style: n } = this._element,
  ...
  const Ab = new Set([
    ...
    wb = /^aria-[\w-]*$/i,
    kb = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i,
    Sb =
    ...
    Ob = (i, t) => {
      ...
      if (t.includes(e))
        return Ab.has(e)
          ? !!(kb.test(i.nodeValue) || Sb.test(i.nodeValue))
          : !0;
  ...
  function Oh(i, t, e) {
    ...
    const n = new window.DOMParser().parseFromString(i, "text/html"),
    ...
    for (let r = 0, a = o.length; r < a; r++) {
      ...
      const h = [].concat(...l.attributes),
        d = [].concat(t["*"] || [], t[c] || []);
      h.forEach((u) => {
        Ob(u, d) || l.removeAttribute(u.nodeName);
      });
    }
  ...
  const Dh = "tooltip",
    ce = ".te.tooltip",
    Ib = "te-tooltip",
    Mb = new Set(["sanitize", "allowList", "sanitizeFn"]),
    Lb = {
      animation: "boolean",
      template: "string",
  ...
  let Gi = class I_ extends qt {
    ...
    toggle(t) {
      if (this._isEnabled)
        if (t) {
          ...
          if (this.getTipElement().classList.contains(ma)) {
    ...
    dispose() {
      clearTimeout(this._timeout),
        g.off(this._element.closest(Mh), Lh, this._hideModalHandler),
    ...
    show() {
      ...
      const t = g.trigger(this._element, this.constructor.Event.SHOW),
        e = ac(this._element),
        s =
          e === null
      ...
      this.constructor.NAME === "tooltip" &&
        this.tip &&
        this.getTitle() !== this.tip.querySelector(Ih).innerHTML &&
        (this._disposePopper(), this.tip.remove(), (this.tip = null));
      const n = this.getTipElement(),
        o = Gt(this.constructor.NAME);
      n.setAttribute("id", o),
      ...
      if (
        (M.setData(n, this.constructor.DATA_KEY, this),
        this._element.ownerDocument.documentElement.contains(this.tip) ||
          (l.append(n),
          g.trigger(this._element, this.constructor.Event.INSERTED)),
        this._popper
          ? this._popper.update()
          : (this._popper = pi(this._element, n, this._getPopperConfig(a))),
      ...
      const d = () => {
          ...
          (this._hoverState = null),
            g.trigger(this._element, this.constructor.Event.SHOWN),
            p === ba && this._leave(null, this);
        },
      ...
      const t = this.getTipElement(),
        e = () => {
          this._isWithActiveTrigger() ||
            (this._hoverState !== Ps && t.remove(),
            this._cleanTipClass(),
            this._element.removeAttribute("aria-describedby"),
            g.trigger(this._element, this.constructor.Event.HIDDEN),
            this._disposePopper());
        };
      if (
        g.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented
      )
        return;
      t.classList.add("opacity-0"),
        t.classList.remove("opacity-100"),
        "ontouchstart" in document.documentElement &&
          []
            .concat(...document.body.children)
            .forEach((o) => g.off(o, "mouseover", Fn)),
        (this._activeTrigger[Hb] = !1),
        (this._activeTrigger[va] = !1),
    ...
    getTipElement() {
      ...
      return (
        this.setContent(e), e.classList.remove(Nb, ma), (this.tip = e), this.tip
      );
    }
    setContent(t) {
      this._sanitizeAndSetContent(t, this.getTitle(), Ih);
    }
      ...
      if (t !== null) {
        ...
        this._config.html
          ? (this._config.sanitize &&
              (e = Oh(e, this._config.allowList, this._config.sanitizeFn)),
            (t.innerHTML = e))
          : (t.textContent = e);
      }
    }
    ...
    _getPopperConfig(t) {
      const e = {
        ...
        onFirstUpdate: (s) => {
          s.options.placement !== s.placement &&
            this._handlePopperPlacementChange(s);
        },
      };
      return {
        ...e,
    ...
    _setListeners() {
      this._config.trigger.split(" ").forEach((e) => {
        if (e === "click")
          ...
          g.on(this._element, s, this._config.selector, (o) => this._enter(o)),
            g.on(this._element, n, this._config.selector, (o) =>
              this._leave(o)
            );
        }
      }),
        ...
        g.on(this._element.closest(Mh), Lh, this._hideModalHandler),
        this._config.selector
          ? (this._config = {
              ...this._config,
              trigger: "manual",
    ...
    _enter(t, e) {
      if (
        ...
        t && (e._activeTrigger[t.type === "focusin" ? va : Ns] = !0),
        e.getTipElement().classList.contains(ma) || e._hoverState === Ps)
      ) {
        e._hoverState = Ps;
        return;
      }
    ...
    _leave(t, e) {
      if (
        ((e = this._initializeOnDelegatedTarget(t, e)),
        t &&
          (e._activeTrigger[t.type === "focusout" ? va : Ns] =
    ...
    _getConfig(t) {
      ...
      return (
        ...
        (t.container = t.container === !1 ? document.body : Ne(t.container)),
        typeof t.delay == "number" &&
          (t.delay = { show: t.delay, hide: t.delay }),
        typeof t.title == "number" && (t.title = t.title.toString()),
        typeof t.content == "number" && (t.content = t.content.toString()),
        P(Dh, t, this.constructor.DefaultType),
        t.sanitize && (t.template = Oh(t.template, t.allowList, t.sanitizeFn)),
        t
      );
    }
    _getDelegateConfig() {
    ...
    _cleanTipClass() {
      ...
      s !== null &&
        s.length > 0 &&
        s.map((n) => n.trim()).forEach((n) => t.classList.remove(n));
    }
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        const e = I_.getOrCreateInstance(this, t);
        if (typeof t == "string") {
          if (typeof e[t] > "u") throw new TypeError(`No method named "${t}"`);
          e[t]();
        }
  ...
  const Wb = "popover",
    ...
    Yb = { ...Gi.DefaultType, content: "(string|element|function)" },
    jb = {
      HIDE: `hide${he}`,
      HIDDEN: `hidden${he}`,
      SHOW: `show${he}`,
  ...
  class io extends Gi {
    ...
    setContent(t) {
      this._sanitizeAndSetContent(t, this.getTitle(), Kb),
        this._sanitizeAndSetContent(t, this._getContent(), Ub);
    }
    _getContent() {
  ...
  const ya = "scrollspy",
    ...
    Xb = { offset: "number", method: "string", target: "(string|element)" },
    Gb = {
      active:
    ...
    Zb = `activate${xa}`,
    Qb = `scroll${xa}`,
    Ta = "data-te-nav-link-active",
    Rh = "[data-te-dropdown-item-ref]",
    Jb = "[data-te-nav-list-ref]",
    Ea = "[data-te-nav-link-ref]",
    tv = "[data-te-nav-item-ref]",
    Ph = "[data-te-list-group-item-ref]",
    Ca = `${Ea}, ${Ph}, ${Rh}`,
    ev = "[data-te-dropdown-ref]",
    iv = "[data-te-dropdown-toggle-ref]",
    sv = "maxOffset",
    Nh = "position";
  class so extends qt {
    constructor(t, e, s) {
      super(t),
        ...
        g.on(this._scrollElement, Qb, () => this._process()),
        this.refresh(),
        this._process();
    }
    static get Default() {
    ...
    refresh() {
      const t = this._scrollElement === this._scrollElement.window ? sv : Nh,
        e = this._config.method === "auto" ? t : this._config.method,
        s = e === Nh ? this._getScrollTop() : 0;
      (this._offsets = []),
        (this._targets = []),
        (this._scrollHeight = this._getScrollHeight()),
        m
          .find(Ca, this._config.target)
          .map((o) => {
            const r = Pr(o),
              a = r ? m.findOne(r) : null;
            if (a) {
              const l = a.getBoundingClientRect();
              if (l.width || l.height) return [_[e](a).top + s, r];
            }
            return null;
          })
          .filter((o) => o)
    ...
    dispose() {
      g.off(this._scrollElement, xa), super.dispose();
    }
    _getConfig(t) {
      return (
        (t = {
        ...
        (t.target = Ne(t.target) || document.documentElement),
        P(ya, t, Xb),
        t
      );
    }
    ...
    _activate(t) {
      ...
      const e = Ca.split(",").map(
          (n) => `${n}[data-te-target="${t}"],${n}[href="${t}"]`
        ),
        s = m.findOne(e.join(","), this._config.target);
      s.classList.add(...this._classes.active.split(" ")),
        s.setAttribute(Ta, ""),
        s.getAttribute(Rh)
          ? m
              .findOne(iv, s.closest(ev))
              .classList.add(...this._classes.active.split(" "))
          : m.parents(s, Jb).forEach((n) => {
              m.prev(n, `${Ea}, ${Ph}`).forEach((o) => {
                o.classList.add(...this._classes.active.split(" ")),
                  o.setAttribute(Ta, "");
              }),
                m.prev(n, tv).forEach((o) => {
                  m.children(o, Ea).forEach((r) =>
                    r.classList.add(...this._classes.active.split(" "))
                  );
                });
            }),
        g.trigger(this._scrollElement, Zb, { relatedTarget: t });
    }
    _clear() {
      m.find(Ca, this._config.target)
        .filter((t) => t.classList.contains(...this._classes.active.split(" ")))
        .forEach((t) => {
          t.classList.remove(...this._classes.active.split(" ")),
            t.removeAttribute(Ta);
        });
    }
    static jQueryInterface(t) {
      return this.each(function () {
        const e = so.getOrCreateInstance(this, t);
        if (typeof t == "string") {
          if (typeof e[t] > "u") throw new TypeError(`No method named "${t}"`);
          e[t]();
        }
  ...
  const Bh = "tab",
    ...
    rv = `show${no}`,
    av = `shown${no}`,
    lv = "data-te-dropdown-menu-ref",
    qi = "data-te-tab-active",
    oo = "data-te-nav-active",
    cv = "[data-te-dropdown-ref]",
    hv = "[data-te-nav-ref]",
    Hh = `[${qi}]`,
    dv = `[${oo}]`,
    Fh = ":scope > li > .active",
    uv = "[data-te-dropdown-toggle-ref]",
    pv = ":scope > [data-te-dropdown-menu-ref] [data-te-dropdown-show]",
    fv = { show: "opacity-100", hide: "opacity-0" },
    _v = { show: "string", hide: "string" };
  class ro extends qt {
    constructor(t, e) {
    ...
    show() {
      if (
        this._element.parentNode &&
        this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
        this._element.getAttribute(oo) === ""
      )
        return;
      let t;
      const e = Pe(this._element),
        s = this._element.closest(hv),
        n = m.findOne(dv, s);
      if (s) {
        const l = s.nodeName === "UL" || s.nodeName === "OL" ? Fh : Hh;
        (t = m.find(l, s)), (t = t[t.length - 1]);
      }
      const o = t ? g.trigger(t, nv, { relatedTarget: this._element }) : null;
      if (
        g.trigger(this._element, rv, { relatedTarget: t }).defaultPrevented ||
        (o !== null && o.defaultPrevented)
      )
        return;
      this._activate(this._element, s, null, n, this._element);
      const a = () => {
        g.trigger(t, ov, { relatedTarget: this._element }),
          g.trigger(this._element, av, { relatedTarget: t });
      };
      e ? this._activate(e, e.parentNode, a, n, this._element) : a();
    }
    _getClasses(t) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...fv, ...e, ...t }), P(Bh, t, _v), t;
    }
    _activate(t, e, s, n, o) {
      const a = (
        ...
        l = s && a && a.hasAttribute(qi),
        c = () => this._transitionComplete(t, a, s, n, o);
      a && l
        ? (_.removeClass(a, this._classes.show),
          _.addClass(a, this._classes.hide),
          this._queueCallback(c, t, !0))
        : c();
    }
    _transitionComplete(t, e, s, n, o) {
      if (e && n) {
        e.removeAttribute(qi), n.removeAttribute(oo);
        const a = m.findOne(pv, e.parentNode);
        a && a.removeAttribute(qi),
      ...
      t.setAttribute(qi, ""),
        ...
        t.classList.contains(this._classes.hide) &&
          (_.removeClass(t, this._classes.hide),
          _.addClass(t, this._classes.show));
      let r = t.parentNode;
      if (
        (r && r.nodeName === "LI" && (r = r.parentNode),
        r && r.hasAttribute(lv))
      ) {
        const a = t.closest(cv);
        a && m.find(uv, a).forEach((l) => l.setAttribute(qi, "")),
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        const e = ro.getOrCreateInstance(this);
        if (typeof t == "string") {
          if (typeof e[t] > "u") throw new TypeError(`No method named "${t}"`);
          e[t]();
        }
  ...
  const Aa = "toast",
    ...
    Tv = `show${We}`,
    Ev = `shown${We}`,
    Wh = "data-te-toast-hide",
    wa = "data-te-toast-show",
    ao = "data-te-toast-showing",
    Cv = { animation: "boolean", autohide: "boolean", delay: "number" },
    Vh = { animation: !0, autohide: !0, delay: 5e3 },
    Av = {
      fadeIn:
        "animate-[fade-in_0.3s_both] p-[auto] motion-reduce:transition-none motion-reduce:animate-none",
      fadeOut:
    ...
    wv = { fadeIn: "string", fadeOut: "string" };
  class lo extends qt {
    constructor(t, e, s) {
      super(t),
        (this._config = this._getConfig(e)),
    ...
    show() {
      if (g.trigger(this._element, Tv).defaultPrevented) return;
      this._clearTimeout(),
        this._config.animation &&
          (_.removeClass(this._element, this._classes.fadeOut),
          _.addClass(this._element, this._classes.fadeIn));
      const e = () => {
        this._element.removeAttribute(ao),
          g.trigger(this._element, Ev),
          this._maybeScheduleHide();
      };
      this._element.removeAttribute(Wh),
        Bi(this._element),
        this._element.setAttribute(wa, ""),
        this._element.setAttribute(ao, ""),
    ...
    hide() {
      if (
        ...
        g.trigger(this._element, yv).defaultPrevented
      )
        return;
      const e = () => {
        let s = 0;
        this._config.animation &&
          ...
          _.addClass(this._element, this._classes.fadeOut)),
          setTimeout(() => {
            this._element.setAttribute(Wh, ""),
              this._element.removeAttribute(ao),
              this._element.removeAttribute(wa),
              g.trigger(this._element, xv);
          }, s);
      };
      this._element.setAttribute(ao, ""),
        this._queueCallback(e, this._element, this._config.animation);
    ...
    _getConfig(t) {
      return (
        ...
        P(Aa, t, this.constructor.DefaultType),
        t
      );
    }
    _getClasses(t) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...Av, ...e, ...t }), P(Aa, t, wv), t;
    }
    _maybeScheduleHide() {
    ...
    _setListeners() {
      g.on(this._element, gv, (t) => this._onInteraction(t, !0)),
        g.on(this._element, mv, (t) => this._onInteraction(t, !1)),
        g.on(this._element, bv, (t) => this._onInteraction(t, !0)),
        g.on(this._element, vv, (t) => this._onInteraction(t, !1));
    }
    _clearTimeout() {
      clearTimeout(this._timeout), (this._timeout = null);
    }
        ...
        379: (s, n, o) => {
          ...
          function h(E, T) {
            for (var C = {}, A = [], w = 0; w < E.length; w++) {
              ...
              I !== -1
                ? (l[I].references++, l[I].updater(R))
                : l.push({ identifier: O, updater: x(R, T), references: 1 }),
                A.push(O);
            }
            return A;
          }
...
`)
          ...
          function f(E, T, C, A) {
            var w = C
              ...
              : A.css;
            if (E.styleSheet) E.styleSheet.cssText = p(T, w);
            else {
              var S = document.createTextNode(w),
                k = E.childNodes;
              k[T] && E.removeChild(k[T]),
                k.length ? E.insertBefore(S, k[T]) : E.appendChild(S);
            }
          }
          function b(E, T, C) {
            var A = C.css,
              ...
              S = C.sourceMap;
            if (
              (w ? E.setAttribute("media", w) : E.removeAttribute("media"),
              S &&
                typeof btoa < "u" &&
                (A += `
/*# sourceMappingURL=data:application/json;base64,`.concat(
          ...
          s.exports = function (E, T) {
            ...
            return function (A) {
              if (
                ...
                for (var k = h(A, T), D = 0; D < C.length; D++) {
                  var O = c(C[D]);
    ...
    (e.n = (s) => {
      ...
      (e.d = (s, n) => {
        for (var o in n)
          e.o(n, o) &&
            !e.o(s, o) &&
            Object.defineProperty(s, o, { enumerable: !0, get: n[o] });
      }),
  ...
  const ka = "input",
    co = "te.input",
    zh = "data-te-input-wrapper-init",
    Yh = "data-te-input-notch-ref",
    jh = "data-te-input-notch-leading-ref",
    Kh = "data-te-input-notch-middle-ref",
    kv = "data-te-input-notch-trailing-ref",
    Sv = "data-te-input-helper-ref",
    Ov = "data-te-input-placeholder-active",
    Ve = "data-te-input-state-active",
    Uh = "data-te-input-focused",
    Xh = "data-te-input-form-counter",
    vi = `[${zh}] input`,
    yi = `[${zh}] textarea`,
    Zi = `[${Yh}]`,
    Gh = `[${jh}]`,
  ...
  class Z {
    constructor(t, e, s) {
      (this._config = this._getConfig(e, t)),
        ...
        this._element && (M.setData(t, co, this), this.init());
    }
    static get NAME() {
      return ka;
    }
    ...
    forceActive() {
      this.input.setAttribute(Ve, ""),
        m.findOne(Zi, this.input.parentNode).setAttribute(Ve, "");
    }
    forceInactive() {
      this.input.removeAttribute(Ve),
        m.findOne(Zi, this.input.parentNode).removeAttribute(Ve);
    }
    dispose() {
      this._removeBorder(),
        M.removeData(this._element, co),
        (this._element = null);
    }
    _getConfig(t, e) {
      return (
    ...
    _getHelper() {
      this._helper = m.findOne(Dv, this._element);
    }
    _getCounter() {
      (this._counter = _.getDataAttribute(this.input, "inputShowcounter")),
        this._counter &&
          ((this._maxLength = this.input.maxLength), this._showCounter());
    }
    _getEvents() {
      g.on(document, "focus", vi, Z.activate(new Z())),
        g.on(document, "input", vi, Z.activate(new Z())),
        g.on(document, "blur", vi, Z.deactivate(new Z())),
        g.on(document, "focus", yi, Z.activate(new Z())),
        g.on(document, "input", yi, Z.activate(new Z())),
        g.on(document, "blur", yi, Z.deactivate(new Z())),
        g.on(window, "shown.te.modal", (t) => {
          m.find(vi, t.target).forEach((e) => {
            const s = Z.getInstance(e.parentNode);
            s && s.update();
          }),
            m.find(yi, t.target).forEach((e) => {
              const s = Z.getInstance(e.parentNode);
              s && s.update();
            });
        }),
        g.on(window, "shown.te.dropdown", (t) => {
          const e = t.target.parentNode.querySelector(
            "[data-te-dropdown-menu-ref]"
          );
          e &&
            (m.find(vi, e).forEach((s) => {
              const n = Z.getInstance(s.parentNode);
              n && n.update();
            }),
            m.find(yi, e).forEach((s) => {
              const n = Z.getInstance(s.parentNode);
              n && n.update();
            }));
        }),
        g.on(window, "shown.te.tab", (t) => {
          let e;
          t.target.href
            ? (e = t.target.href.split("#")[1])
            : (e = _.getDataAttribute(t.target, "target").split("#")[1]);
          const s = m.findOne(`#${e}`);
          m.find(vi, s).forEach((n) => {
            const o = Z.getInstance(n.parentNode);
            o && o.update();
          }),
            m.find(yi, s).forEach((n) => {
              const o = Z.getInstance(n.parentNode);
              o && o.update();
            });
        }),
        ...
        g.on(window, "onautocomplete", (t) => {
          const e = Z.getInstance(t.target.parentNode);
          !e || !t.cancelable || e.forceActive();
        });
    }
    _showCounter() {
      if (m.find(`[${Xh}]`, this._element).length > 0) return;
      (this._counterElement = document.createElement("div")),
        _.addClass(this._counterElement, this._classes.counter),
        this._counterElement.setAttribute(Xh, "");
    ...
    _showPlaceholder() {
      this.input.setAttribute(Ov, "");
    }
    _getNotchData() {
      (this._notchMiddle = m.findOne(qh, this._element)),
        (this._notchLeading = m.findOne(Gh, this._element));
    }
    _getLabelWidth() {
    ...
    _applyDivs() {
      const t = this._config.inputFormWhite
        ...
        s = this._config.inputFormWhite
          ? this._classes.notchTrailingWhite
          : this._classes.notchTrailingNormal,
        n = m.find(Zi, this._element),
        o = L("div");
      _.addClass(o, this._classes.notch),
        o.setAttribute(Yh, ""),
        (this._notchLeading = L("div")),
        _.addClass(this._notchLeading, `${this._classes.notchLeading} ${t}`),
        this._notchLeading.setAttribute(jh, ""),
        (this._notchMiddle = L("div")),
        _.addClass(this._notchMiddle, `${this._classes.notchMiddle} ${e}`),
        this._notchMiddle.setAttribute(Kh, ""),
        (this._notchTrailing = L("div")),
        _.addClass(this._notchTrailing, `${this._classes.notchTrailing} ${s}`),
        this._notchTrailing.setAttribute(kv, ""),
        !(n.length >= 1) &&
    ...
    _removeBorder() {
      const t = m.findOne(Zi, this._element);
      t && t.remove();
    }
    _activate(t) {
      cc(() => {
        ...
        const e = t ? t.target : this.input,
          s = m.findOne(Zi, this._element);
        t && t.type === "focus" && s.setAttribute(Uh, ""),
          e.value !== "" && (e.setAttribute(Ve, ""), s.setAttribute(Ve, "")),
    ...
    _getElements(t) {
      if (
        ...
        this._getLabelData(),
          e !== this._labelWidth &&
            ((this._notchMiddle = m.findOne(qh, t.target.parentNode)),
            (this._notchLeading = m.findOne(Gh, t.target.parentNode)),
            this._applyNotch());
      }
    }
    _deactivate(t) {
      const e = t ? t.target : this.input,
        s = m.findOne(Zi, e.parentNode);
      s.removeAttribute(Uh),
        e.value === "" && (e.removeAttribute(Ve), s.removeAttribute(Ve)),
        this._toggleDefaultDatePlaceholder(e);
    }
    static activate(t) {
      return function (e) {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        let s = M.getData(this, co);
        const n = typeof t == "object" && t;
        if (
          !(!s && /dispose/.test(t)) &&
          (s || (s = new Z(this, n)), typeof t == "string")
        ) {
          if (typeof s[t] > "u") throw new TypeError(`No method named "${t}"`);
          s[t](e);
        }
  ...
  class ho {
    constructor(t, e) {
      (this._element = t),
        ...
        this._element && (M.setData(t, Sa, this), this._init());
    }
    static get NAME() {
      return Zh;
    }
    ...
    dispose() {
      g.off(this._element, "mousedown"),
        g.off(this._animateElement, "animationend"),
        g.off(window, "scroll"),
        g.off(this._element, "mouseover"),
        M.removeData(this._element, Sa),
        (this._element = null),
    ...
    _getAnimateElement() {
      const t = _.getDataAttribute(this._element, "animation-target");
      return t ? m.find(t)[0] : this._element;
    }
    _getConfig(t) {
      const e = _.getDataAttributes(this._animateElement);
      return (t = { ...Pv, ...e, ...t }), P(Zh, t, Rv), t;
    }
    _animateOnScroll() {
      const t = _.offset(this._animateElement).top,
        e = this._animateElement.offsetHeight,
        s = window.innerHeight,
        n =
          t + this._options.animationOffset <= s &&
    ...
    _addAnimatedClass() {
      _.addClass(this._animateElement, `animate-${this._options.animation}`);
    }
    ...
    _setAnimationInterval() {
      g.on(this._animateElement, "click", () => {
        this._clearAnimationClass(),
          setTimeout(() => {
            this._addAnimatedClass();
          }, this._options.animationInterval);
    ...
    _hideAnimateElement() {
      _.style(this._animateElement, { visibility: "hidden" });
    }
    _showAnimateElement() {
      _.style(this._animateElement, { visibility: "visible" });
    }
    _bindResetAnimationAfterFinish() {
      g.on(this._animateElement, "animationend", () => {
        this._clearAnimationClass();
      });
    }
    ...
    _bindClickEvents() {
      g.on(this._element, "mousedown", () => {
        this._startAnimation();
      });
    }
    _bindHoverEvents() {
      g.one(this._element, "mouseover", () => {
        this._startAnimation();
      }),
        g.one(this._animateElement, "animationend", () => {
          setTimeout(() => {
            this._bindHoverEvents();
          }, 100);
        });
    ...
    static jQueryInterface(t) {
      new ho(this[0], t).init();
    }
    static getInstance(t) {
      return M.getData(t, Sa);
    }
    static getOrCreateInstance(t, e = {}) {
      return (
        this.getInstance(t) || new this(t, typeof e == "object" ? e : null)
  ...
  const Oa = "ripple",
    ...
    zv = { ripple: "string", rippleWave: "string", unbound: "string" };
  class ze {
    constructor(t, e, s) {
      (this._element = t),
        (this._options = this._getConfig(e)),
        ...
        this._element &&
          (M.setData(t, uo, this),
          _.addClass(this._element, this._classes.ripple)),
    ...
    dispose() {
      M.removeData(this._element, uo),
        g.off(this._element, "click", this._clickHandler),
        (this._element = null),
        (this._options = null);
    }
    _autoInit(t) {
    ...
    _addClickEvent(t) {
      g.on(t, "mousedown", this._clickHandler);
    }
    _createRipple(t) {
      this._element.className.indexOf(this._classes.ripple) < 0 &&
        _.addClass(this._element, this._classes.ripple);
      const { layerX: e, layerY: s } = t,
        n = t.offsetX || e,
        o = t.offsetY || s,
    ...
    _createHTMLRipple({ wrapper: t, ripple: e, styles: s }) {
      Object.keys(s).forEach((n) => (e.style[n] = s[n])),
        _.addClass(e, this._classes.rippleWave),
    ...
    _getConfig(t = {}) {
      const e = _.getDataAttributes(this._element);
      return (t = { ...Fv, ...e, ...t }), P(Oa, t, Wv), t;
    }
    _getClasses(t = {}) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...Vv, ...e, ...t }), P(Oa, t, zv), t;
    }
    ...
    _appendRipple(t, e) {
      e.appendChild(t),
        setTimeout(() => {
          _.addClass(t, "opacity-0 scale-100");
        }, 50);
    }
    _toggleUnbound(t) {
      this._options.rippleUnbound === !0
        ? _.addClass(t, this._classes.unbound)
    ...
    _addColor(t) {
      ...
      const s = Hv.find((r) => r.name === e.toLowerCase()),
        n = s
          ? this._colorToRGB(s.gradientColor).join(",")
          : this._colorToRGB(e).join(","),
        o = Nv.split("{{color}}").join(`${n}`);
    ...
    _colorToRGB(t) {
      ...
      function n(o) {
        return (
          (o = o.match(/[.\d]+/g).map((r) => +Number(r))), (o.length = 3), o
        );
      }
      return t.toLowerCase() === "transparent"
        ...
        : t[0] === "#"
        ? e(t)
        : (t.indexOf("rgb") === -1 && (t = s(t)),
          t.indexOf("rgb") === 0 ? n(t) : po);
    }
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        return M.getData(this, uo) ? null : new ze(this, t);
      });
    }
    static getInstance(t) {
      return M.getData(t, uo);
    }
    static getOrCreateInstance(t, e = {}) {
      return (
        this.getInstance(t) || new this(t, typeof e == "object" ? e : null)
  ...
  function jv(i) {
    return de(i.getFullYear(), i.getMonth() + 1, 0);
  }
  function Qi() {
    return new Date();
  }
  ...
  function Et(i, t) {
    const e = de(i.getFullYear(), i.getMonth() + t, i.getDate()),
      s = bt(i),
      n = bt(e);
    return s !== n && e.setDate(0), e;
  }
  function Ji(i, t) {
    return de(i.getFullYear(), i.getMonth(), i.getDate() + t);
  }
  function de(i, t, e) {
  ...
  function Gv(i, t, e, s, n, o, r, a) {
    const l = new Date();
    return (
      l.setHours(0, 0, 0, 0),
      ((i && o && ts(o, l) < 0) || i) && (o = l),
      o && Bs(t, o, e, s, n, o, r, a)
    );
  }
  function qv(i, t, e, s, n, o, r, a) {
    const l = new Date();
    return (
      l.setHours(0, 0, 0, 0),
      ((i && n && ts(n, l) < 0) || i) && (n = l),
      n && Bs(t, n, e, s, n, o, r, a)
    );
  }
  function Bs(i, t, e, s, n, o, r, a) {
    return e === "days"
      ? K(i) === K(t) && ot(i) === ot(t)
      : e === "months"
      ? K(i) === K(t)
  ...
  const Zv = "data-te-datepicker-modal-container-ref",
    Qv = "data-te-datepicker-dropdown-container-ref",
    Jv = "data-te-dropdown-backdrop-ref",
    t0 = "data-te-datepicker-date-text-ref",
    ed = "data-te-datepicker-view-ref",
    e0 = "data-te-datepicker-previous-button-ref",
    i0 = "data-te-datepicker-next-button-ref",
    s0 = "data-te-datepicker-ok-button-ref",
    n0 = "data-te-datepicker-cancel-button-ref",
    o0 = "data-te-datepicker-clear-button-ref",
    r0 = "data-te-datepicker-view-change-button-ref";
  function a0(i, t, e, s, n, o, r, a, l, c) {
    const h = ot(i),
      d = K(i),
      u = bt(i),
      p = fo(i),
    ...
    return (
      n.inline
        ? (_.addClass(f, c.datepickerDropdownContainer),
          f.setAttribute(Qv, l),
          (f.innerHTML = b))
        : (_.addClass(f, c.modalContainer),
          f.setAttribute(Zv, l),
          (f.innerHTML = v)),
      f
    );
  ...
  function l0(i) {
    const t = L("div");
    return _.addClass(t, i), t.setAttribute(Jv, ""), t;
  }
  function c0(i, t, e, s, n) {
    return `
  ...
  function id(i, t, e, s, n, o, r, a, l, c, h) {
    let d;
    return (
      r.inline
        ? (d = `
  ...
  function sd(i, t, e, s, n, o, r, a, l, c) {
    let h;
    return (
      o.view === "days"
        ? (h = mo(i, e, o, c))
  ...
  function nd(i, t, e, s) {
    ...
    <div class="${s.datepickerDateControls}">
      <button class="${
        s.datepickerViewChangeButton
      }" aria-label="${e.switchToMultiYearViewLabel}" ${r0}>
        ${e.monthsFull[i]} ${t} ${ue(e, s)}
      </button>
      <div class="${s.datepickerArrowControls}">
        <button class="${
          s.datepickerPreviousButton
        }" aria-label="${e.prevMonthLabel}" ${e0}>${e.changeMonthIconTemplate}</button>
        <button class="${
          s.datepickerNextButton
        }" aria-label="${e.nextMonthLabel}" ${i0}>${e.changeMonthIconTemplate}</button>
      </div>
    </div>
    `;
  }
  ...
  function h0(i, t) {
    const e = `<button class="${t.datepickerFooterBtn}" aria-label="${i.okBtnLabel}" ${s0}>${i.okBtnText}</button>`,
      s = `<button class="${t.datepickerFooterBtn}" aria-label="${i.cancelBtnLabel}" ${n0}>${i.cancelBtnText}</button>`,
      n = `<button class="${t.datepickerFooterBtn} ${t.datepickerClearBtn}" aria-label="${i.clearBtnLabel}" ${o0}>${i.clearBtnText}</button>`;
    return `
    ...
    const n = d0(i, t, e),
      ...
      <tr>
        ${e.weekdaysNarrow
          .map(
            (l, c) =>
              `<th class="${s.datepickerDayHeading}" scope="col" aria-label="${e.weekdaysFull[c]}">${l}</th>`
          )
          .join("")}
      </tr>
    `,
        ...
        <tr>
          ${l
            .map(
              ...
              >
                <div
                  class="${s.datepickerCellContent} ${
                s.datepickerCellContentSmall
              }"
          ...
          <tr>
            ${h
              .map((d) => {
                ...
                ${
                  td(u, i, s.min, s.max, s.disablePast, s.disableFuture)
                    ? "data-te-datepicker-cell-disabled"
                    : ""
                }
                ...
                ${
                  u === a && i === l ? "data-te-datepicker-cell-current" : ""
                }" data-te-month="${u}" data-te-year="${i}" aria-label="${d}, ${i}">
        ...
        <tr>
          ${c
            .map(
              ...
              ${
                Ia(h, e.min, e.max, e.disablePast, e.disableFuture)
                  ? "data-te-datepicker-cell-disabled"
                  : ""
              }
  ...
  const es = 37,
    ...
    y0 = `dateChange${Co}`,
    Ao = `click${Co}${m0}`,
    od = "data-te-datepicker-modal-container-ref",
    rd = "data-te-datepicker-dropdown-container-ref",
    wo = "[data-te-datepicker-toggle-ref]",
    x0 = `[${od}]`,
    T0 = `[${rd}]`,
    E0 = "[data-te-datepicker-view-change-button-ref]",
    C0 = "[data-te-datepicker-previous-button-ref]",
    A0 = "[data-te-datepicker-next-button-ref]",
    w0 = "[data-te-datepicker-ok-button-ref]",
    k0 = "[data-te-datepicker-cancel-button-ref]",
    S0 = "[data-te-datepicker-clear-button-ref]",
    O0 = "[data-te-datepicker-view-ref]",
    D0 = "[data-te-datepicker-toggle-button-ref]",
    I0 = "[data-te-datepicker-date-text-ref]",
    M0 = "[data-te-dropdown-backdrop-ref]",
    L0 =
    ...
    W0 = "h-8 flex flex-col justify-end",
    V0 = "text-[10px] font-normal uppercase tracking-[1.7px] text-white",
    z0 = "xs:max-md:landscape:mt-24 h-[72px] flex flex-col justify-end",
    Y0 = "text-[34px] font-normal text-white",
    j0 = "outline-none px-3",
    K0 = "px-3 pt-2.5 pb-0 flex justify-between text-black/[64]",
    U0 =
    ...
    Z0 = "h-14 flex absolute w-full bottom-0 justify-end items-center px-3",
    Q0 =
    ...
    J0 = "mr-auto",
    ty = "w-10 h-10 text-center text-[12px] font-normal dark:text-white",
    ey =
    ...
    iy = "w-10 h-10 xs:max-md:landscape:w-8 xs:max-md:landscape:h-8",
    sy = "w-[76px] h-[42px]",
    ny =
    ...
    oy = "w-9 h-9 leading-9 rounded-[50%] text-[13px]",
    ry = "w-[72px] h-10 leading-10 py-[1px] px-0.5 rounded-[999px]",
    ay = "mx-auto w-[304px]",
    ly =
  ...
  `,
    ...
    py = {
      ...
      fadeOutShort: P0,
      modalContainer: N0,
      datepickerBackdrop: B0,
      datepickerMain: H0,
      datepickerHeader: F0,
      datepickerTitle: W0,
      datepickerTitleText: V0,
      datepickerDate: z0,
      datepickerDateText: Y0,
      datepickerView: j0,
      datepickerDateControls: K0,
      datepickerViewChangeButton: U0,
      datepickerViewChangeIcon: cy,
      datepickerArrowControls: X0,
      datepickerPreviousButton: G0,
      datepickerNextButton: q0,
      datepickerFooter: Z0,
      datepickerFooterBtn: Q0,
      datepickerClearBtn: J0,
      datepickerDayHeading: ty,
      datepickerCell: ey,
      datepickerCellSmall: iy,
      datepickerCellLarge: sy,
      datepickerCellContent: ny,
      datepickerCellContentSmall: oy,
      datepickerCellContentLarge: ry,
      datepickerTable: ay,
      datepickerToggleButton: ly,
      datepickerDropdownContainer: hy,
    },
    fy = {
      fadeIn: "string",
      fadeOut: "string",
  ...
  class ad {
    constructor(t, e, s) {
      (this._element = t),
        ...
        (this._isOpen = !1),
        (this._toggleButtonId = Gt("datepicker-toggle-")),
        (this._animations =
          !window.matchMedia("(prefers-reduced-motion: reduce)").matches &&
          this._options.animations),
        (this._scrollBar = new Ds()),
        this._element && M.setData(t, Eo, this),
        this._init(),
        this.toggleButton &&
    ...
    get container() {
      return (
        m.findOne(`[${od}='${this._toggleButtonId}']`) ||
        m.findOne(`[${rd}='${this._toggleButtonId}']`)
      );
    }
    get options() {
    ...
    get firstYearInView() {
      return this.activeYear - _o(this._activeDate, te);
    }
    get lastYearInView() {
      return this.firstYearInView + te - 1;
    }
    get viewChangeButton() {
      return m.findOne(E0, this.container);
    }
    get previousButton() {
      return m.findOne(C0, this.container);
    }
    get nextButton() {
      return m.findOne(A0, this.container);
    }
    get okButton() {
      return m.findOne(w0, this.container);
    }
    get cancelButton() {
      return m.findOne(k0, this.container);
    }
    get clearButton() {
      return m.findOne(S0, this.container);
    }
    get datesContainer() {
      return m.findOne(O0, this.container);
    }
    get toggleButton() {
      return m.findOne(D0, this._element);
    }
    update(t = {}) {
    ...
    _appendToggleButton() {
      const t = f0(this._toggleButtonId, this._classes.datepickerToggleButton);
      this._element.insertAdjacentHTML("beforeend", t);
    }
    open() {
      if (this._input.readOnly || this._input.disabled) return;
      const t = g.trigger(this._element, v0);
      if (this._isOpen || t.defaultPrevented) return;
      this._setInitialDate();
      const e = l0(this._classes.datepickerBackdrop),
        s = a0(
          this._activeDate,
          this._selectedDate,
          this._selectedYear,
      ...
      this._options.inline
        ? this._openDropdown(s)
        : (this._openModal(e, s), this._scrollBar.hide()),
        this._animations &&
          (_.addClass(this.container, this._classes.fadeIn),
          _.addClass(e, this._classes.fadeInShort)),
    ...
    _openDropdown(t) {
      (this._popper = pi(this._input, t, { placement: "bottom-start" })),
    ...
    _listenToUserInput() {
      g.on(this._input, "input", (t) => {
        this._handleUserInput(t.target.value);
      });
    }
    _listenToToggleClick() {
      g.on(this._element, Ao, wo, (t) => {
        t.preventDefault(), this.open();
      });
    }
    _listenToToggleKeydown() {
      g.on(this._element, "keydown", wo, (t) => {
        t.keyCode === $t && !this._isOpen && this.open();
      });
    }
    _listenToDateSelection() {
      g.on(this.datesContainer, "click", (t) => {
    ...
    _handleDateSelection(t) {
      const e =
          t.target.nodeName === "DIV"
            ...
            : t.target.dataset,
        s = t.target.nodeName === "DIV" ? t.target.parentNode : t.target;
    ...
    _updateHeaderDate(t, e, s) {
      const n = m.findOne(I0, this.container),
        o = ot(t),
        r = bt(t),
        a = fo(t);
    ...
    _addControlsListeners() {
      g.on(this.nextButton, "click", () => {
        ...
        g.on(this.previousButton, "click", () => {
          this._view === "days"
            ? this.previousMonth()
            : this._view === "years"
            ? this.previousYears()
        ...
        g.on(this.viewChangeButton, "click", () => {
          this._view === "days"
    ...
    _listenToFooterButtonsClick() {
      g.on(this.okButton, "click", () => this.handleOk()),
        g.on(this.cancelButton, "click", () => this.handleCancel()),
        g.on(this.clearButton, "click", () => this.handleClear());
    }
    _listenToOutsideClick() {
      g.on(document, Ao, (t) => {
        const e = t.target === this.container,
          s = this.container && this.container.contains(t.target);
        !e && !s && this.close();
      });
    }
    _listenToEscapeClick() {
      g.on(document, "keydown", (t) => {
        t.keyCode === Hs && this._isOpen && this.close();
      });
    }
    _listenToKeyboardNavigation() {
      g.on(this.datesContainer, "keydown", (t) => {
        this._handleKeydown(t);
      });
    }
    _listenToDatesContainerFocus() {
      g.on(this.datesContainer, "focus", () => {
        this._focusActiveCell(this.activeCell);
      });
    }
    _listenToDatesContainerBlur() {
      g.on(this.datesContainer, "blur", () => {
    ...
    _handleDaysViewKeydown(t) {
      ...
      switch (t.keyCode) {
        case es:
          this._activeDate = Ji(this._activeDate, st() ? 1 : -1);
          break;
        case is:
          this._activeDate = Ji(this._activeDate, st() ? -1 : 1);
          break;
        case Ct:
          this._activeDate = Ji(this._activeDate, -7);
          break;
        case ut:
          this._activeDate = Ji(this._activeDate, 7);
          break;
        case ss:
          this._activeDate = Ji(this._activeDate, 1 - bt(this._activeDate));
          break;
        case ns:
          this._activeDate = Ji(
            this._activeDate,
            Da(this._activeDate) - bt(this._activeDate)
          );
          break;
        case Ma:
      ...
      Bs(
        ...
        this._removeHighlightFromCell(s),
        this._focusActiveCell(this.activeCell),
        t.preventDefault();
    }
    ...
    _getActiveDayCell() {
      ...
      return Array.from(t).find((s) => {
        const n = Jh(s.dataset.teDate);
        return xi(n, this._activeDate);
      });
    }
    _handleMonthsViewKeydown(t) {
      ...
      switch (t.keyCode) {
        ...
        case is:
          ...
          break;
        case Ct:
          this._activeDate = Et(this._activeDate, -4);
          break;
        case ut:
          this._activeDate = Et(this._activeDate, 4);
          break;
        case ss:
          this._activeDate = Et(this._activeDate, -this.activeMonth);
          break;
        case ns:
          this._activeDate = Et(this._activeDate, 11 - this.activeMonth);
          break;
        case Ma:
    ...
    _getActiveMonthCell() {
      const t = m.find("td", this.datesContainer);
      return Array.from(t).find((s) => {
        const n = parseInt(s.dataset.teYear, 10),
          o = parseInt(s.dataset.teMonth, 10);
    ...
    _handleYearsViewKeydown(t) {
      ...
      switch (t.keyCode) {
        case es:
          this._activeDate = Tt(this._activeDate, st() ? 1 : -1);
          break;
        case is:
          this._activeDate = Tt(this._activeDate, st() ? -1 : 1);
          break;
        case Ct:
          this._activeDate = Tt(this._activeDate, -n);
          break;
        case ut:
          this._activeDate = Tt(this._activeDate, n);
          break;
        case ss:
          this._activeDate = Tt(this._activeDate, -_o(this._activeDate, o));
          break;
        case ns:
          this._activeDate = Tt(
            this._activeDate,
            o - _o(this._activeDate, o) - 1
          );
          break;
        case Ma:
          this._activeDate = Tt(this._activeDate, -o);
          break;
        case La:
          this._activeDate = Tt(this._activeDate, o);
          break;
    ...
    _getActiveYearCell() {
      ...
      return Array.from(t).find(
        (s) => parseInt(s.dataset.teYear, 10) === this.activeYear
      );
    }
    _setInitialDate() {
      this._input.value
    ...
    close() {
      const t = g.trigger(this._element, b0);
      !this._isOpen ||
        t.defaultPrevented ||
        (this._removeDatepickerListeners(),
        this._animations && _.addClass(this.container, this._classes.fadeOut),
    ...
    _closeModal() {
      const t = m.findOne(M0),
        e = m.findOne(x0);
      !e ||
        !t ||
        (this._animations
          ? (_.addClass(t, this._classes.fadeOutShort),
            t.addEventListener("animationend", () => {
    ...
    _removeDatepickerListeners() {
      g.off(this.nextButton, "click"),
        g.off(this.previousButton, "click"),
        g.off(this.viewChangeButton, "click"),
        g.off(this.okButton, "click"),
        g.off(this.cancelButton, "click"),
        g.off(this.clearButton, "click"),
        g.off(this.datesContainer, "click"),
        g.off(this.datesContainer, "keydown"),
        g.off(this.datesContainer, "focus"),
        g.off(this.datesContainer, "blur"),
        g.off(document, Ao);
    }
    dispose() {
    ...
    _removeInputAndToggleListeners() {
      g.off(this._input, "input"),
        g.off(this._element, Ao, wo),
        g.off(this._element, "keydown", wo);
    }
    handleOk() {
    ...
    _confirmSelection(t) {
      if (t) {
        ...
        (this._input.value = e),
          g.trigger(this._element, y0, { date: t }),
          g.trigger(this._input, "input");
      }
    }
    handleCancel() {
      (this._selectedDate = null),
    ...
    formatDate(t) {
      const e = bt(t),
        s = this._addLeadingZero(bt(t)),
        n = this._options.weekdaysShort[fo(t)],
        o = this._options.weekdaysFull[fo(t)],
        r = ot(t) + 1,
    ...
    _pickDay(t, e) {
      ...
      go(s, n, o, r, a, l) || ((this._activeDate = s), this._selectDate(s, e));
    }
    _pickYear(t) {
      const {
        min: e,
      ...
      if (Ia(t, e, s, n, o)) return;
      const r = de(t, this.activeMonth, this.activeDay);
    ...
    _pickMonth(t, e) {
      ...
      const a = de(e, t, this.activeDay);
      (this._activeDate = a), this._selectMonth(t);
    }
    nextMonth() {
      const t = Et(this._activeDate, 1),
        e = mo(t, this._headerDate, this._options, this._classes);
      (this._activeDate = t),
        (this.viewChangeButton.textContent = `${
          this._options.monthsFull[this.activeMonth]
        } ${this.activeYear}`),
        (this.viewChangeButton.innerHTML += ue(this._options, this._classes)),
        (this.datesContainer.innerHTML = e);
    }
    previousMonth() {
      const t = Et(this._activeDate, -1);
      this._activeDate = t;
      const e = mo(t, this._headerDate, this._options, this._classes);
      (this.viewChangeButton.textContent = `${
        this._options.monthsFull[this.activeMonth]
      } ${this.activeYear}`),
        (this.viewChangeButton.innerHTML += ue(this._options, this._classes)),
    ...
    nextYears() {
      const t = Tt(this._activeDate, 24);
      this._activeDate = t;
      const e = vo(t, this._selectedYear, this._options, te, xo, this._classes);
    ...
    _changeView(t) {
      (this._view = t),
        ...
        t === "days" &&
          (this.datesContainer.innerHTML = mo(
            this._activeDate,
            this._headerDate,
            this._options,
            this._classes
        ...
        t === "years" &&
          (this.datesContainer.innerHTML = vo(
            this._activeDate,
            this._selectedYear,
            this._options,
            te,
    ...
    _handleUserInput(t) {
      const e = this._getDelimeters(this._options.format),
        s = this._parseDate(t, this._options.format, e);
      Kv(s)
        ? ((this._activeDate = s),
          (this._selectedDate = s),
          (this._selectedYear = K(s)),
          (this._selectedMonth = ot(s)),
          (this._headerDate = s))
        : ((this._activeDate = new Date()),
          (this._selectedDate = null),
          (this._selectedMonth = null),
  ...
  const _y = (
      ...
      <div class="${u.timepickerContainer}">
        ...
        <div id='${s}' class='${u.timepickerHead}' style='padding-right:${
          i ? 50 : 10
        }px'>
...
`;
    ...
    my = (i, t, e) =>
      g.on(document, i, t, ({ target: s }) => {
        if (s.hasAttribute(So)) return;
        document.querySelectorAll(t).forEach((o) => {
          o.hasAttribute(So) &&
            (_.removeClass(o, e.opacity), o.removeAttribute(So));
        }),
          _.addClass(s, e.opacity),
          s.setAttribute(So, "");
      }),
    hd = ({ clientX: i, clientY: t, touches: e }, s, n = !1) => {
    ...
    Ye = (i, t, e) => {
      ...
      let s = ud();
      return (
        e && (s = `${Ti(s).hours}:${Ti(s).minutes} ${Ti(s).amOrPm}`),
        ((i !== "" && dd(s, i)) || i === "") && (i = s),
        i
      );
    },
    ...
    by = (
      { format12: i, maxTime: t, minTime: e, disablePast: s, disableFuture: n },
      o,
      r
    ) => {
      const a = Y(o)[1];
      (e = Ye(e, s, i)), (t = je(t, n, i));
      const [l, c, h] = Y(t, !1),
        [d, u, p] = Y(e, !1);
    ...
    pd = (i, t, e, s) => {
      i.forEach((n) => {
        (t = t === "12" && s ? "0" : t),
          (n.textContent === "00" ||
            Number(n.textContent === "12" && s ? "0" : n.textContent) > t) &&
            (_.addClass(n, e.tipsDisabled), n.setAttribute(ko, ""));
      });
    },
    fd = (i, t, e, s) => {
      i.forEach((n) => {
        (t = t === "12" && s ? "0" : t),
          n.textContent !== "00" &&
            Number(n.textContent === "12" && s ? "0" : n.textContent) <
              Number(t) &&
            (_.addClass(n, e.tipsDisabled), n.setAttribute(ko, ""));
      });
    },
    _d = (i, t, e, s) => {
      ...
      const n = e ? 12 : 24;
      return s === "max"
        ? (Number(i) === n ? 0 : Number(i)) > Number(t)
        : (Number(i) === n ? 0 : Number(i)) < Number(t);
    },
    vy = (i, t, e, s, n, o) => {
      i.forEach((r) => {
        (_d(s, e, o, "max") ||
          (Number(r.textContent) > t && Number(s) === Number(e))) &&
          (_.addClass(r, n.tipsDisabled), r.setAttribute(ko, ""));
      });
    },
    yy = (i, t, e, s, n, o) => {
      i.forEach((r) => {
    ...
    xy = (i) => (i.startsWith("0") ? Number(i.slice(1)) : Number(i)),
    Ws = "timepicker",
    V = `data-te-${Ws}`,
    gd = "[data-te-toggle]",
    Do = `te.${Ws}`,
    ...
    Na = `${V}-icon-up`,
    Ba = `${V}-icon-down`,
    ky = `${V}-icon-inline-hour`,
    Sy = `${V}-icon-inline-minute`,
    kd = `${V}-inline-hour-icons`,
    Oy = `${V}-current-inline`,
    Dy = "readonly",
    Sd = `${V}-invalid-feedback`,
    Ha = `${V}-is-invalid`,
    Ke = `${V}-disabled`,
    J = `${V}-active`,
    Iy = `${V}-input`,
  ...
  class Md {
    constructor(t, e = {}, s) {
      we(this, "_toggleAmPm", (t) => {
        t === "PM"
          ? ((this._isPmEnabled = !0), (this._isAmEnabled = !1))
          : t === "AM" && ((this._isPmEnabled = !1), (this._isAmEnabled = !0));
      });
      we(this, "_toggleBackgroundColorCircle", (t) => {
        if (this._modal.querySelector(`${t}[${J}]`) !== null) {
          _.addStyle(this._circle, { backgroundColor: "#1976d2" });
          return;
        }
        _.addStyle(this._circle, { backgroundColor: "transparent" });
      });
      we(this, "_toggleClassActive", (t, { textContent: e }, s) => {
        const n = [...t].find((o) => Number(o) === Number(e));
        return s.forEach((o) => {
          if (!o.hasAttribute(Ke)) {
            if (o.textContent === n) {
              _.addClass(o, this._classes.tipsActive), o.setAttribute(J, "");
              return;
            }
            _.removeClass(o, this._classes.tipsActive), o.removeAttribute(J);
          }
        });
      });
      we(this, "_makeMinutesDegrees", (t, e) => {
        ...
        return (
          ...
          s &&
            ...
            e === 60 && (e = "00")),
          t >= 360 && (t = 0),
          { degrees: t, minute: e, addDegrees: s ? 30 : 6 }
        );
      });
      we(this, "_makeHourDegrees", (t, e, s) => {
        if (t)
          return (
            this._hasTargetInnerClass(t)
              ? e < 0
                ? ((s = Math.round(360 + e / 30) % 24), (e = 360 + e))
                : ((s = Math.round(e / 30) + 12), s === 12 && (s = "00"))
              : e < 0
              ? ((s = Math.round(360 + e / 30) % 12), (e = 360 + e))
              : ((s = Math.round(e / 30) % 12),
                (s === 0 || s > 12) && (s = 12)),
            e >= 360 && (e = 0),
            { degrees: e, hour: s, addDegrees: 30 }
          );
      });
      we(
        this,
      ...
      we(this, "_getAppendClock", (t = [], e = `[${Ei}]`, s) => {
        ...
        !r &&
          ...
          (_.addClass(this._PM, this._classes.opacity),
        ...
        if (v === null) return;
        const E = (v.offsetWidth - 32) / 2,
          T = (v.offsetHeight - 32) / 2,
          C = E - 4;
        setTimeout(() => {
          let A;
          a && (A = m.findOne(`${Lo}[${J}]`).textContent),
          ...
          [...t].forEach((A, w) => {
            const S = x(w * y),
              ...
              D = L("span");
            (D.innerHTML = A),
              _.addClass(k, this._classes.tips),
              k.setAttribute(s, "");
            const O = k.offsetWidth,
              I = k.offsetHeight;
            return (
              _.addStyle(k, {
                left: `${E + Math.sin(S) * C - O}px`,
                bottom: `${T + Math.cos(S) * C - I}px`,
              }),
              t.includes("05") && k.setAttribute(vt, ""),
              t.includes("13")
                ? D.setAttribute(Po, "")
                : D.setAttribute(Ro, ""),
              k.appendChild(D),
      ...
      (this._element = t),
        this._element && M.setData(t, Do, this),
        (this._document = document),
        (this._options = this._getConfig(e)),
        (this._classes = this._getClasses(s)),
        (this._currentTime = null),
        (this._toggleButtonId = Gt("timepicker-toggle-")),
        (this.hoursArray = [
          "12",
          "1",
          "2",
        ...
        (this.customIcon = m.findOne(Ay, this._element)),
        this._checkToggleButton(),
        (this.inputFormatShow = m.findOne(Cy, this._element)),
        (this.inputFormat =
          this.inputFormatShow === null
            ? ""
            : Object.values(this.inputFormatShow.dataset)[0]),
        (this.elementToggle = m.findOne(gd, this._element)),
        (this.toggleElement = Object.values(t.querySelector(gd).dataset)[0]),
        (this._hour = null),
        (this._minutes = null),
        (this._AM = null),
        (this._PM = null),
        ...
        this._options.format24 &&
          ...
          (this._currentTime = cd(this._inputValue))),
        this._options.format12 &&
          ((this._options.format24 = !1),
          (this._currentTime = Ti(this._inputValue))),
        this._options.readOnly && this.input.setAttribute(Dy, !0),
    ...
    init() {
      ...
      let n, o, r;
      if ((this.input.setAttribute(Iy, ""), this._currentTime !== void 0)) {
      ...
      this.input.value.length > 0 &&
        this.input.value !== "" &&
        (this.input.setAttribute(J, ""), g.trigger(this.input, "input")),
        !(this._options === null && this._element === null) &&
          (s && this._getValidate("keydown change blur focus"),
          this._handleOpen(),
          this._listenToToggleKeydown());
    }
    dispose() {
      this._removeModal(),
        this._element !== null && M.removeData(this._element, Do),
        setTimeout(() => {
          (this._element = null),
            (this._options = null),
            (this.input = null),
    ...
    _appendToggleButton() {
      const t = gy(this._options, this._toggleButtonId, this._classes);
      this.input.insertAdjacentHTML("afterend", t);
    }
    _getDomElements() {
      (this._hour = m.findOne(`[${$o}]`)),
        (this._minutes = m.findOne(`[${Wa}]`)),
        (this._AM = m.findOne(Ty)),
        (this._PM = m.findOne(Ey)),
        (this._wrapper = m.findOne(`[${Fa}]`)),
        (this._modal = m.findOne(`[${Id}]`)),
        (this._hand = m.findOne(`[${Va}]`)),
        (this._circle = m.findOne(`[${za}]`)),
        (this._clock = m.findOne(`[${Ei}]`)),
        (this._clockInner = m.findOne(`[${Vs}]`));
    }
    _handlerMaxMinHoursOptions(t, e, s, n, o, r) {
      ...
      const {
        ...
        p = r.keyCode,
        f =
          r.target.hasAttribute(Vs) ||
          r.target.hasAttribute(Rt) ||
          r.target.hasAttribute(Po);
      (s = Ye(s, c, l)),
        (e = je(e, h, l)),
        typeof e != "number" && (e = Y(e, !1)[0]);
      const b = e !== "" ? e * 30 : "",
        v = s !== "" ? s * 30 : "";
      t < 0 && (t = 360 + t), (t = t === 360 ? 0 : t);
      const y = () => {
          const w = document.querySelectorAll(`[${Ro}]`),
            S = document.querySelectorAll(`[${Po}]`),
            k = xy(this._hour.innerText);
          let D, O, I;
          return (
            p === Ct ? (O = 1) : p === ut && (O = -1),
            k === 12 && p === Ct
              ...
              : (I = k + O),
            w.forEach((R) => {
              Number(R.textContent) === I && (D = R);
            }),
            S.forEach((R) => {
              Number(R.textContent) === I && (D = R);
            }),
            !D.parentElement.hasAttribute(Ke)
          );
        },
        x = () => {
          const w = s !== "" && s > 12 ? (s - 12) * 30 : "",
            S = e !== "" && e > 12 ? (e - 12) * 30 : "";
          if (!((w && t < w) || (S && t > S) || (e && e < 12))) return !0;
        };
      if (a && r.type !== "keydown" && f) return x();
      if (r.type === "keydown") return y();
      const E = !o || (o === "PM" && u) || (s !== "" && o === "AM" && d),
        T = !n || (n === "PM" && u) || (e !== "" && n === "AM" && d),
        C = () => {
          const w = v === 360 && l ? 0 : v;
          if (s) {
    ...
    _handleKeyboard() {
      g.on(this._document, Io, "", (t) => {
        ...
        (d = Ye(d, c, l)),
          (u = je(u, h, l)),
          typeof u != "number" && (u = Y(u, !1)[0]);
        const b = m.findOne(`[${vt}]`) === null,
          v = m.findOne(`[${Rt}]`) !== null,
          y = Number(this._hand.style.transform.replace(/[^\d-]/g, "")),
          x = m.find(`[${vt}]`, this._modal),
          E = m.find(`[${pt}]`, this._modal),
          T = m.find(`[${Rt}]`, this._modal);
        ...
        if (t.keyCode === Hs) {
          const I = m.findOne(`[${Ra}]`, this._modal);
          g.trigger(I, "click");
        } else if (b) {
          if (
            (v &&
              (t.keyCode === is &&
                ((this._isInner = !1),
                _.addStyle(this._hand, { height: "calc(40% + 1px)" }),
                (this._hour.textContent = this._setHourOrMinute(
                  C > 12 ? 1 : C
                )),
                this._toggleClassActive(this.hoursArray, this._hour, E),
                this._toggleClassActive(this.innerHours, this._hour, T)),
              t.keyCode === es &&
                ((this._isInner = !0),
                _.addStyle(this._hand, { height: "21.5%" }),
                (this._hour.textContent = this._setHourOrMinute(
                  O >= 24 || O === "00" ? 0 : O
                )),
                this._toggleClassActive(this.innerHours, this._hour, T),
                this._toggleClassActive(this.hoursArray, this._hour - 1, E))),
            t.keyCode === Ct)
          ) {
            if (!this._handlerMaxMinHoursOptions(A + 30, u, d, f, p, t)) return;
            _.addStyle(this._hand, { transform: `rotateZ(${A + w}deg)` }),
              this._isInner
                ? ((O += 1),
                  O === 24 ? (O = 0) : (O === 25 || O === "001") && (O = 13),
                  (this._hour.textContent = this._setHourOrMinute(O)),
                  this._toggleClassActive(this.innerHours, this._hour, T))
                : ((C += 1),
                  (this._hour.textContent = this._setHourOrMinute(
                    C > 12 ? 1 : C
    ...
    _setActiveClassToTipsOnOpen(t, ...e) {
      if (!this._isInvalidTimeFormat)
        if (this._options.format24) {
          const s = m.find(`[${pt}]`, this._modal),
            n = m.find(`[${Rt}]`, this._modal);
            ...
            (n) => (
              n === "PM"
                ? (_.addClass(this._PM, this._classes.opacity),
                  this._PM.setAttribute(J, ""))
                : n === "AM"
                ? (_.addClass(this._AM, this._classes.opacity),
                  this._AM.setAttribute(J, ""))
                : (_.removeClass(this._AM, this._classes.opacity),
                  _.removeClass(this._PM, this._classes.opacity),
    ...
    _setTipsAndTimesDependOnInputValue(t, e) {
      ...
      if (this._isInvalidTimeFormat)
        (this._hour.textContent = "12"),
          ...
          s || _.addStyle(this._hand, { transform: "rotateZ(0deg)" }),
          n &&
            (_.addClass(this._PM, this._classes.opacity),
            this._PM.setAttribute(J, ""));
      else {
        ...
        (this._hour.textContent = t),
          ...
          s ||
            (_.addStyle(this._hand, { transform: `rotateZ(${o}deg)` }),
            _.addStyle(this._circle, { backgroundColor: "#1976d2" }),
            (Number(t) > 12 || t === "00") &&
              _.addStyle(this._hand, { height: "21.5%" }));
      }
    ...
    _listenToToggleKeydown() {
      g.on(
        ...
        (t) => {
          t.keyCode === $t &&
            (t.preventDefault(), g.trigger(this.elementToggle, "click"));
        }
      );
    }
    _handleOpen() {
      ...
      li.on(
        ...
        (e) => {
          ...
          const s = _.getDataAttribute(this.input, "toggle") !== null ? 200 : 0;
          setTimeout(() => {
            _.addStyle(this.elementToggle, { pointerEvents: "none" }),
            ...
            if (
              ...
              this.input.blur(),
              e.target.blur(),
              (d.innerHTML = _y(this._options, this._classes)),
              _.addClass(d, this._classes.modal),
              d.setAttribute(Id, ""),
              d.setAttribute("role", "dialog"),
              d.setAttribute("tabIndex", "-1"),
              d.setAttribute("id", o),
              r
                ? ((this._popper = pi(this.input, d, {
              ...
              this._animations
                ...
                : _.addClass(this._wrapper, this._classes.opacity),
            ...
            if (
              ...
              const u = document.querySelector(`${Mo}[${J}]`);
              _.addClass(u, this._classes.opacity),
                _.addStyle(this._hour, { pointerEvents: "none" }),
                _.addStyle(this._minutes, { pointerEvents: "" });
            }
            (this._focusTrap = new Is(this._wrapper, {
              event: "keydown",
    ...
    _handleInlineClicks() {
      ...
      const s = (u) => {
          let p = u;
          return p > 59 ? (p = 0) : p < 0 && (p = 59), p;
        },
        n = (u) => {
          let p = u;
          return (
            this._options.format24
              ? (p > 24 ? (p = 1) : p < 0 && (p = 23), p > 23 && (p = 0))
              : (p > 12 ? (p = 1) : p < 1 && (p = 12), p > 12 && (p = 1)),
            p
          );
        },
        o = (u) => {
          const p = n(u);
          this._hour.textContent = this._setHourOrMinute(p);
        },
        r = (u) => {
          const p = s(u);
          this._minutes.textContent = this._setHourOrMinute(p);
        },
        a = () => {
          (t += 1), o(t);
        },
      ...
      li.on(
        ...
        (u) => {
          ...
          const { target: p, type: f } = u,
            b = f === "mousedown" || f === "touchstart";
          p.closest(`[${Na}]`)
            ? p.closest(`[${Na}]`).parentNode.hasAttribute(kd)
              ? b
                ? d(a)
                : f === "mouseup" || f === "touchend" || f === "contextmenu"
                ? clearInterval(this._interval)
                : a()
              : b
              ? d(l)
              ...
              : l()
            : p.closest(`[${Ba}]`) &&
              (p.closest(`[${Ba}]`).parentNode.hasAttribute(kd)
                ? b
                  ? d(c)
                  : f === "mouseup" || f === "touchend"
                  ? clearInterval(this._interval)
                  : c()
                : b
                ? d(h)
        ...
        g.on(window, Io, (u) => {
          const p = u.code,
            f = document.activeElement.hasAttribute($o),
            b = document.activeElement.hasAttribute(Wa),
            v = document.activeElement === document.body;
          switch (
            ((t = Number(this._hour.textContent)),
            (e = Number(this._minutes.textContent)),
            p)
            ...
            case "ArrowUp":
              u.preventDefault(), v || f ? (this._hour.focus(), a()) : b && l();
              break;
            case "ArrowDown":
              u.preventDefault(), v || f ? (this._hour.focus(), c()) : b && h();
              break;
          }
        });
    }
      ...
      g.on(
        ...
        ({ target: t }) => {
          const { closeModalOnBackdropClick: e } = this._options,
            s = () => {
              var n;
              _.addStyle(this.elementToggle, { pointerEvents: "auto" }),
    ...
    _handleOkButton() {
      li.on(this._modal, "click", `[${Pa}]`, () => {
        ...
        (e !== "" &&
          ((w && (T || k)) || (E === "PM" && c.textContent === "AM"))) ||
          (by(this._options, this.input, this._hour.textContent) !== void 0 &&
            (this._isInvalidTimeFormat && this.input.removeAttribute(Ha),
            ...
            this._animations && this._toggleBackdropAnimation(!0),
            this._removeModal(),
            g.trigger(this.input, "input.te.timepicker"),
            g.trigger(this.input, "input")));
      });
    }
    _handleHoverInlineBtn() {
      li.on(
        ...
        `[${Oy}]`,
        ({ type: t, target: e }) => {
          const s = m.find(`[${ky}]`, this._modal),
            n = m.find(`[${Sy}]`, this._modal),
            o = (l, c) =>
              l.forEach((h) => {
                if (c) {
                  _.addClass(h, this._classes.opacity), h.setAttribute(J, "");
                  return;
                }
                _.removeClass(h, this._classes.opacity), h.removeAttribute(J);
              }),
            a = e.hasAttribute($o) ? s : n;
          o(a, t === "mouseover");
        }
      );
    }
    _handleDocumentClickInline() {
      g.on(document, md, ({ target: t }) => {
        if (this._modal && !this._modal.contains(t) && !t.hasAttribute(wy)) {
          if (
            (clearInterval(this._interval),
            _.addStyle(this.elementToggle, { pointerEvents: "auto" }),
            this._removeModal(),
    ...
    _handleSwitchHourMinute() {
      my("click", Mo, this._classes),
        g.on(this._modal, "click", Mo, () => {
          const { format24: t } = this._options,
            e = m.find(Mo, this._modal),
            s = m.find(`[${vt}]`, this._modal),
            n = m.find(`[${pt}]`, this._modal),
            o = m.find(`[${Rt}]`, this._modal),
            r = Number(this._hour.textContent),
            a = Number(this._minutes.textContent),
            l = (c, h) => {
              n.forEach((u) => u.remove()),
                s.forEach((u) => u.remove()),
                _.addClass(this._hand, this._classes.transform),
                setTimeout(() => {
                  _.removeClass(this._hand, this._classes.transform);
                }, 401),
                this._getAppendClock(c, `[${Ei}]`, h);
              const d = () => {
                const u = m.find(`[${pt}]`, this._modal),
                  p = m.find(`[${vt}]`, this._modal);
                this._addActiveClassToTip(u, r),
                  this._addActiveClassToTip(p, a);
              };
              if (!t)
                setTimeout(() => {
                  d();
          ...
          e.forEach((c) => {
            c.hasAttribute(J) &&
              (c.hasAttribute(Wa)
                ? (_.addClass(this._hand, this._classes.transform),
                  _.addStyle(this._hand, {
                    transform: `rotateZ(${this._minutes.textContent * 6}deg)`,
                    height: "calc(40% + 1px)",
                  }),
                  t && o.length > 0 && o.forEach((h) => h.remove()),
                  l(this.minutesArray, vt),
                  ...
                  Number(this._hour.textContent) > 12
                    ? (_.addStyle(this._hand, {
                      ...
                      Number(this._hour.textContent) > 12 &&
                        _.addStyle(this._hand, { height: "21.5%" }))
                    : _.addStyle(this._hand, { height: "calc(40% + 1px)" }),
                  t && this._getAppendClock(this.innerHours, `[${Vs}]`, Rt),
                  o.length > 0 && o.forEach((h) => h.remove()),
                  l(this.hoursArray, pt),
                  _.addStyle(this._hour, { pointerEvents: "none" }),
                  _.addStyle(this._minutes, { pointerEvents: "" })));
          });
        });
    ...
    _handleDisablingTipsMaxTime(t, e, s, n) {
      ...
      const o = m.find(`[${pt}]`),
        ...
        a = m.find(`[${vt}]`);
      if (!e || e === t) {
        pd(r, n, this._classes, this._options.format12),
          pd(o, n, this._classes, this._options.format12),
          vy(
            a,
            s,
            n,
      ...
      e === "AM" &&
        t === "PM" &&
        (o.forEach((l) => {
          _.addClass(l, this._classes.tipsDisabled), l.setAttribute(Ke, "");
        }),
        a.forEach((l) => {
          _.addClass(l, this._classes.tipsDisabled), l.setAttribute(Ke, "");
        }));
    ...
    _handleDisablingTipsMinTime(t, e, s, n) {
      ...
      const o = m.find(`[${pt}]`),
        ...
        a = m.find(`[${vt}]`);
      !e || e === t
        ? (fd(o, n, this._classes, this._options.format12),
          fd(r, n, this._classes, this._options.format12),
          yy(
            a,
            s,
            n,
    ...
    _handleSwitchTimeMode() {
      g.on(document, "click", Lo, ({ target: t }) => {
        let { maxTime: e, minTime: s } = this._options;
        const { disablePast: n, disableFuture: o, format12: r } = this._options;
        (s = Ye(s, n, r)), (e = je(e, o, r));
        const [a, l, c] = Y(e, !1),
          [h, d, u] = Y(s, !1),
          p = m.find(`[${pt}]`),
          f = m.find(`[${vt}]`);
        (() => {
          p.forEach((v) => {
            _.removeClass(v, this._classes.tipsDisabled), v.removeAttribute(Ke);
          }),
            f.forEach((v) => {
              _.removeClass(v, this._classes.tipsDisabled),
                v.removeAttribute(Ke);
            });
        })(),
          ...
          t.hasAttribute(J) ||
            (m.find(Lo).forEach((y) => {
              y.hasAttribute(J) &&
                (_.removeClass(y, this._classes.opacity), y.removeAttribute(J));
            }),
            _.addClass(t, this._classes.opacity),
            t.setAttribute(J, ""));
      });
    }
    _handleClockClick() {
        ...
        (d) => {
          ...
          const { type: u, target: p } = d,
            { closeModalOnMinutesClick: f, switchHoursToMinutesOnClick: b } =
              this._options,
            v = m.findOne(`[${vt}]`, this._modal) !== null,
            y = m.findOne(`[${pt}]`, this._modal) !== null,
            x = m.findOne(`[${Rt}]`, this._modal) !== null,
            E = m.find(`[${vt}]`, this._modal),
            T = hd(d, h),
            C = h.offsetWidth / 2;
          let A = Math.atan2(T.y - C, T.x - C);
          if (Oo()) {
            const D = hd(d, h, !0);
          ...
          if (
            ...
            if (
              ...
              g.trigger(this._minutes, "click");
            }
            if (v && f) {
              const D = m.findOne(`[${Pa}]`, this._modal);
              g.trigger(D, "click");
            }
          }
          if (v) {
            let D;
            const O = Math.trunc((A * 180) / Math.PI) + 90,
              { degrees: I, minute: R } = this._makeMinutesDegrees(O, D);
            if (this._handlerMaxMinMinutesOptions(I, R) === void 0) return;
            const { degrees: X, minute: $ } = this._handlerMaxMinMinutesOptions(
              I,
              R
            );
            if (this._isMouseMove) {
              if (
                (_.addStyle(this._hand, { transform: `rotateZ(${X}deg)` }),
                $ === void 0)
              )
                return;
              const z = () => ($ >= 10 || $ === "00" ? $ : `0${$}`);
              (this._minutes.textContent = z()),
                this._toggleClassActive(this.minutesArray, this._minutes, E),
                this._toggleBackgroundColorCircle(`[${vt}]`),
                (this._objWithDataOnChange.degreesMinutes = X),
                (this._objWithDataOnChange.minutes = $);
            }
          }
          if (y || x) {
            let D,
              O = Math.trunc((A * 180) / Math.PI) + 90;
            if (
              ((O = Math.round(O / 30) * 30),
              _.addStyle(this._circle, { backgroundColor: "#1976d2" }),
              this._makeHourDegrees(p, O, D) === void 0)
            )
              return;
            const I = () => {
              if (Oo() && O && k) {
                const { degrees: R, hour: X } = this._makeHourDegrees(k, O, D);
                return this._handleMoveHand(k, X, R);
              } else {
                const { degrees: R, hour: X } = this._makeHourDegrees(p, O, D);
                return this._handleMoveHand(p, X, R);
              }
            };
            (this._objWithDataOnChange.degreesHours = O),
              this._handlerMaxMinHoursOptions(O, l, c, r, a, d) && I();
          }
          d.stopPropagation();
        }
      );
    ...
    _hasTargetInnerClass(t) {
      return t.hasAttribute(Vs) || t.hasAttribute(Rt) || t.hasAttribute(Po);
    }
    _handleMoveHand(t, e, s) {
      const n = m.find(`[${pt}]`, this._modal),
        o = m.find(`[${Rt}]`, this._modal);
      this._isMouseMove &&
        (this._hasTargetInnerClass(t)
          ? _.addStyle(this._hand, { height: "21.5%" })
          : _.addStyle(this._hand, { height: "calc(40% + 1px)" }),
        _.addStyle(this._hand, { transform: `rotateZ(${s}deg)` }),
    ...
    _handlerMaxMinMinutesOptions(t, e) {
      ...
      if (!b && !v) {
        if (s !== "" && n !== "") {
          if ((Number(f) === T && t > y) || (Number(p) === T && t < x))
            return t;
        } else if (n !== "" && T <= Number(p)) {
          if (t <= x - 6) return t;
        } else if (s !== "" && T >= Number(f) && t >= y + 6) return t;
      } else {
        if (n !== "") {
          if (v === "PM" && this._isAmEnabled) return;
          if (v === "PM" && this._isPmEnabled) {
            if (T < Number(p)) return;
            if (T <= Number(p) && t <= x - 6) return t;
    ...
    _toggleBackdropAnimation(t = !1) {
      t
        ...
        : (this._wrapper.classList.add("animate-[fade-in_350ms_ease-in-out]"),
          this._options.inline ||
            _.addClass(this._clock, this._classes.clockAnimation)),
        setTimeout(() => {
    ...
    _addActiveClassToTip(t, e) {
      t.forEach((s) => {
        Number(s.textContent) === Number(e) &&
          (_.addClass(s, this._classes.tipsActive), s.setAttribute(J, ""));
      });
    }
    _setHourOrMinute(t) {
      return t < 10 ? `0${t}` : t;
    ...
    _appendTimes() {
      const { format24: t } = this._options;
      if (t) {
        this._getAppendClock(this.hoursArray, `[${Ei}]`, pt),
          this._getAppendClock(this.innerHours, `[${Vs}]`, Rt);
        return;
      }
      this._getAppendClock(this.hoursArray, `[${Ei}]`, pt);
    }
    _getConfig(t) {
      const e = _.getDataAttributes(this._element);
      return (t = { ...My, ...e, ...t }), P(Ws, t, Ly), t;
    }
    _getClasses(t) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...$y, ...e, ...t }), P(Ws, t, Ry), t;
    }
    _getContainer() {
      return m.findOne(this._options.container);
    }
    _getValidate(t) {
      ...
      o &&
        ((r = L("div")),
        r.setAttribute(Sd, ""),
        _.addClass(r, this._classes.invalidFeedback),
        (r.innerHTML = e)),
        li.on(this.input, t, ({ target: a }) => {
          ...
          if ((c.test(a.value) !== !0 && s) || (h !== !0 && n)) {
            o &&
              (this.input.setAttribute(Ha, ""),
              this.input.parentNode.insertBefore(r, this.input.nextSibling)),
              _.addStyle(a, { marginBottom: 0 }),
              _.addStyle(r, { bottom: "-23px" }),
              (this._isInvalidTimeFormat = !0);
            return;
          }
          this.input.removeAttribute(Ha), (this._isInvalidTimeFormat = !1);
          const u = m.findOne(`[${Sd}]`);
          u !== null && u.remove();
        });
    }
    static getInstance(t) {
      return M.getData(t, Do);
    }
    static getOrCreateInstance(t, e = {}) {
      return (
        this.getInstance(t) || new this(t, typeof e == "object" ? e : null)
  ...
  const Py = { threshold: 10, direction: "all" };
  class Ny {
    constructor(t, e) {
      (this._element = t),
    ...
    handleTouchMove(t) {
      ...
      const e = this._getCoordinates(t),
        s = { x: e.x - this._startPosition.x, y: e.y - this._startPosition.y },
      ...
      if (this._options.direction === "all") {
        ...
        g.trigger(this._element, `swipe${r}`),
          g.trigger(this._element, "swipe", { direction: r }),
          (this._startPosition = null);
        return;
      }
      const o =
      ...
      n[o].direction === this._options.direction &&
        ...
        (g.trigger(this._element, `swipe${n[o].direction}`),
        (this._startPosition = null));
    }
    handleTouchEnd() {
      this._startPosition = null;
  ...
  class Nd {
    constructor(t, e) {
      (this._element = t),
        ...
        (this._steps = m.find(`${Ue}`, this._element)),
        (this._currentView = ""),
        (this._activeStepIndex = 0),
        (this._verticalStepperStyles = []),
        this._element && (M.setData(t, No, this), this._init());
    }
    static get NAME() {
      return Ya;
    }
    ...
    dispose() {
      this._steps.forEach((t) => {
        g.off(t, Ld), g.off(t, $d);
      }),
        g.off(window, Rd),
        M.removeData(this._element, No),
        (this._element = null);
    }
    changeStep(t) {
      this._toggleStep(t);
    ...
    _init() {
      const t = m
          .find(`${Ue}`, this._element)
          [this._activeStepIndex].setAttribute("data-te", "active-step"),
        e = m.find(`${Pd}`, this._element),
        s = m.find(`${Ho}`, this._element);
      switch (
        (t
          ? ((this._activeStepIndex = this._steps.indexOf(t)),
            ...
            s[this._activeStepIndex].classList.add("!bg-primary-100"),
            s[this._activeStepIndex].classList.add("!text-primary-700"))
          : (e[this._activeStepIndex].classList.add("font-medium"),
            s[this._activeStepIndex].classList.add("!bg-primary-100"),
            s[this._activeStepIndex].classList.add("!text-primary-700"),
            this._toggleStepClass(
    ...
    _getConfig(t) {
      const e = _.getDataAttributes(this._element);
      return (t = { ...Fy, ...e, ...t }), P(Ya, t, Hy), t;
    }
    _bindMouseDown() {
      this._steps.forEach((t) => {
        const e = m.findOne(`${yt}`, t);
        g.on(e, Ld, (s) => {
          const n = m.parents(s.target, `${Ue}`)[0],
    ...
    _bindResize() {
      g.on(window, Rd, () => {
        this._currentView === _e && this._setSingleStepHeight(this.activeStep),
          this._currentView === Ys && this._setHeight(this.activeStep),
          (this._options.stepperVerticalBreakpoint ||
            this._options.stepperMobileBreakpoint) &&
            this._toggleStepperView();
      });
    ...
    _toggleStepperView() {
      const t = this._options.stepperVerticalBreakpoint < window.innerWidth,
        ...
        s = this._options.stepperMobileBreakpoint > window.innerWidth;
      t && this._currentView !== Ys && this._toggleHorizontal(),
        e &&
          !s &&
          this._currentView !== _e &&
    ...
    _bindKeysNavigation() {
      this._toggleStepTabIndex(!1, m.findOne(`${yt}`, this.activeStep)),
        this._steps.forEach((t) => {
          const e = m.findOne(`${yt}`, t);
          g.on(e, $d, (s) => {
            const n = m.parents(s.currentTarget, `${Ue}`)[0],
              o = m.next(n, `${Ue}`)[0],
              r = m.prev(n, `${Ue}`)[0],
              a = m.findOne(`${yt}`, n),
              l = m.findOne(`${yt}`, this.activeStep);
            let c = null,
              h = null;
            if (
              (o && (c = m.findOne(`${yt}`, o)),
              ...
              const d = m.findOne(`${yt}`, this._steps[0]);
            ...
            (s.keyCode === $t || s.keyCode === yo) &&
              (s.preventDefault(), this.changeStep(this._steps.indexOf(n))),
              s.keyCode === Fs &&
            ...
            g.on(e, Wy, (s) => {
              const n = m.parents(s.currentTarget, `${Ue}`)[0],
                o = m.findOne(`${yt}`, n),
                r = m.findOne(`${yt}`, this.activeStep);
              s.keyCode === Fs &&
    ...
    _toggleDisabled() {
      const t = m.find(`${yt}`, this._element),
        e = m.find(`${Ho}`, this._element);
    ...
    _toggleActive(t) {
      const e = m.find(`${Pd}`, this._element),
        s = m.find(`${Ho}`, this._element);
      e[t].classList.add("font-medium"),
        s[t].classList.add("!bg-primary-100"),
        s[t].classList.add("!text-primary-700"),
        s[t].classList.remove("!bg-success-100"),
        s[t].classList.remove("!text-success-700"),
        e[this._activeStepIndex].classList.remove("font-medium"),
        s[this._activeStepIndex].classList.remove("!bg-primary-100"),
        s[this._activeStepIndex].classList.remove("!text-primary-700"),
    ...
    _toggleCompleted(t) {
      const e = m.find(`${Ho}`, this._element);
    ...
    _hideInactiveSteps() {
      this._steps.forEach((t) => {
        t.getAttribute("data-te") || this._hideElement(m.findOne(`${At}`, t));
      });
    }
    _setHeight(t) {
      const e = m.findOne(`${At}`, t),
        ...
        r =
          e.offsetHeight + parseFloat(s.marginTop) + parseFloat(s.marginBottom),
        a =
          n.offsetHeight + parseFloat(o.marginTop) + parseFloat(o.marginBottom);
      this._element.style.height = `${a + r}px`;
    }
    _hideElement(t) {
      (!m.parents(t, `${Ue}`)[0].getAttribute("data-te") &&
        this._currentView !== _e) ||
    ...
    _animateHorizontalStep(t) {
      ...
      e
        ? ((r = l),
          (o = c),
          s.classList.remove("translate-x-[150%]"),
          s.classList.remove("-translate-x-[150%]"))
        : ((r = a),
          (o = c),
          s.classList.remove("-translate-x-[150%]"),
    ...
    _animateVerticalStep(t) {
      const e = m.findOne(`${At}`, this._steps[t]),
        s = m.findOne(`${At}`, this.activeStep);
      this._hideElement(s), this._showElement(e);
    }
    static getInstance(t) {
      return M.getData(t, No);
    }
    static getOrCreateInstance(t, e = {}) {
      return (
        this.getInstance(t) || new this(t, typeof e == "object" ? e : null)
  ...
  const Bd = "data-te-input-state-active",
    Fo = "data-te-input-selected",
    Hd = "data-te-input-multiple-active",
    Fd = "[data-te-form-check-input]";
  class Wd {
    ...
    _selectMultiple() {
      if (!this.selected) {
        const t = m.findOne(Fd, this.node);
        (t.checked = !0),
          this.node.setAttribute(Fo, ""),
          this.node.setAttribute("aria-selected", !0),
          (this.selected = !0),
    ...
    setActiveStyles() {
      if (!this.active) {
        if (this.multiple) {
          this.node.setAttribute(Hd, "");
          return;
        }
        (this.active = !0), this.node.setAttribute(Bd, "");
      }
    }
    removeActiveStyles() {
      this.active && ((this.active = !1), this.node.removeAttribute(Bd)),
        this.multiple && this.node.removeAttribute(Hd);
    }
  }
  class Vy {
    constructor(t = !1) {
  ...
  const zy = "data-te-select-form-outline-ref",
    Yy = "data-te-select-wrapper-ref",
    jy = "data-te-select-input-ref",
    Ky = "data-te-select-clear-btn-ref",
    Uy = "data-te-select-dropdown-container-ref",
    Xy = "data-te-select-dropdown-ref",
    Gy = "data-te-select-options-wrapper-ref",
    qy = "data-te-select-options-list-ref",
    Zy = "data-te-select-input-filter-ref",
    Vd = "data-te-select-option-ref",
    Qy = "data-te-select-option-all-ref",
    Jy = "data-te-select-option-text-ref",
    tx = "data-te-form-check-input",
    ex = "data-te-select-option-group-ref",
    ix = "data-te-select-option-group-label-ref",
    zd = "data-te-select-selected",
    sx = `
...
`,
  ...
  function Wo(i, t, e, s, n) {
    t.selectSize === "default" && _.addClass(i, e),
      t.selectSize === "sm" && _.addClass(i, s),
      t.selectSize === "lg" && _.addClass(i, n);
  }
  function ox(i, t, e, s) {
    const n = document.createElement("div");
    n.setAttribute("id", i), n.setAttribute(Yy, "");
    const o = L("div");
    o.setAttribute(zy, ""), _.addClass(o, s.formOutline);
    const r = L("input"),
      a = t.selectFilter ? "combobox" : "listbox",
      l = t.multiple ? "true" : "false",
      c = t.disabled ? "true" : "false";
    r.setAttribute(jy, ""),
      _.addClass(r, s.selectInput),
      Wo(
        r,
        t,
        s.selectInputSizeDefault,
        s.selectInputSizeSm,
        s.selectInputSizeLg
      ),
      t.selectFormWhite && _.addClass(r, s.selectInputWhite),
      r.setAttribute("type", "text"),
      r.setAttribute("role", a),
      r.setAttribute("aria-multiselectable", l),
      r.setAttribute("aria-disabled", c),
      r.setAttribute("aria-haspopup", "true"),
      r.setAttribute("aria-expanded", !1),
      t.tabIndex && r.setAttribute("tabIndex", t.tabIndex),
      t.disabled && r.setAttribute("disabled", ""),
      t.selectPlaceholder !== "" &&
      ...
      t.selectValidation
        ? (_.addStyle(r, {
          ...
          _.addStyle(o, { cursor: "pointer" }))
        : r.setAttribute("readonly", "true"),
      t.selectValidation &&
        (r.setAttribute("required", "true"),
        r.setAttribute("aria-required", "true"),
        r.addEventListener("keydown", nx));
    const h = L("div");
    _.addClass(h, s.selectValidationValid);
    const d = document.createTextNode(`${t.selectValidFeedback}`);
    h.appendChild(d);
    const u = L("div");
    _.addClass(u, s.selectValidationInvalid);
    const p = document.createTextNode(`${t.selectInvalidFeedback}`);
    u.appendChild(p);
    const f = L("span");
    f.setAttribute(Ky, ""),
      _.addClass(f, s.selectClearBtn),
      Wo(f, t, s.selectClearBtnDefault, s.selectClearBtnSm, s.selectClearBtnLg),
      t.selectFormWhite && _.addClass(f, s.selectClearBtnWhite);
    const b = document.createTextNode("✕");
    f.appendChild(b), f.setAttribute("tabindex", "0");
    const v = L("span");
    return (
      _.addClass(v, s.selectArrow),
      Wo(v, t, s.selectArrowDefault, s.selectArrowSm, s.selectArrowLg),
      t.selectFormWhite && _.addClass(v, s.selectArrowWhite),
      (v.innerHTML = sx),
      o.appendChild(r),
      e &&
        (_.addClass(e, s.selectLabel),
        Wo(
          e,
          t,
          s.selectLabelSizeDefault,
          s.selectLabelSizeSm,
          s.selectLabelSizeLg
        ),
        t.selectFormWhite && _.addClass(e, s.selectLabelWhite),
        o.appendChild(e)),
      t.selectValidation && (o.appendChild(h), o.appendChild(u)),
      t.selectClearButton && o.appendChild(f),
      o.appendChild(v),
      n.appendChild(o),
      n
    );
  }
  function Yd(i, t, e, s, n, o, r, a) {
    const l = document.createElement("div");
    l.setAttribute(Uy, ""),
      _.addClass(l, a.selectDropdownContainer),
      l.setAttribute("id", `${i}`),
      (l.style.width = `${e}px`);
    const c = document.createElement("div");
    c.setAttribute("tabindex", 0),
      c.setAttribute(Xy, ""),
      _.addClass(c, a.dropdown);
    const h = L("div");
    h.setAttribute(Gy, ""),
      _.addClass(h, a.optionsWrapper),
      _.addClass(h, a.optionsWrapperScrollbar),
      (h.style.maxHeight = `${s}px`);
    const d = jd(o, n, t, a);
    return (
      h.appendChild(d),
      t.selectFilter && c.appendChild(rx(t.selectSearchPlaceholder, a)),
      c.appendChild(h),
      r && c.appendChild(r),
      l.appendChild(c),
      l
  ...
  function jd(i, t, e, s) {
    const n = L("div");
    n.setAttribute(qy, ""), _.addClass(n, s.optionsList);
    let o;
    return (
      e.multiple ? (o = lx(i, t, e, s)) : (o = ax(i, e, s)),
      o.forEach((r) => {
        n.appendChild(r);
      }),
      n
  ...
  function rx(i, t) {
    const e = L("div");
    _.addClass(e, t.inputGroup);
    const s = L("input");
    return (
      s.setAttribute(Zy, ""),
      _.addClass(s, t.selectFilterInput),
      (s.placeholder = i),
      s.setAttribute("role", "searchbox"),
  ...
  function cx(i, t, e, s) {
    ...
    return (
      o.setAttribute(Vd, ""),
      _.addClass(o, s.selectOption),
      o.setAttribute(Qy, ""),
      _.addStyle(o, { height: `${e.selectOptionHeight}px` }),
      o.setAttribute("role", "option"),
      o.setAttribute("aria-selected", n),
      n && o.setAttribute(zd, ""),
      o.appendChild(Xd(i, e, s)),
      i.setNode(o),
      o
    );
  }
  function Ud(i, t, e) {
    ...
    return (
      s.setAttribute(Vd, ""),
      _.addClass(s, e.selectOption),
      _.addStyle(s, { height: `${t.selectOptionHeight}px` }),
      _.setDataAttribute(s, "id", i.id),
      s.setAttribute("role", "option"),
      s.setAttribute("aria-selected", i.selected),
      s.setAttribute("aria-disabled", i.disabled),
      i.selected && s.setAttribute(zd, ""),
      i.disabled && s.setAttribute("data-te-select-option-disabled", !0),
      i.hidden && _.addClass(s, "hidden"),
      s.appendChild(Xd(i, t, e)),
      i.icon && s.appendChild(ux(i, e)),
      i.setNode(s),
      s
    );
  }
  function Xd(i, t, e) {
    const s = L("span");
    s.setAttribute(Jy, ""), _.addClass(s, e.selectOptionText);
    const n = document.createTextNode(i.label);
    return (
      t.multiple && s.appendChild(dx(i, e)),
      s.appendChild(n),
      (i.secondaryText || typeof i.secondaryText == "number") &&
        s.appendChild(hx(i.secondaryText, e)),
      s
    );
  }
  function hx(i, t) {
    const e = L("span");
    _.addClass(e, t.selectOptionSecondaryText);
  ...
  function dx(i, t) {
    ...
    e.setAttribute("type", "checkbox"),
      _.addClass(e, t.formCheckInput),
      e.setAttribute(tx, "");
    const s = L("label");
    return (
      i.selected && e.setAttribute("checked", !0),
  ...
  function ux(i, t) {
    const e = L("span"),
      s = L("img");
    return (
      _.addClass(s, t.selectOptionIcon), (s.src = i.icon), e.appendChild(s), e
    );
  }
  function px(i, t, e) {
    const s = L("div");
    s.setAttribute(ex, ""),
      _.addClass(s, e.selectOptionGroup),
    ...
    return (
      n.setAttribute(ix, ""),
      _.addClass(n, e.selectOptionGroupLabel),
      _.addStyle(n, { height: `${t.selectOptionHeight}px` }),
      n.setAttribute("for", i.id),
      (n.textContent = i.label),
      s.appendChild(n),
      i.options.forEach((o) => {
        s.appendChild(Ud(o, t, e));
      }),
      s
    );
  }
  function fx(i, t) {
    ...
    return (
      (e.innerHTML = i),
      _.addClass(e, t.selectLabel),
      _.addClass(e, t.selectFakeValue),
      e
    );
  }
  const Ka = "select",
    ...
    gx = `open${Ks}`,
    Gd = `optionSelect${Ks}`,
    qd = `optionDeselect${Ks}`,
    mx = `valueChange${Ks}`,
    bx = "change",
    Zd = "data-te-select-init",
    Qd = "data-te-select-no-results-ref",
    Jd = "data-te-select-open",
    xt = "data-te-input-state-active",
    Xe = "data-te-input-focused",
    Ua = "data-te-input-disabled",
    vx = "data-te-select-option-group-label-ref",
    yx = "data-te-select-option-all-ref",
    Us = "data-te-select-selected",
    xx = "[data-te-select-label-ref]",
    tu = "[data-te-select-input-ref]",
    Tx = "[data-te-select-input-filter-ref]",
    Ex = "[data-te-select-dropdown-ref]",
    Cx = "[data-te-select-options-wrapper-ref]",
    eu = "[data-te-select-options-list-ref]",
    Ax = "[data-te-select-option-ref]",
    wx = "[data-te-select-clear-btn-ref]",
    kx = "[data-te-select-custom-content-ref]",
    Sx = `[${Qd}]`,
    iu = "[data-te-select-form-outline-ref]",
    Ox = "[data-te-select-toggle]",
    Xa = "[data-te-input-notch-ref]",
    Dx = 200,
    Ix = {
      selectAutoSelect: !1,
  ...
  class Xs {
    constructor(t, e, s) {
      (this._element = t),
        ...
        (this._selectionModel = new Vy(this.multiple)),
        (this._activeOptionIndex = -1),
        (this._activeOption = null),
        (this._wrapperId = Gt("select-wrapper-")),
        (this._dropdownContainerId = Gt("select-dropdown-container-")),
        (this._selectAllId = Gt("select-all-")),
        (this._debounceTimeoutId = null),
        (this._dropdownHeight =
          this._config.selectOptionHeight * this._config.selectVisibleOptions),
        (this._popper = null),
        (this._input = null),
        (this._label = m.next(this._element, xx)[0]),
        (this._notch = null),
        (this._fakeValue = null),
        (this._isFakeValueActive = !1),
        (this._customContent = m.next(t, kx)[0]),
        ...
        this._element && M.setData(t, js, this);
    }
    static get NAME() {
      return Ka;
    }
    ...
    get optionsList() {
      return m.findOne(eu, this._dropdownContainer);
    }
    get optionsWrapper() {
      return m.findOne(Cx, this._dropdownContainer);
    }
    get clearButton() {
      return m.findOne(wx, this._wrapper);
    }
    get options() {
    ...
    _createOptionObject(t, e = {}) {
      const s = Gt("option-"),
        ...
        r = t.selected || t.hasAttribute(Us),
        a = t.hasAttribute("disabled") || o,
        l = t.hasAttribute("hidden") || (e && e.hidden),
        c = this.multiple,
        h = t.value,
        d = t.label,
        u = _.getDataAttribute(t, "selectSecondaryText"),
        p = _.getDataAttribute(t, "select-icon");
      return new Wd(s, t, c, h, d, r, a, l, u, n, p);
    }
    ...
    _init() {
      this._renderMaterialWrapper(),
        ...
        (this._input = m.findOne(tu, this._wrapper)),
        this._config.disabled && this._input.setAttribute(Ua, "");
    ...
    _renderMaterialWrapper() {
      const t = ox(this._wrapperId, this._config, this._label, this._classes);
      this._element.parentNode.insertBefore(t, this._element),
        _.addClass(this._element, this._classes.initialized),
        t.appendChild(this._element);
    }
    _initOutlineInput() {
      const t = m.findOne(iu, this._wrapper);
      new Z(
        t,
        { inputFormWhite: this._config.selectFormWhite },
        this._classes
      ).init(),
        (this._notch = m.findOne(Xa, this._wrapper));
    }
    ...
    _listenToComponentKeydown() {
      g.on(this._wrapper, "keydown", this._handleKeydown.bind(this));
    }
    _handleKeydown(t) {
    ...
    _handleClosedKeydown(t) {
      ...
      if (
        ...
        (e === $t || (e === ut && t.altKey) || (e === ut && this.multiple)) &&
          this.open(),
        this.multiple)
      )
        switch (e) {
    ...
    _getNumberOfGroupsBeforeOption(t) {
      const e = this.options.filter((r) => !r.hidden),
        s = this._optionsToRender.filter((r) => !r.hidden),
    ...
    _updateActiveOption(t, e) {
      ...
      s && s.removeActiveStyles(),
        t.setActiveStyles(),
        (this._activeOptionIndex = e),
        (this._activeOption = t);
    }
    _listenToWrapperClick() {
      g.on(this._wrapper, "click", () => {
        this.toggle();
      });
    }
    _listenToClearBtnClick() {
      g.on(this.clearButton, "click", (t) => {
        t.preventDefault(), t.stopPropagation(), this._handleClear();
      });
    }
    _listenToClearBtnKeydown() {
      g.on(this.clearButton, "keydown", (t) => {
        t.keyCode === $t &&
    ...
    _listenToOptionsClick() {
      g.on(this.optionsWrapper, "click", (t) => {
        if (t.target.hasAttribute(vx)) return;
        const s =
          t.target.nodeName === "DIV" ? t.target : m.closest(t.target, Ax);
        if (s.hasAttribute(yx)) {
          this._handleSelectAll();
          return;
        }
        const o = s.dataset.teId,
    ...
    _singleOptionSelect(t) {
      ...
      e &&
        ...
        e.deselect(),
        e.node.setAttribute(Us, !1),
        g.trigger(this._element, qd, { value: e.value })),
        (!e || (e && t !== e)) &&
          (this._selectionModel.select(t),
          t.select(),
          t.node.setAttribute(Us, !0),
          g.trigger(this._element, Gd, { value: t.value }),
          this._emitValueChangeEvent(this.value),
          this._emitNativeChangeEvent());
    }
    _handleMultiSelection(t) {
      t.selected
        ? (this._selectionModel.deselect(t),
          t.deselect(),
          t.node.setAttribute(Us, !1),
          g.trigger(this._element, qd, { value: t.value }))
        : (this._selectionModel.select(t),
          t.select(),
          t.node.setAttribute(Us, !0),
          g.trigger(this._element, Gd, { value: t.value })),
    ...
    _emitValueChangeEvent(t) {
      g.trigger(this._element, mx, { value: t });
    }
    _emitNativeChangeEvent() {
      g.trigger(this._element, bx);
    }
    _updateInputValue() {
    ...
    _appendFakeValue() {
      ...
      (this._fakeValue = fx(t, this._classes)),
        m.findOne(iu, this._wrapper).appendChild(this._fakeValue);
    }
    _updateLabelPosition() {
      const t = this._element.hasAttribute(Zd),
        e = this._input.value !== "";
      this._label &&
        (t && (e || this._isOpen || this._isFakeValueActive)
          ? (this._label.setAttribute(xt, ""), this._notch.setAttribute(xt, ""))
          : (this._label.removeAttribute(xt),
            this._notch.removeAttribute(xt, "")));
    }
    _updateLabelPositionWhileClosing() {
      this._label &&
        (this._input.value !== "" || this._isFakeValueActive
          ? (this._label.setAttribute(xt, ""), this._notch.setAttribute(xt, ""))
          : (this._label.removeAttribute(xt), this._notch.removeAttribute(xt)));
    }
      ...
      this._fakeValue &&
        ...
        !this._config.selectPlaceholder
          ? ((this._isFakeValueActive = !0),
            this._fakeValue.setAttribute(xt, ""))
          : ((this._isFakeValueActive = !1),
            this._fakeValue.removeAttribute(xt)));
    }
    _updateClearButtonVisibility() {
      if (!this.clearButton) return;
      this._selectionModel.selection ||
      this._selectionModel.selections.length > 0
        ? _.addStyle(this.clearButton, { display: "block" })
        : _.addStyle(this.clearButton, { display: "none" });
    }
    ...
    _openDropdown() {
      (this._popper = pi(this._input, this._dropdownContainer, {
        placement: "bottom-start",
        modifiers: [{ name: "offset", options: { offset: [0, 1] } }],
      })),
        this._container.appendChild(this._dropdownContainer),
        setTimeout(() => {
          this.dropdown.setAttribute(Jd, "");
        }, 0);
    }
    _updateDropdownWidth() {
      const t = this._input.offsetWidth;
      _.addStyle(this._dropdownContainer, { width: `${t}px` });
    }
    _setFirstActiveOption() {
      ...
      const s = this.multiple
        ...
        : this._selectionModel.selection;
      s
        ? ((this._activeOption = s),
          s.setActiveStyles(),
          (this._activeOptionIndex = t.findIndex((n) => n === s)))
        : ((this._activeOption = null), (this._activeOptionIndex = -1));
    }
    _setInputActiveStyles() {
      this._input.setAttribute(Xe, ""),
        m.findOne(Xa, this._wrapper).setAttribute(Xe, "");
    }
    _listenToWindowResize() {
      g.on(window, "resize", this._handleWindowResize.bind(this));
    }
    _handleWindowResize() {
    ...
    _listenToSelectSearch() {
      this.filterInput.addEventListener("input", (t) => {
        const e = t.target.value,
          s = this._config.selectFilterDebounce;
    ...
    _filterOptions(t) {
      ...
      const s = this._config.selectNoResultText !== "",
        n = e.length !== 0;
      if (n)
    ...
    _updateOptionsListTemplate(t) {
      const e =
          m.findOne(eu, this._dropdownContainer) ||
          m.findOne(Sx, this._dropdownContainer),
        s = jd(t, this._selectAllOption, this._config, this._classes);
      this.optionsWrapper.removeChild(e), this.optionsWrapper.appendChild(s);
    }
    _getNoResultTemplate() {
      return `<div class="${this._classes.noResult}" ${Qd} style="height: ${this._config.selectOptionHeight}px">${this._config.selectNoResultText}</div>`;
    }
    _filter(t, e) {
    ...
    _listenToDropdownKeydown() {
      g.on(this.dropdown, "keydown", this._handleOpenKeydown.bind(this));
    }
    _listenToOutsideClick() {
      (this._outsideClick = this._handleOutSideClick.bind(this)),
        g.on(document, "click", this._outsideClick);
    }
    _listenToFocusChange(t = !0) {
      if (t === !1) {
        g.off(this._input, "focus", () => this._notch.setAttribute(Xe, "")),
          g.off(this._input, "blur", () => this._notch.removeAttribute(Xe));
        return;
      }
      g.on(this._input, "focus", () => this._notch.setAttribute(Xe, "")),
        g.on(this._input, "blur", () => this._notch.removeAttribute(Xe));
    }
    _handleOutSideClick(t) {
      const e = this._wrapper && this._wrapper.contains(t.target),
        s = t.target === this._dropdownContainer,
        n =
          this._dropdownContainer && this._dropdownContainer.contains(t.target);
      let o;
      this._toggleButton || (this._elementToggle = m.find(Ox)),
        this._elementToggle &&
          this._elementToggle.forEach((r) => {
            const a = _.getDataAttribute(r, "select-toggle");
    ...
    close() {
      const t = g.trigger(this._element, _x);
      !this._isOpen ||
        t.defaultPrevented ||
        (this._config.selectFilter &&
          this.hasSelectAll &&
        ...
        this.dropdown.removeAttribute(Jd),
        setTimeout(() => {
          this._input.removeAttribute(Xe),
            this._input.blur(),
            m.findOne(Xa, this._wrapper).removeAttribute(Xe),
            this._label &&
              !this.hasSelection &&
              (this._label.removeAttribute(xt),
              this._notch.setAttribute(xt, ""),
              this._input.removeAttribute(xt),
              this._notch.removeAttribute(xt)),
        ...
        setTimeout(() => {
          this._container &&
            ...
            (this._isOpen = !1),
            g.off(this.dropdown, "transitionend");
        }, Dx));
    }
    _resetFilterState() {
    ...
    _removeDropdownEvents() {
      g.off(document, "click", this._outsideClick),
        this._config.selectFilter && g.off(this.dropdown, "keydown"),
        g.off(this.optionsWrapper, "click");
    }
    ...
    _updateDisabledState() {
      const t = m.findOne(tu, this._wrapper);
    ...
    _createSelectAllOption() {
      const t = this._selectAllId,
        ...
        h = null,
        d = null;
      return new Wd(t, e, s, n, o, r, a, l, c, h, d);
    }
    dispose() {
      this._removeComponentEvents(),
        this._destroyMaterialSelect(),
        this._listenToFocusChange(!1),
        M.removeData(this._element, js);
    }
    _removeComponentEvents() {
      g.off(this.input, "click"),
        g.off(this.wrapper, this._handleKeydown.bind(this)),
        g.off(this.clearButton, "click"),
        g.off(this.clearButton, "keydown"),
        g.off(window, "resize", this._handleWindowResize.bind(this));
    }
    ...
    _destroyMaterialTemplate() {
      ...
      t.appendChild(this._element),
        ...
        _.removeClass(this._element, this._classes.initialized),
        this._element.removeAttribute(Zd),
        t.removeChild(this._wrapper);
    }
    setValue(t) {
      this.options
        .filter((s) => s.selected)
        .forEach((s) => (s.nativeOption.selected = !1)),
        Array.isArray(t)
          ? t.forEach((s) => {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        let s = M.getData(this, js);
        const n = typeof t == "object" && t;
        if (
          !(!s && /dispose/.test(t)) &&
          (s || (s = new Xs(this, n)), typeof t == "string")
        ) {
          if (typeof s[t] > "u") throw new TypeError(`No method named "${t}"`);
          s[t](e);
        }
  ...
  const Rx = (
    ...
    Vx = { text: "", closeIcon: !1, img: { path: "", alt: "" }, iconSVG: Fx },
    zx = {
  ...
  class Ci {
    ...
    dispose() {
      (this._element = null),
        (this._options = null),
        g.off(this._element, "click");
    }
    appendChip() {
      const { text: t, closeIcon: e, iconSVG: s } = this._options;
      return Px({ text: t, closeIcon: e, iconSVG: s }, this._classes);
    }
    _appendCloseIcon(t = this._element) {
      if (!(m.find(Ga, this._element).length > 0) && this._options.closeIcon) {
        const e = L("span");
    ...
    _handleClickOnChip() {
      g.on(this._element, "click", (t) => {
        const { textContent: e } = t.target,
          s = {};
        (s.tag = e.trim()), g.trigger(Hx, { event: t, obj: s });
      });
    }
    _handleDelete() {
      m.find(Ga, this._element).length !== 0 &&
        g.on(this._element, "click", Ga, () => {
          g.trigger(this._element, Bx), this._element.remove();
        });
    }
    _handleTextChip() {
    ...
    _getConfig(t) {
      const e = { ...Vx, ..._.getDataAttributes(this._element), ...t };
      return P(Vo, e, Wx), e;
    }
    _getClasses(t) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...zx, ...e, ...t }), P(Vo, t, Yx), t;
    }
    static getInstance(t) {
      return M.getData(t, Nx);
    }
    static getOrCreateInstance(t, e = {}) {
      return (
        this.getInstance(t) || new this(t, typeof e == "object" ? e : null)
  ...
  const Gs = "chips",
    ...
    ru = `${qs}-placeholder`,
    Kx = `${qs}-input-wrapper`,
    qa = "data-te-chip-init",
    au = "data-te-chip-close",
    lu = "data-te-chip-text",
    Ux = `[${Ht}]`,
    Za = `[${qa}]`,
    Xx = `${Za}${Ux}`,
    Qa = `[${au}]`,
    ...
    qx = `[${lu}]`,
    Zx = `[${ru}]`,
    Qx = "data-te-input-notch-leading-ref",
    Jx = "data-te-input-notch-middle-ref",
    tT = `[${Qx}]`,
    eT = `[${Jx}]`,
    os = "data-te-input-state-active",
    Ja = "[data-te-input-notch-ref]",
    iT = "add.te.chips",
    sT = "arrowDown.te.chips",
    nT = "arrowLeft.te.chips",
    oT = "arrowRight.te.chips",
    rT = "arrowUp.te.chips",
    cu = "delete.te.chips",
    hu = "select.te.chips",
    aT = {
  ...
  class du extends Ci {
    constructor(e, s = {}, n) {
      super(e, s);
      we(this, "_handleBlurInput", ({ target: e }) => {
        e.value.length > 0 && this._handleCreateChip(e, e.value),
          this.allChips.length > 0
            ? (e.setAttribute(Ht, ""),
              this.input.setAttribute(os, ""),
              m.findOne(Ja, this.input.parentNode).setAttribute(os, ""),
              this.chipsInputWrapper.classList.add(
                ...this._classes.inputWrapperPadding.split(" ")
              ))
            : (e.removeAttribute(Ht),
              this.input.removeAttribute(os),
              m.findOne(Ja, this.input.parentNode).removeAttribute(os),
              this.chipsInputWrapper.classList.remove(
                ...this._classes.inputWrapperPadding.split(" ")
              )),
          this.allChips.forEach((s) => s.removeAttribute(Ht));
      });
      (this._element = e),
        (this._inputInstance = null),
        this._element && M.setData(e, nu, this),
        (this._options = this._getConfig(s)),
    ...
    get activeChip() {
      return m.findOne(Xx, this._element);
    }
    get input() {
      return m.findOne("input", this._element);
    }
    get allChips() {
      return m.find(Za, this._element);
    }
    get chipsInputWrapper() {
      return m.findOne(Gx, this._element);
    }
    init() {
      this._setChipsClass(),
        this._appendInputToElement(ru),
    ...
    _getNotchData() {
      (this._notchMiddle = m.findOne(eT, this._element)),
        (this._notchLeading = m.findOne(tT, this._element));
    }
    _setChipsClass() {
      this._element.setAttribute(jx, "");
    }
    _handleDeleteEvents(e) {
      const [s] = this.allChips.slice(-1);
      if (this.activeChip === null) s.remove(), this._handleEvents(e, cu);
      else {
    ...
    _handleKeyboard() {
      g.on(this.input, "keydown", (e) => this._keyboardEvents(e));
    }
    _handleEditable() {
      ...
      e &&
        this.allChips.forEach((s) => {
          g.on(s, "dblclick", (n) => {
            const o = m.findOne(Qa, s);
            s.classList.add(...this._classes.contentEditable.split(" ")),
              (s.contentEditable = !0),
              s.focus(),
              setTimeout(() => {
                _.addStyle(o, { display: "none" });
              }, 200),
              o.classList.add(...this._classes.opacity.split(" ")),
              n.target.textContent,
              g.trigger(s, hu, { event: n, allChips: this.allChips });
          }),
            g.on(document, "click", ({ target: n }) => {
              const o = m.findOne(Qa, s),
                r = m.findOne(qx, s),
                a = n === s,
                l = s && s.contains(n);
              !a &&
                !l &&
                ((s.contentEditable = !1),
                s.classList.remove(...this._classes.contentEditable.split(" ")),
                r.textContent !== "" &&
                  setTimeout(() => {
                    _.addStyle(o, { display: "block" }),
    ...
    _handleRemoveActiveClass() {
      this.allChips.forEach((e) => e.removeAttribute(Ht));
    }
    _handleAddActiveClass() {
      this.allChips.forEach((e) => e.setAttribute(Ht, ""));
    }
    ...
    _handleClicksOnChips() {
      g.on(this._element, "click", () => {
        this.allChips.length === 0 &&
          (this.chipsInputWrapper.classList.remove(
            ...this._classes.inputWrapperPadding.split(" ")
          ),
          this.input.removeAttribute(Ht));
      });
    }
    _handleTextContent() {
      const e = [];
      return (
        this.allChips.forEach((s) => e.push({ tag: s.textContent.trim() })), e
      );
    }
    _handleEvents(e, s) {
      const n = this._handleTextContent(),
        o = this.allChips.filter((r) => r.hasAttribute(Ht) && r);
      g.trigger(this._element, s, {
        event: e,
    ...
    _handleChipsFocus() {
      g.on(this._element, "click", ({ target: { attributes: e } }) => {
        const s = [...e];
        s.includes(qa) ||
          s.includes(au) ||
          s.includes(lu) ||
    ...
    _handleInitialValue() {
      if ((this._appendInputToElement(ou), this._element.hasAttribute(ou))) {
        const { initialValues: e } = this._options;
        e.forEach(({ tag: s }) => this._handleCreateChip(this.input, s)),
          m.findOne(Ja, this.input.parentNode).setAttribute(os, ""),
          this.input.setAttribute(Ht, ""),
          this.input.setAttribute(os, "");
      }
      this.allChips.length > 0 &&
        (this.chipsInputWrapper.classList.add(
    ...
    _handleKeysInputToElement(e) {
      ...
      if (n.hasAttribute(qa)) {
        const o = m.findOne(Qa, n);
        s === $t &&
          ((n.contentEditable = !1),
    ...
    _handleInputText() {
      const e = m.findOne(Zx, this._element);
      g.on(this._element, "keyup", e, (s) => this._handleKeysInputToElement(s)),
        g.on(this.input, "blur", (s) => this._handleBlurInput(s));
    }
    _appendInputToElement(e) {
      if (!this._element.hasAttribute(e)) return;
      const s = Rx(this._options, this._classes);
    ...
    _handleCreateChip(e, s) {
      const n = L("div"),
        o = Ci.getInstance(n),
        r = new Ci(o, { text: s }, this._classes);
      this._options.parentSelector !== ""
        ...
        (e.value = ""),
        m.find(Za).forEach((a) => {
          let l = Ci.getInstance(a);
          return l || (l = new Ci(a, {}, this._classes)), l.init();
        }),
        this._handleEditable();
    }
    _handleChipsOnSelect() {
      this.allChips.forEach((e) => {
        g.on(this._element, "click", (s) => {
          g.trigger(e, hu, { event: s, allChips: this.allChips });
        });
      });
    }
    ...
    _getConfig(e) {
      const s = { ...lT, ..._.getDataAttributes(this._element), ...e };
      return P(Gs, s, aT), s;
    }
    _getClasses(e) {
      const s = _.getDataClassAttributes(this._element);
      return (e = { ...cT, ...s, ...e }), P(Gs, e, hT), e;
    }
    static getInstance(e) {
      return M.getData(e, nu);
    }
    static getOrCreateInstance(e, s = {}) {
      return (
        this.getInstance(e) || new this(e, typeof s == "object" ? s : null)
      );
    }
  }
  ...
  function pT(i) {
    ...
    return t === "[object RegExp]" || t === "[object Date]" || gT(i);
  }
  var fT = typeof Symbol == "function" && Symbol.for,
    _T = fT ? Symbol.for("react.element") : 60103;
  function gT(i) {
    return i.$$typeof === _T;
  }
  function mT(i) {
  ...
  function Qs(i, t) {
    return t.clone !== !1 && t.isMergeableObject(i) ? rs(mT(i), i, t) : i;
  }
  function bT(i, t, e) {
  ...
  function uu(i) {
    return Object.keys(i).concat(yT(i));
  }
  function pu(i, t) {
    try {
      return t in i;
  ...
  function xT(i, t) {
    return (
      ...
      !(
        ...
        Object.propertyIsEnumerable.call(i, t)
      )
    );
  }
  function TT(i, t, e) {
    var s = {};
    return (
      e.isMergeableObject(i) &&
        uu(i).forEach(function (n) {
          s[n] = Qs(i[n], e);
        }),
      uu(t).forEach(function (n) {
        xT(i, n) ||
          (pu(i, n) && e.isMergeableObject(t[n])
            ? (s[n] = vT(n, e)(i[n], t[n], e))
            : (s[n] = Qs(t[n], e)));
      }),
      s
    );
  ...
  function rs(i, t, e) {
    (e = e || {}),
      (e.arrayMerge = e.arrayMerge || bT),
      (e.isMergeableObject = e.isMergeableObject || dT),
      (e.cloneUnlessOtherwiseSpecified = Qs);
    var s = Array.isArray(t),
      n = Array.isArray(i),
      o = s === n;
    return o ? (s ? e.arrayMerge(i, t, e) : TT(i, t, e)) : Qs(t, e);
  }
  rs.all = function (t, e) {
  ...
  let _u = class M_ {
    ...
    async _getChartDataLabels() {
      return await Promise.resolve().then(() => gD);
    }
    ...
    update(t, e) {
      ...
      const s = Object.prototype.hasOwnProperty.call(e, "options")
        ? e
        : { options: { ...e } };
      (this._options = tl(this._options, s)),
        (this._chart.options = el(this._options, this._type, Zs).options),
        this._chart.update();
    }
    setTheme(t) {
    ...
    _getDarkConfig(t) {
      let e = {};
      const s = _.getDataAttributes(this._element);
      Object.keys(s).forEach((c) => c.startsWith("dark") && (e[c] = s[c])),
        (e = { ...AT, ...e });
      const n = {
          y: {
      ...
      return (t = { ...e, options: { ...l }, ...t }), P(fu, t, wT), t;
    }
    _chartConstructor() {
      if (this._data) {
        this._createCanvas();
        const t = el(this._options, this._type, Zs),
          e = [];
    ...
    static jQueryInterface(t, e, s) {
      return this.each(function () {
        let n = M.getData(this, zo);
        if (!(!n && /dispose/.test(t))) {
          if (!n) {
            const o = e ? el(e, s, Zs) : Zs[s];
            n = new M_(this, { ...t, ...o });
          }
          if (typeof t == "string") {
            if (typeof n[t] > "u")
  ...
  function qe(i, t) {
    if (!gu) throw new Error("No element matching method supported");
    return gu.call(i, t);
  }
  function as(i) {
  ...
  function vu(i, t) {
    var e = i.element.classList,
      s = at.state.scrolling(t);
    e.contains(s) ? clearTimeout(bu[t]) : e.add(s);
  }
  function yu(i, t) {
    bu[t] = setTimeout(function () {
  ...
  var Js = function (t) {
    ...
    xu = { isEmpty: { configurable: !0 } };
  (Js.prototype.bind = function (t, e) {
    typeof this.handlers[t] > "u" && (this.handlers[t] = []),
      this.handlers[t].push(e),
      this.element.addEventListener(t, e, !1);
  }),
    (Js.prototype.unbind = function (t, e) {
      var s = this;
      this.handlers[t] = this.handlers[t].filter(function (n) {
        return e && n !== e
          ? !0
          : (s.element.removeEventListener(t, n, !1), !1);
      });
    }),
    (Js.prototype.unbindAll = function () {
      for (var t in this.handlers) this.unbind(t);
    }),
    (xu.isEmpty.get = function () {
      var i = this;
      return Object.keys(this.handlers).every(function (t) {
        return i.handlers[t].length === 0;
      });
    }),
    Object.defineProperties(Js.prototype, xu);
  var ls = function () {
    this.eventElements = [];
  };
  (ls.prototype.eventElement = function (t) {
    var e = this.eventElements.filter(function (s) {
      return s.element === t;
    })[0];
    return e || ((e = new Js(t)), this.eventElements.push(e)), e;
  }),
    (ls.prototype.bind = function (t, e, s) {
      this.eventElement(t).bind(e, s);
    }),
    (ls.prototype.unbind = function (t, e, s) {
    ...
    (ls.prototype.once = function (t, e, s) {
      var n = this.eventElement(t),
        o = function (r) {
          n.unbind(e, o), s(r);
        };
  ...
  function ST(i, t, e, s, n) {
    ...
    var d = i.element;
    (i.reach[l] = null),
      d[a] < 1 && (i.reach[l] = "start"),
      d[a] > i[o] - i[r] - 1 && (i.reach[l] = "end"),
      t &&
        (d.dispatchEvent(jo("ps-scroll-" + l)),
        t < 0
          ? d.dispatchEvent(jo("ps-scroll-" + c))
          : t > 0 && d.dispatchEvent(jo("ps-scroll-" + h)),
        s && kT(i, l)),
      i.reach[l] &&
        (t || n) &&
        d.dispatchEvent(jo("ps-" + l + "-reach-" + i.reach[l]));
  }
  function it(i) {
  ...
  function OT(i) {
    return (
      qe(i, "input,[contenteditable]") ||
      qe(i, "select,[contenteditable]") ||
      qe(i, "textarea,[contenteditable]") ||
      qe(i, "button,[contenteditable]")
    );
  }
  function DT(i) {
    var t = ge(i);
    return (
      ...
      it(t.paddingLeft) +
      it(t.paddingRight) +
      it(t.borderLeftWidth) +
      it(t.borderRightWidth)
    );
  }
  var cs = {
    isWebKit:
  ...
  function ke(i) {
    ...
    (i.containerWidth = Math.round(s.width)),
      (i.containerHeight = Math.round(s.height)),
      (i.contentWidth = t.scrollWidth),
      (i.contentHeight = t.scrollHeight),
      t.contains(i.scrollbarXRail) ||
        (mu(t, at.element.rail("x")).forEach(function (n) {
          return as(n);
        }),
        t.appendChild(i.scrollbarXRail)),
      t.contains(i.scrollbarYRail) ||
        (mu(t, at.element.rail("y")).forEach(function (n) {
          return as(n);
        }),
        t.appendChild(i.scrollbarYRail)),
      !i.settings.suppressScrollX &&
      i.containerWidth + i.settings.scrollXMarginOffset < i.contentWidth
        ? ((i.scrollbarXActive = !0),
          (i.railXWidth = i.containerWidth - i.railXMarginWidth),
          (i.railXRatio = i.containerWidth / i.railXWidth),
          (i.scrollbarXWidth = Tu(
            i,
            it((i.railXWidth * i.containerWidth) / i.contentWidth)
          )),
          (i.scrollbarXLeft = it(
      ...
      i.containerHeight + i.settings.scrollYMarginOffset < i.contentHeight
        ? ((i.scrollbarYActive = !0),
          ...
          (i.scrollbarYHeight = Tu(
            i,
            it((i.railYHeight * i.containerHeight) / i.contentHeight)
          )),
          (i.scrollbarYTop = it(
            (e * (i.railYHeight - i.scrollbarYHeight)) /
      ...
      i.scrollbarXActive
        ...
        : (t.classList.remove(at.state.active("x")),
          (i.scrollbarXWidth = 0),
          (i.scrollbarXLeft = 0),
          (t.scrollLeft = i.isRtl === !0 ? i.contentWidth : 0)),
      i.scrollbarYActive
  ...
  function Tu(i, t) {
    return (
      i.settings.minScrollbarLength &&
        (t = Math.max(t, i.settings.minScrollbarLength)),
      i.settings.maxScrollbarLength &&
        (t = Math.min(t, i.settings.maxScrollbarLength)),
      t
    );
  }
  function IT(i, t) {
    ...
    t.isRtl
      ...
      t.isScrollbarXUsingBottom
        ? (e.bottom = t.scrollbarXBottom - s)
        : (e.top = t.scrollbarXTop + s),
      wt(t.scrollbarXRail, e);
    ...
    t.isScrollbarYUsingRight
      ? t.isRtl
        ? (n.right =
            ...
            9)
        : (n.right = t.scrollbarYRight - i.scrollLeft)
      : t.isRtl
      ? (n.left =
          t.negativeScrollAdjustment +
          i.scrollLeft +
          ...
          t.scrollbarYLeft -
          t.scrollbarYOuterWidth)
      : (n.left = t.scrollbarYLeft + i.scrollLeft),
      wt(t.scrollbarYRail, n),
      wt(t.scrollbarX, {
    ...
    i.element,
      ...
      i.event.bind(i.scrollbarYRail, "mousedown", function (t) {
        var e =
          ...
          s = e > i.scrollbarYTop ? 1 : -1;
        (i.element.scrollTop += s * i.containerHeight),
          ke(i),
          t.stopPropagation();
      }),
      ...
      i.event.bind(i.scrollbarXRail, "mousedown", function (t) {
        var e =
          ...
          s = e > i.scrollbarXLeft ? 1 : -1;
        (i.element.scrollLeft += s * i.containerWidth),
          ke(i),
          t.stopPropagation();
      });
  }
  ...
  function Eu(i, t) {
    var e = t[0],
      ...
      f = null;
    function b(x) {
      x.touches && x.touches[0] && (x[n] = x.touches[0].pageY),
        (d[l] = u + f * (x[n] - p)),
        vu(i, c),
        ke(i),
        x.stopPropagation(),
        x.type.startsWith("touch") &&
          x.changedTouches.length > 1 &&
          x.preventDefault();
    }
    function v() {
      yu(i, c),
        i[h].classList.remove(at.state.clicking),
        i.event.unbind(i.ownerDocument, "mousemove", b);
    }
    function y(x, E) {
      (u = d[l]),
        E && x.touches && (x[n] = x.touches[0].pageY),
        (p = x[n]),
        (f = (i[s] - i[e]) / (i[o] - i[a])),
        E
          ? i.event.bind(i.ownerDocument, "touchmove", b)
          : (i.event.bind(i.ownerDocument, "mousemove", b),
            i.event.once(i.ownerDocument, "mouseup", v),
            x.preventDefault()),
        i[h].classList.add(at.state.clicking),
        x.stopPropagation();
    }
  ...
  function $T(i) {
    var t = i.element,
      ...
      s = function () {
        return qe(i.scrollbarX, ":focus") || qe(i.scrollbarY, ":focus");
      };
    function n(o, r) {
      ...
      if (o === 0) {
        ...
        if (
          (a === 0 && r > 0) ||
          (a >= i.contentHeight - i.containerHeight && r < 0)
        )
      ...
      if (r === 0) {
        ...
        if (
          (l === 0 && o < 0) ||
          (l >= i.contentWidth - i.containerWidth && o > 0)
        )
          return !i.settings.wheelPropagation;
      }
      return !0;
    ...
    i.event.bind(i.ownerDocument, "keydown", function (o) {
      if (
        ...
        (i.settings.suppressScrollX && a !== 0) ||
          (i.settings.suppressScrollY && l !== 0) ||
          ((t.scrollTop -= l),
          (t.scrollLeft += a),
          ke(i),
  ...
  function RT(i) {
    ...
    function e(r, a) {
      ...
      return (
        ...
        p ? !i.settings.wheelPropagation : !0
      );
    }
    function s(r) {
      var a = r.deltaX,
    ...
    function n(r, a, l) {
      if (!cs.isWebKit && t.querySelector("select:focus")) return !0;
      ...
      if (!n(r.target, l, c)) {
        ...
        i.settings.useBothWheelAxes
          ? i.scrollbarYActive && !i.scrollbarXActive
            ? (c
                ? (t.scrollTop -= c * i.settings.wheelSpeed)
                : (t.scrollTop += l * i.settings.wheelSpeed),
              (h = !0))
            : i.scrollbarXActive &&
              !i.scrollbarYActive &&
              (l
                ? (t.scrollLeft += l * i.settings.wheelSpeed)
                : (t.scrollLeft -= c * i.settings.wheelSpeed),
              (h = !0))
          : ((t.scrollTop -= c * i.settings.wheelSpeed),
            (t.scrollLeft += l * i.settings.wheelSpeed)),
          ke(i),
    ...
    typeof window.onwheel < "u"
      ? i.event.bind(t, "wheel", o)
      : typeof window.onmousewheel < "u" && i.event.bind(t, "mousewheel", o);
  }
  function PT(i) {
    if (!cs.supportsTouch && !cs.supportsIePointer) return;
    var t = i.element;
    function e(f, b) {
      ...
      if (E > x) {
        if (
          (b < 0 && v === i.contentHeight - i.containerHeight) ||
          (b > 0 && v === 0)
        )
          return window.scrollY === 0 && b > 0 && cs.isChrome;
      } else if (x > E && ((f < 0 && y === i.contentWidth - i.containerWidth) || (f > 0 && y === 0))) return !0;
      return !0;
    }
    function s(f, b) {
      (t.scrollTop -= b), (t.scrollLeft -= f), ke(i);
    }
    var n = {},
      o = 0,
      r = {},
    ...
    function d(f, b, v) {
      ...
      for (var y = f; y && y !== t; ) {
        ...
        var x = ge(y);
        if (v && x.overflowY.match(/(scroll|auto)/)) {
          var E = y.scrollHeight - y.clientHeight;
          if (
            E > 0 &&
            ((y.scrollTop > 0 && v < 0) || (y.scrollTop < E && v > 0))
          )
            return !0;
        }
        if (b && x.overflowX.match(/(scroll|auto)/)) {
          var T = y.scrollWidth - y.clientWidth;
          if (
            T > 0 &&
            ((y.scrollLeft > 0 && b < 0) || (y.scrollLeft < T && b > 0))
          )
            return !0;
        }
        y = y.parentNode;
    ...
    function u(f) {
      if (c(f)) {
        var b = l(f),
          ...
          y = v.pageX - n.pageX,
          x = v.pageY - n.pageY;
        if (d(f.target, y, x)) return;
        s(y, x), (n = v);
        var E = new Date().getTime(),
          T = E - o;
        T > 0 && ((r.x = y / T), (r.y = x / T), (o = E)),
          e(y, x) && f.preventDefault();
      }
    }
    function p() {
    ...
    cs.supportsTouch
      ? (i.event.bind(t, "touchstart", h),
        i.event.bind(t, "touchmove", u),
        i.event.bind(t, "touchend", p))
      : cs.supportsIePointer &&
        (window.PointerEvent
          ? (i.event.bind(t, "pointerdown", h),
            i.event.bind(t, "pointermove", u),
            i.event.bind(t, "pointerup", p))
          : window.MSPointerEvent &&
            (i.event.bind(t, "MSPointerDown", h),
            i.event.bind(t, "MSPointerMove", u),
            i.event.bind(t, "MSPointerUp", p)));
  }
  var NT = function () {
      return {
    ...
    tn = function (t, e) {
      ...
      (this.element = t), t.classList.add(at.main), (this.settings = NT());
      ...
      (this.isRtl = ge(t).direction === "rtl"),
        ...
        (this.scrollbarXRail = Yo(at.element.rail("x"))),
        t.appendChild(this.scrollbarXRail),
        (this.scrollbarX = Yo(at.element.thumb("x"))),
      ...
      var a = ge(this.scrollbarXRail);
      (this.scrollbarXBottom = parseInt(a.bottom, 10)),
        isNaN(this.scrollbarXBottom)
          ? ((this.isScrollbarXUsingBottom = !1),
            (this.scrollbarXTop = it(a.top)))
          : (this.isScrollbarXUsingBottom = !0),
        (this.railBorderXWidth =
          it(a.borderLeftWidth) + it(a.borderRightWidth)),
        wt(this.scrollbarXRail, { display: "block" }),
        (this.railXMarginWidth = it(a.marginLeft) + it(a.marginRight)),
        wt(this.scrollbarXRail, { display: "" }),
        (this.railXWidth = null),
        (this.railXRatio = null),
        (this.scrollbarYRail = Yo(at.element.rail("y"))),
        t.appendChild(this.scrollbarYRail),
        (this.scrollbarY = Yo(at.element.thumb("y"))),
      ...
      var l = ge(this.scrollbarYRail);
      (this.scrollbarYRight = parseInt(l.right, 10)),
        isNaN(this.scrollbarYRight)
          ? ((this.isScrollbarYUsingRight = !1),
            (this.scrollbarYLeft = it(l.left)))
          : (this.isScrollbarYUsingRight = !0),
        (this.scrollbarYOuterWidth = this.isRtl ? DT(this.scrollbarY) : null),
        (this.railBorderYWidth =
          it(l.borderTopWidth) + it(l.borderBottomWidth)),
        wt(this.scrollbarYRail, { display: "block" }),
        (this.railYMarginHeight = it(l.marginTop) + it(l.marginBottom)),
        wt(this.scrollbarYRail, { display: "" }),
  ...
  (tn.prototype.update = function () {
    this.isAlive &&
      ...
      (this.railXMarginWidth =
        it(ge(this.scrollbarXRail).marginLeft) +
        it(ge(this.scrollbarXRail).marginRight)),
      (this.railYMarginHeight =
        it(ge(this.scrollbarYRail).marginTop) +
        it(ge(this.scrollbarYRail).marginBottom)),
      wt(this.scrollbarXRail, { display: "none" }),
      wt(this.scrollbarYRail, { display: "none" }),
      ke(this),
      Ko(this, "top", 0, !1, !0),
      Ko(this, "left", 0, !1, !0),
      wt(this.scrollbarXRail, { display: "" }),
    ...
    (tn.prototype.onScroll = function (t) {
      this.isAlive &&
        (ke(this),
        Ko(this, "top", this.element.scrollTop - this.lastScrollTop),
        Ko(this, "left", this.element.scrollLeft - this.lastScrollLeft),
    ...
    (tn.prototype.destroy = function () {
      this.isAlive &&
        ...
        as(this.scrollbarX),
        as(this.scrollbarY),
        as(this.scrollbarXRail),
        as(this.scrollbarYRail),
    ...
    (tn.prototype.removePsClasses = function () {
  ...
  const il = "perfectScrollbar",
    HT = "perfect-scrollbar",
    Uo = "te.perfectScrollbar",
    me = "te",
    be = "ps",
    sl = [
      { te: `scrollX.${me}.${be}`, ps: "ps-scroll-x" },
      { te: `scrollY.${me}.${be}`, ps: "ps-scroll-y" },
      { te: `scrollUp.${me}.${be}`, ps: "ps-scroll-up" },
      { te: `scrollDown.${me}.${be}`, ps: "ps-scroll-down" },
      { te: `scrollLeft.${me}.${be}`, ps: "ps-scroll-left" },
      { te: `scrollRight.${me}.${be}`, ps: "ps-scroll-right" },
      { te: `scrollXEnd.${me}.${be}`, ps: "ps-x-reach-end" },
      { te: `scrollYEnd.${me}.${be}`, ps: "ps-y-reach-end" },
      { te: `scrollXStart.${me}.${be}`, ps: "ps-x-reach-start" },
      { te: `scrollYStart.${me}.${be}`, ps: "ps-y-reach-start" },
    ],
    FT = {
      handlers: ["click-rail", "drag-thumb", "keyboard", "wheel", "touch"],
      wheelSpeed: 1,
  ...
  class hs {
    constructor(t, e = {}, s = {}) {
      (this._element = t),
        ...
        this._element &&
          (M.setData(t, Uo, this), _.addClass(this._element, HT)),
        this.init();
    }
    static get NAME() {
      return il;
    ...
    init() {
      if (
        ((this.perfectScrollbar = new tn(this._element, this._options)),
    ...
    _initEvents(t = []) {
      t.forEach(({ ps: e, te: s }) =>
        g.on(this._element, e, (n) => g.trigger(this._element, s, { e: n }))
      );
    }
    _addPerfectScrollbarStyles() {
      this._psClasses.forEach((t) => {
        const e = m.findOne(`.${t.ps}`, this._element);
        _.addClass(e, t.te), _.addClass(e, t.teColor);
      }),
        _.addClass(this._element, this._classes.ps),
        _.removeClass(this._element, "ps");
    }
    removeEvent(t) {
      let e = [];
      typeof t == "string" && (e = sl.filter(({ te: s }) => s === t)),
        e.forEach(({ ps: s, te: n }) => {
          g.off(this._element, s), g.off(this._element, n);
        });
    }
    static jQueryInterface(t) {
      return this.each(function () {
        let e = M.getData(this, Uo);
        const s = typeof t == "object" && t;
        if (
          !(!e && /dispose|hide/.test(t)) &&
          (e || (e = new hs(this, s)), typeof t == "string")
        ) {
          if (typeof e[t] > "u") throw new TypeError(`No method named "${t}"`);
          e[t]();
        }
  ...
  const YT = "data-te-datatable-select-ref",
    jT = "data-te-datatable-pagination-nav-ref",
    KT = "data-te-datatable-pagination-right-ref",
    UT = "data-te-datatable-pagination-left-ref",
    XT = "data-te-datatable-pagination-start-ref",
    GT = "data-te-datatable-pagination-end-ref",
    qT = (
      {
        text: i,
        entries: t,
...
<div class="${h.pagination} ${u ? `${h.paginationBordered}` : ""} ${
  ...
  <div class="${h.paginationButtonsWrapper}">
    ${
      s
        ? `<button data-te-ripple-init data-te-ripple-color="dark" class="${h.paginationStartButton}" ${XT}>
           ${r}
          </button>`
        : ""
    }
    ...
    ${
      s
        ? `<button data-te-ripple-init data-te-ripple-color="dark" class="${h.paginationEndButton}" ${GT}>
           ${c}
          </button>`
        : ""
    }
...
`;
    ...
    ZT = "data-te-datatable-sort-icon-ref",
    QT = "data-te-datatable-header-checkbox-ref",
    JT = (i, t, e, s, n, o, r, a) => {
      const l = e
          ? `
  <th scope="col">
  ...
  `
        ...
        c = i.map((h, d) => {
          const u = h.fixed
            ...
            : null;
          return `<th class="${a.column} ${s ? `${a.tableBordered}` : ""} ${
            a.borderColor
          } ${n ? `${a.sm}` : ""} ${
            ...
            h.sort
              ? `<div class="${a.sortIconWrapper}"><span class="${a.sortIcon} ${
                  o ? "invisible" : ""
                }" data-te-sort="${h.field}" ${ZT}>${r}</span>`
              : ""
...
`);
    ...
    tE = "data-te-datatable-row-ref",
    eE = "data-te-datatable-row-checkbox-ref",
    iE = "data-te-datatable-cell-ref",
    sE = ({
      rows: i,
      columns: t,
      noFoundMessage: e,
      ...
      <td data-te-field="checkbox" class="${
        ...
        <div class="${d.checkboxRowWrapper}">
          ...
          b = t
            .map((v, y) => {
              ...
              if (
                (v.width &&
                  ((x["min-width"] = `${v.width - 1}px`),
                  (x["max-width"] = `${v.width}px`),
                  (x.width = `${v.width}px`)),
                v.fixed)
              ) {
                const T = t
        ...
        return `<tr scope="row" class="${d.row} ${d.borderColor} ${
          ...
          c ? `${d.hoverRow}` : ""
        }" data-te-index="${p.rowIndex}" ${tE}>${n ? f : ""}${b}</tr>`;
      });
      return i.length > 0 || o
        ? u.join(`
`)
    ...
    nE = "data-te-datatable-inner-ref",
    oE = "data-te-datatable-header-ref",
    Cu = ({
      columns: i,
      rows: t,
      noFoundMessage: e,
...
${l.enable ? qT(l, r, c) : ""}
  `,
    ...
    aE = (i, t, e) => {
      ...
      return i.filter((n) => {
        if (e && typeof e == "string") return s(n[e]);
        ...
        return (
          e &&
            ...
            (o = Object.keys(n)
              ...
              .map((r) => n[r])),
          o.filter((r) => s(r)).length > 0
        );
      });
    },
    Au = ({ rows: i, entries: t, activePage: e }) => {
      const s = e * t;
    ...
    nl = `[${Pt}-cell-ref]`,
    cE = `[${Pt}-header-ref]`,
    hE = `[${Pt}-header-checkbox-ref]`,
    dE = `[${Pt}-pagination-right-ref]`,
    uE = `[${Pt}-pagination-left-ref]`,
    pE = `[${Pt}-pagination-start-ref]`,
    fE = `[${Pt}-pagination-end-ref]`,
    _E = `[${Pt}-pagination-nav-ref]`,
    gE = `[${Pt}-select-ref]`,
    ol = `[${Pt}-sort-icon-ref]`,
    nn = `[${Pt}-row-ref]`,
    rl = `[${Pt}-row-checkbox-ref]`,
    mE = `selectRows${Xo}`,
    wu = `render${Xo}`,
    bE = `rowClick${Xo}`,
    vE = `update${Xo}`,
    yE = `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5L12 3m0 0l7.5 7.5M12 3v18" />
</svg>`,
    xE = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M18.75 19.5l-7.5-7.5 7.5-7.5m-6 15L5.25 12l7.5-7.5" />
</svg>`,
    TE = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
</svg>`,
    EE = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
</svg>`,
    CE = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
  <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5"/>
</svg>`,
    AE = "border-neutral-200 dark:border-neutral-500",
    wE = "border-none",
    kE =
    ...
    SE = "mb-[0.125rem] min-h-[1.5rem] pl-[1.5rem] ml-3 flex items-center",
    OE =
      "relative float-left -ml-[1.5rem] mr-[6px] mt-[0.15rem] h-[1.125rem] w-[1.125rem] appearance-none rounded-[0.25rem] border-[0.125rem] border-solid border-neutral-300 outline-none before:pointer-events-none before:absolute before:h-[0.875rem] before:w-[0.875rem] before:scale-0 before:rounded-full before:bg-transparent before:opacity-0 before:shadow-[0px_0px_0px_13px_transparent] before:content-[''] checked:border-primary checked:bg-primary checked:before:opacity-[0.16] checked:after:absolute checked:after:-mt-px checked:after:ml-[0.25rem] checked:after:block checked:after:h-[0.8125rem] checked:after:w-[0.375rem] checked:after:rotate-45 checked:after:border-[0.125rem] checked:after:border-l-0 checked:after:border-t-0 checked:after:border-solid checked:after:border-white checked:after:bg-transparent checked:after:content-[''] hover:cursor-pointer hover:before:opacity-[0.04] hover:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:shadow-none focus:transition-[border-color_0.2s] focus:before:scale-100 focus:before:opacity-[0.12] focus:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:before:transition-[box-shadow_0.2s,transform_0.2s] focus:after:absolute focus:after:z-[1] focus:after:block focus:after:h-[0.875rem] focus:after:w-[0.875rem] focus:after:rounded-[0.125rem] focus:after:content-[''] checked:focus:before:scale-100 checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca] checked:focus:before:transition-[box-shadow_0.2s,transform_0.2s] checked:focus:after:-mt-px checked:focus:after:ml-[0.25rem] checked:focus:after:h-[0.8125rem] checked:focus:after:w-[0.375rem] checked:focus:after:rotate-45 checked:focus:after:rounded-none checked:focus:after:border-[0.125rem] checked:focus:after:border-l-0 checked:focus:after:border-t-0 checked:focus:after:border-solid checked:focus:after:border-white checked:focus:after:bg-transparent dark:border-neutral-600 dark:checked:border-primary dark:checked:bg-primary dark:focus:before:shadow-[0px_0px_0px_13px_rgba(255,255,255,0.4)] dark:checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca] dark:border-neutral-400",
    DE = "mb-[0.125rem] min-h-[1.5rem] pl-[1.5rem] ml-3 flex items-center",
    IE = "bg-white dark:bg-neutral-800",
    ME = "py-4 pl-1 text-clip overflow-hidden text-[#212529] dark:text-white",
    LE = "focus:outline-none",
    $E = "sticky top-0 z-30",
    RE = "sticky z-10 bg-inherit",
    PE = "hover:bg-neutral-100 dark:hover:bg-neutral-700",
    NE =
      "pointer-events-none cursor-none text-neutral-400 dark:text-neutral-300",
    BE = "h-[2px] relative w-full overflow-hidden",
    HE =
      "text-center text-neutral-500 font-ligh text-sm my-4 dark:text-neutral-400",
    FE = "text-neutral-500 dark:text-neutral-300",
    WE = "text-neutral-500 dark:text-neutral-300",
    VE = "pointer-events-none cursor-none",
    zE = "h-full w-[45%] bg-primary-400 dark:bg-primary-600",
    YE = "h-full animate-[progress_3s_ease-in-out_infinite]",
    jE = "pl-2 py-3 font-light text-sm dark:text-neutral-300",
    KE = "border-b",
    UE =
      "flex md:flex-row justify-end items-center py-2 space-x-4 text-sm flex-col leading-[1.6]",
    XE = "border border-t-0",
    GE = "order-1 my-3 md:order-none md:my-0 md:pr-1",
    qE =
    ...
    QE = "font-normal order-2 mb-3 md:order-none md:mb-0",
    JE =
      "inline-block rounded p-2.5 font-medium uppercase leading-normal transition duration-150 ease-in-out hover:bg-neutral-100 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 disabled:text-slate-300 disabled:hover:bg-transparent dark:hover:bg-neutral-500 dark:disabled:hover:bg-transparent dark:disabled:text-neutral-600",
    tC = "font-light",
    eC =
      "inline-block rounded p-2.5 font-medium uppercase leading-normal transition duration-150 ease-in-out hover:bg-neutral-100 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 disabled:text-slate-300 disabled:hover:bg-transparent dark:hover:bg-neutral-500 dark:disabled:hover:bg-transparent dark:disabled:text-neutral-600",
    iC = "border-b",
    sC = "transition ease-in-out duration-300 motion-reduce:transition-none",
    nC = "whitespace-nowrap text-clip overflow-hidden px-[1.4rem] py-4",
    oC = "relative",
    rC = "!bg-neutral-100 dark:!bg-neutral-600",
    aC = "flex items-center space-x-4 order-3 md:order-none",
    lC = "w-[70px]",
    cC = "!py-2",
    hC =
    ...
    dC = "flex flex-row group",
    uC =
      "[&:nth-child(odd)]:bg-neutral-50 [&:nth-child(odd)]:dark:bg-neutral-700",
    pC = "border",
    fC = "border-b font-normal px-[1.4rem]",
    _C = "text-left text-sm font-light w-full leading-[1.6]",
    gC = {
      bordered: "boolean",
      borderless: "boolean",
    ...
    mC = {
      ...
      forceSort: !1,
      sortIconTemplate: yE,
      paginationStartIconTemplate: xE,
      paginationEndIconTemplate: CE,
      paginationLeftIconTemplate: TE,
      paginationRightIconTemplate: EE,
    },
    bC = {
      label: "string",
      field: "string",
    ...
    yC = {
      ...
      scroll: oC,
      tableBordered: pC,
      paginationBordered: XE,
      borderless: wE,
      checkboxRowWrapper: DE,
      checkboxRow: OE,
      checkboxHeaderWrapper: SE,
      checkboxHeader: kE,
      row: iC,
      rowItem: nC,
      striped: uC,
      sortIconWrapper: dC,
      sortIcon: hC,
      paginationRowsText: tC,
      paginationNav: QE,
      paginationButtonsWrapper: GE,
      hoverRow: PE,
      borderColor: AE,
      color: IE,
      fixedHeader: $E,
      ...
      sm: cC,
      edit: LE,
      selectItemsWrapper: aC,
      paginationStartButton: eC,
      paginationLeftButton: ZE,
      paginationRightButton: JE,
      paginationEndButton: qE,
      loadingItemsWrapper: BE,
      loadingProgressBarWrapper: YE,
      loadingProgressBar: zE,
      loadingMessage: HE,
      loadingPaginationRowsText: WE,
      loadingPaginationSelectWrapper: VE,
      loadingPaginationNav: FE,
      loadingColumn: NE,
      noFoundMessageWrapper: KE,
      noFoundMessage: jE,
    },
    xC = {
      table: "string",
  ...
  class Go {
    constructor(t, e = {}, s = {}, n = {}) {
      (this._element = t),
        (this._options = this._getOptions(s)),
        (this._classes = this._getClasses(n)),
        (this._sortReverse = !1),
        (this._activePage = 0),
        (this._search = ""),
    ...
    get columns() {
      return this._columns.map((t, e) => {
        let s = { ...vC, field: `field_${e}`, columnIndex: e };
        return (
          typeof t == "string"
            ? (s.label = t)
            : typeof t == "object" && (s = { ...s, ...t }),
          P("column", s, bC),
          s
        );
      });
        ...
        return (
          Array.isArray(t)
            ? this.columns.forEach((n, o) => {
                t[o] === 0
                  ? (s[n.field] = t[o])
                  : (s[n.field] = t[o] || this._options.defaultValue);
              })
            : typeof t == "object" &&
              this.columns.forEach((n) => {
                t[n.field] === 0
                  ? (s[n.field] = t[n.field])
                  : (s[n.field] = t[n.field] || this._options.defaultValue);
              }),
          s
        );
      });
    ...
    get searchResult() {
      return aE(this.rows, this._search, this._searchColumn);
    }
    get computedRows() {
    ...
    _clearClassList(t) {
      ["hover", "bordered", "borderless", "sm", "striped"].forEach((e) => {
        this._options[e] && !t[e] && _.removeDataAttribute(`data-te-${e}`);
      });
    }
    _emitSelectEvent() {
      g.trigger(this._element, mE, {
    ...
    _getRows(t = []) {
      ...
      return e
        ? [
            ...m
              .find("tr", e)
              .map((n) => m.find("td", n).map((o) => o.innerHTML)),
            ...t,
          ]
        : t;
    }
    _getColumns(t = []) {
      ...
      if (!e) return t;
      const s = m.findOne("tr", e);
      return [
        ...m
          .find("th", s)
          .map((o) => ({ label: o.innerHTML, ..._.getDataAttributes(o) })),
        ...t,
      ];
    }
    _getCSSValue(t) {
    ...
    _getOptions(t) {
      const e = { ...mC, ..._.getDataAttributes(this._element), ...t };
      return P(en, e, gC), e;
    }
    _setActiveRows() {
      m.find(nn, this._element).forEach((t) => {
        this._selected.includes(_.getDataAttribute(t, "index"))
          ? _.addClass(t, `active ${this._classes.selectableRow}`)
          : _.removeClass(t, `active ${this._classes.selectableRow}`);
      });
    }
    _setEntries(t) {
    ...
    _setSelected() {
      m.find(rl, this._element).forEach((t) => {
        const e = _.getDataAttribute(t, "rowIndex");
        t.checked = this._selected.includes(e);
      }),
        this._setActiveRows();
    }
    _setActiveSortIcon(t) {
      m.find(ol, this._element).forEach((e) => {
        const s = this._options.sortOrder === "desc" && e === t ? 180 : 0;
        _.style(e, { transform: `rotate(${s}deg)` }),
          e === t && this._options.sortOrder
            ? _.addClass(e, "opacity-100")
            : _.removeClass(e, "opacity-100");
      });
    }
    _setup() {
      this._renderTable(),
    ...
    _setupClickableRows() {
      m.find(nn, this._element).forEach((t) => {
        const e = _.getDataAttribute(t, "index");
        _.addClass(t, "cursor-pointer"),
          g.on(t, "click", (s) => {
            m.matches(s.target, rl) ||
              g.trigger(this._element, bE, { index: e, row: this.rows[e] });
          });
      });
    }
    _setupEditable() {
      m.find(nn, this._element).forEach((t) => {
        const e = _.getDataAttribute(t, "index");
        m.find(nl, t).forEach((s) => {
          g.on(s, "input", (n) => this._updateRow(n, e));
        });
      });
    }
    _setupScroll() {
      const t = m.findOne(lE, this._element),
        e = {};
      if (
        (this._options.maxHeight &&
        ...
        (e.maxWidth = s), _.style(this._element, { maxWidth: s });
      }
      if (
        (_.style(t, e),
        _.addClass(t, `${this._classes.scroll}`),
        this._options.fixedHeader)
      ) {
        let s = m.find(cE, this._element);
        this._options.selectable &&
          ...
          s.forEach((n, o) => {
            _.addClass(
              ...
              this.columns[o].fixed && _.addClass(n, "!z-40");
          });
      }
      this._perfectScrollbar = new hs(t);
    }
    _setupSort() {
      m.find(ol, this._element).forEach((t) => {
        const e = _.getDataAttribute(t, "sort"),
          [s] = m.parents(t, "th");
        if (this.columns.sort) _.addClass(s, "cursor-pointer");
        else return;
    ...
    _setupSelectable() {
      (this._checkboxes = m.find(rl, this._element)),
        (this._headerCheckbox = m.findOne(hE, this._element)),
        g.on(this._headerCheckbox, "input", (t) => this._toggleSelectAll(t)),
        this._checkboxes.forEach((t) => {
          const e = _.getDataAttribute(t, "rowIndex");
          g.on(t, "input", (s) => this._toggleSelectRow(s, e));
        });
    }
    _setupPagination() {
      (this._paginationRight = m.findOne(dE, this._element)),
        (this._paginationLeft = m.findOne(uE, this._element)),
        g.on(this._paginationRight, "click", () =>
          this._changeActivePage(this._activePage + 1)
        ),
        g.on(this._paginationLeft, "click", () =>
          this._changeActivePage(this._activePage - 1)
        ),
        this._options.fullPagination &&
          ((this._paginationStart = m.findOne(pE, this._element)),
          (this._paginationEnd = m.findOne(fE, this._element)),
          g.on(this._paginationStart, "click", () => this._changeActivePage(0)),
          g.on(this._paginationEnd, "click", () =>
    ...
    _setupPaginationSelect() {
      (this._select = m.findOne(gE, this._element)),
        (this._selectInstance = new Xs(this._select)),
        g.on(this._select, "valueChange.te.select", (t) => this._setEntries(t));
    }
    _removeEventListeners() {
      this._options.pagination &&
        (g.off(this._paginationRight, "click"),
        g.off(this._paginationLeft, "click"),
        g.off(this._select, "valueChange.te.select"),
        this._options.fullPagination &&
          (g.off(this._paginationStart, "click"),
          g.off(this._paginationEnd, "click"))),
        this._options.edit &&
          m.find(nl, this._element).forEach((t) => {
            g.off(t, "input");
          }),
        ...
        this._options.selectable &&
          (g.off(this._headerCheckbox, "input"),
          this._checkboxes.forEach((t) => {
            g.off(t, "input");
          }));
    }
    _renderTable() {
      (this._element.innerHTML = Cu(this.tableOptions).table),
        this._formatCells(),
        g.trigger(this._element, wu);
    }
    _renderRows() {
      const t = m.findOne("tbody", this._element);
      if (this._options.pagination) {
        const e = m.findOne(_E, this._element);
        e.innerText = this.navigationText;
      }
      (t.innerHTML = Cu(this.tableOptions).rows),
        this._formatCells(),
        this._options.edit && this._setupEditable(),
        this._options.selectable &&
    ...
    _formatCells() {
      m.find(nn, this._element).forEach((e) => {
        const s = _.getDataAttribute(e, "index");
        m.find(nl, e).forEach((o) => {
          const r = _.getDataAttribute(o, "field"),
            a = this.columns.find((l) => l.field === r);
          a && a.format !== null && a.format(o, this.rows[s][r]);
        });
      });
    }
    _toggleDisableState() {
    ...
    _toggleSelectRow(t, e) {
      t.target.checked
        ? this._options.multi && !this._selected.includes(e)
          ...
          : ((this._selected = [e]),
            this._checkboxes.forEach((s) => {
              s !== t.target && (s.checked = !1);
            }))
        : (this._selected = this._selected.filter((s) => s !== e)),
        this._options.multi &&
          !t.target.checked &&
    ...
    _updateRow(t, e) {
      const s = _.getDataAttribute(t.target, "field"),
        n = t.target.textContent,
        o = this._rows[e];
      if (Array.isArray(o)) {
        const a = this.columns.find((l) => l.field === s).columnIndex;
        o[a] = n;
      } else o[s] = n;
      g.trigger(this._element, vE, {
        rows: this._rows,
    ...
    static jQueryInterface(t, e, s) {
      return this.each(function () {
        let n = M.getData(this, sn);
        const o = typeof t == "object" && t;
        if (
          !(!n && /dispose/.test(t)) &&
          (n || (n = new Go(this, o, e)), typeof t == "string")
        ) {
  ...
  const ku = "rating",
    qo = "te.rating",
    TC = "data-te-rating-init",
    EC = "[data-te-rating-icon-ref]",
    ds = `.${qo}`,
    CC = "ArrowLeft",
    AC = "ArrowRight",
    wC = {
  ...
  class Lu {
    constructor(t, e) {
      (this._element = t),
        (this._icons = m.find(EC, this._element)),
        (this._options = this._getConfig(e)),
        (this._index = -1),
        ...
        (this._fn = {}),
        (this._tooltips = []),
        this._element && (M.setData(t, qo, this), this._init());
    }
    static get NAME() {
      return ku;
    }
    dispose() {
      M.removeData(this._element, qo),
        this._options.readonly ||
          (g.off(this._element, Ou),
          g.off(this._element, Du),
          g.off(this._element, Iu),
          ...
          this._icons.forEach((t, e) => {
            g.off(t, Mu),
              ...
              _.removeClass(t, "cursor-pointer");
          }),
          this._tooltips.forEach((t) => {
            t._element.removeAttribute(TC), t.dispose();
          }),
        ...
        this._icons.forEach((t, e) => {
          t.addEventListener(
            ...
            (this._fn.mouseenter[e] = (s) => {
              (this._index = this._icons.indexOf(s.target)),
                this._updateRating(this._index),
                this._triggerEvents(t, SC);
            })
          );
        });
    }
      ...
      this._icons.forEach((t) => {
        g.on(t, Mu, () => {
          this._setElementOutline("none"),
            ...
            this._triggerEvents(t, Su);
        });
      });
    }
    _bindKeyDown() {
      (this._element.tabIndex = 0),
        g.on(this._element, Iu, (t) => this._updateAfterKeyDown(t));
    }
    _bindKeyUp() {
      g.on(this._element, Ou, () => this._setElementOutline("auto"));
    }
    _bindFocusLost() {
      g.on(this._element, Du, () => this._setElementOutline("none"));
    }
    _setElementOutline(t) {
      this._element.style.outline = t;
    }
    _triggerEvents(t, e) {
      g.trigger(t, e, { value: this._index + 1 });
    }
    _updateAfterKeyDown(t) {
      const e = this._icons.length - 1,
        s = this._index;
      t.key === AC && this._index < e && (this._index += 1),
        t.key === CC && this._index > -1 && (this._index -= 1),
        s !== this._index &&
          ((this._savedIndex = this._index),
          this._updateRating(this._savedIndex),
          this._triggerEvents(this._icons[this._savedIndex], Su));
    }
    _updateRating(t) {
      this._clearRating(),
        this._options.dynamic && this._restoreOriginalIcon(t),
        this._icons.forEach((e, s) => {
          s <= t && _.addClass(e.querySelector("svg"), this._options.active);
        });
    }
    _clearRating() {
      this._icons.forEach((t, e) => {
        ...
        this._options.dynamic &&
          ...
          (s.innerHTML = this._originalIcons[e])),
          _.removeClass(s, this._options.active);
      });
    }
    _setToolTips() {
      this._icons.forEach((t, e) => {
        const s = _.getDataAttribute(t, "toggle");
        t.title &&
          !s &&
          (_.setDataAttribute(t, "toggle", "tooltip"),
          (this._tooltips[e] = new Gi(t, {
    ...
    _setCustomText() {
      this._icons.forEach((t) => {
        const e = _.getDataAttribute(t, "after"),
          s = _.getDataAttribute(t, "before");
        e && t.insertAdjacentHTML("afterEnd", e),
          s && t.insertAdjacentHTML("beforeBegin", s);
      });
    }
    ...
    _restoreOriginalIcon(t) {
      const e = this._originalClassList[t],
        s = this._originalIcons[t];
      this._icons.forEach((n, o) => {
        if (o <= t) {
          const r = n.querySelector("svg");
          (r.innerHTML = s), (n.classList = e);
        }
      });
    }
    static getInstance(t) {
      return M.getData(t, qo);
    }
    static getOrCreateInstance(t, e = {}) {
      return (
        this.getInstance(t) || new this(t, typeof e == "object" ? e : null)
  ...
  const al = "popconfirm",
    ...
    OC = `cancel${$u}`,
    DC = `confirm${$u}`,
    IC = "[data-te-popconfirm-body]",
    ll = "data-te-popconfirm-popover",
    MC = "data-te-popconfirm-modal",
    Ru = "data-te-popconfirm-backdrop",
    LC = {
  ...
  class Zo {
    constructor(t, e, s) {
      (this._element = t),
        ...
        (this._uid = this._element.id
          ...
          : Gt("popconfirm-")),
        t && M.setData(t, on, this),
        (this._clickHandler = this.open.bind(this)),
        g.on(this._element, "click", this._clickHandler);
    }
    static get NAME() {
      return al;
    }
    ...
    get popconfirmBody() {
      return m.findOne(IC, this.container);
    }
    dispose() {
      (this._isOpen || this.container !== null) && this.close(),
        M.removeData(this._element, on),
        g.off(this._element, "click", this._clickHandler),
        (this._element = null);
    }
    open() {
    ...
    close() {
      if (this._isOpen) {
        if (this._popper !== null || m.findOne(`[${ll}]`) !== null)
          g.on(
            this.popconfirmBody,
            "transitionend",
            this._handlePopconfirmTransitionEnd.bind(this)
          ),
            _.removeClass(this.popconfirmBody, "opacity-100");
        else {
          const t = m.findOne(`[${Ru}]`);
          _.removeClass(this.popconfirmBody, "opacity-100"),
            document.body.removeChild(t),
            (this._isOpen = !1);
        }
        g.off(document, "click", this._handleOutsideClick.bind(this)),
          g.off(document, "keydown", this._handleEscapeKey.bind(this));
      }
    }
    _handlePopconfirmTransitionEnd(t) {
      if (t.target !== this.popconfirmBody) return;
      const e = m.findOne(`[${ll}]`);
      g.off(this.popconfirmBody, "transitionend"),
        this._isOpen &&
          t &&
    ...
    _getPopoverTemplate() {
      ...
      return (
        t.setAttribute(ll, ""),
        _.addClass(t, this._classes.popover),
        (t.id = this._uid),
        (t.innerHTML = e),
        t
      );
    ...
    _getModalTemplate() {
      ...
      return (
        t.setAttribute(MC, ""),
        _.addClass(t, `${this._classes.modal}`),
        (t.id = this._uid),
        (t.innerHTML = e),
        t
      );
    ...
    _getConfig(t) {
      return (
        (t = { ...$C, ..._.getDataAttributes(this._element), ...t }),
        P(al, t, LC),
        t
      );
    }
    _getClasses(t) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...PC, ...e, ...t }), P(al, t, RC), t;
    }
    _openPopover(t) {
      (this._popper = pi(this._element, t, {
        placement: this._translatePositionValue(),
        modifiers: [{ name: "offset", options: { offset: [0, 5] } }],
      })),
        document.body.appendChild(t),
        setTimeout(() => {
          _.addClass(this.popconfirmBody, `${this._classes.fade} opacity-100`),
            (this._isOpen = !0);
        }, 0);
    }
    _openModal(t) {
      const e = L("div");
      e.setAttribute(Ru, ""),
        _.addClass(e, this._classes.backdrop),
        document.body.appendChild(e),
        e.appendChild(t),
        _.addClass(this.popconfirmBody, "opacity-100"),
        (this._isOpen = !0);
    }
    _handleCancelButtonClick() {
      const t = this.container;
      (this._cancelButton = m.findOne("#popconfirm-button-cancel", t)),
        ze.getOrCreateInstance(this._cancelButton, { rippleColor: "light" }),
        this._cancelButton !== null &&
          g.on(this._cancelButton, "click", () => {
            this.close(), g.trigger(this._element, OC);
          });
    }
    _handleConfirmButtonClick() {
      const t = this.container;
      (this._confirmButton = m.findOne("#popconfirm-button-confirm", t)),
        ze.getOrCreateInstance(this._confirmButton, { rippleColor: "light" }),
        g.on(this._confirmButton, "click", () => {
          this.close(), g.trigger(this._element, DC);
        });
    }
    _listenToEscapeKey() {
      g.on(document, "keydown", this._handleEscapeKey.bind(this));
    }
    _handleEscapeKey(t) {
      t.keyCode === Hs && this.close();
    }
    _listenToOutsideClick() {
      g.on(document, "click", this._handleOutsideClick.bind(this));
    }
    _handleOutsideClick(t) {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        const s = M.getData(this, on),
          n = typeof t == "object" && t;
        if (!(!s && /dispose/.test(t))) {
          if (!s) return new Zo(this, n);
          if (typeof t == "string") {
            if (typeof s[t] > "u")
              throw new TypeError(`No method named "${t}"`);
            s[t](e);
  ...
  const cl = "lightbox",
    rn = "te.lightbox",
    us = `click${`.${rn}`}.data-api`,
    Pu = "[data-te-lightbox-init]",
    NC = `${Pu} img:not([data-te-lightbox-disabled])`,
    Nu = "data-te-lightbox-caption",
    BC = "data-te-lightbox-disabled",
    ve = "data-te-lightbox-active",
    HC = `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-4 h-4">
...
`,
    ...
    UC = {
      ...
      prevIconTemplate: HC,
      nextIconTemplate: FC,
      showFullscreenIconTemplate: WC,
      hideFullscreenIconTemplate: VC,
      zoomInIconTemplate: zC,
      zoomOutIconTemplate: YC,
      closeIconTemplate: jC,
  ...
  class ps {
    constructor(t, e = {}, s) {
      (this._element = t),
        ...
        this._element && (M.setData(t, rn, this), this.init());
    }
    static get NAME() {
      return cl;
    }
    ...
    get currentImg() {
      return m.findOne(`[${ve}]`, this._galleryContent);
    }
    get options() {
      const t = {
        ...UC,
    ...
    zoomIn() {
      this._zoom >= 3 ||
        ...
        _.style(this.currentImg.parentNode, {
    ...
    toggleFullscreen() {
      this._fullscreen === !1
        ? (this._fullscreenBtn.setAttribute(ve, ""),
          ...
          (this._fullscreen = !0))
        : (this._fullscreenBtn.removeAttribute(ve),
    ...
    dispose() {
      g.off(document, us, NC, this.toggle),
        this._galleryContent && this._removeEvents(),
        this._gallery && this._gallery.remove(),
        M.removeData(this._element, rn),
        (this._element = null);
    }
    _getClasses(t) {
      const e = _.getDataClassAttributes(this._element);
      return (t = { ...XC, ...e, ...t }), P(cl, t, GC), t;
    }
    _getImages() {
      const e = m.find("img", this._element).filter((s) => !s.hasAttribute(BC));
      this._images = e;
    }
    _getContainer() {
    ...
    _appendTemplate() {
      (this._gallery = L("div")),
        _.addClass(this._gallery, `${this._classes.gallery}`),
    ...
    _appendToolbar() {
      (this._galleryToolbar = L("div")),
        (this._imgCounter = L("p")),
        (this._fullscreenBtn = L("button")),
        (this._zoomBtn = L("button"));
      const t = L("button"),
        e = L("div"),
        s = L("div");
      _.addClass(this._galleryToolbar, `${this._classes.toolbar}`),
        _.addClass(this._imgCounter, `${this._classes.galleryCounter}`),
        _.addClass(this._fullscreenBtn, `${this._classes.fullscreenBtn}`),
        _.addClass(this._zoomBtn, `${this._classes.zoomInBtn}`),
        _.addClass(this._zoomBtn, this._classes.zoomBtn),
        _.addClass(e, `${this._classes.leftTools}`),
        _.addClass(s, `${this._classes.rightTools}`),
        _.addClass(t, `${this._classes.closeBtn}`),
        (this._fullscreenBtn.innerHTML =
        ...
        g.on(this._fullscreenBtn, us, () => this.toggleFullscreen()),
        g.on(this._zoomBtn, us, () => this._toggleZoom()),
        g.on(t, us, () => this.close()),
        e.append(this._imgCounter),
        s.append(this._fullscreenBtn),
        s.append(this._zoomBtn),
        s.append(t),
        this._galleryToolbar.append(e),
        this._galleryToolbar.append(s),
        this._gallery.append(this._galleryToolbar);
    }
    _appendContent() {
      (this._galleryContent = L("div")),
        _.addClass(this._galleryContent, `${this._classes.galleryContent}`),
    ...
    _appendLoader() {
      ...
      const t = L("div"),
        e = L("span");
      _.addClass(this._loader, `${this._classes.loader}`),
        _.addClass(t, `${this._classes.spinner}`),
        _.addClass(e, `${this._classes.spinnerContent}`),
    ...
    _appendArrows() {
      (this._leftArrowWrapper = L("div")),
        _.addClass(this._leftArrowWrapper, `${this._classes.prevBtnWrapper}`);
      const t = L("button");
      t.setAttribute("aria-label", "Previous"),
        _.addClass(t, `${this._classes.prevBtn}`),
        g.on(t, us, () => this.slide("left")),
        this._leftArrowWrapper.append(t),
        (this._rightArrowWrapper = L("div")),
        _.addClass(this._rightArrowWrapper, `${this._classes.nextBtnWrapper}`),
        (this._rightArrow = L("button")),
        this._rightArrow.setAttribute("aria-label", "Next"),
        _.addClass(this._rightArrow, `${this._classes.nextBtn}`),
        g.on(this._rightArrow, us, () => this.slide()),
    ...
    _appendCaption() {
      const t = L("div"),
        e = L("p");
      e.setAttribute(Nu, ""),
        _.addClass(t, `${this._classes.captionWrapper}`),
        _.addClass(e, `${this._classes.caption}`),
        t.append(e),
        ...
        this._images.forEach((n, o) => {
          t.push(
            new Promise((r) => {
              const a = new Image(),
                l = L("div");
              _.addClass(l, `${this._classes.imgWrapper}`),
                _.addClass(a, `${this._classes.img}`),
                this._addImgStyles(a, l, s, o, n),
                l.append(a),
    ...
    _addImgStyles(t, e, s, n, o) {
      (t.alt = o.alt),
        (t.draggable = !1),
        _.style(e, { position: "absolute", left: `${s}%`, top: 0 }),
        (o.dataset.teCaption || o.dataset.teCaption === "") &&
          (t.dataset.caption = o.dataset.teCaption),
        s === 0
          ? (o.width < o.height && _.addClass(t, `${this._classes.vertical}`),
            _.style(e, { opacity: 1 }),
            t.setAttribute(ve, ""))
    ...
    _slideHorizontally(t) {
      (this._images = m.find("img", this._galleryContent)),
        this._images.forEach((e) => {
          let s;
          t === "right"
            ? ((s = parseInt(e.parentNode.style.left, 10) - 100),
              s < -100 && (s = (this._images.length - 2) * 100))
            : ((s = parseInt(e.parentNode.style.left, 10) + 100),
              s === (this._images.length - 1) * 100 && (s = -100)),
            this._slideImg(e, s);
        }),
    ...
    _slideImg(t, e) {
      e === 0
        ? (t.setAttribute(ve, ""),
          _.style(t.parentNode, { opacity: 1, transform: "scale(1)" }))
        : (t.removeAttribute(ve),
          _.style(t.parentNode, { opacity: 0, transform: "scale(0.25)" })),
    ...
    _updateCaption() {
      setTimeout(() => {
        ...
        (this.currentImg.dataset.caption ||
          ...
          (m.findOne(`[${Nu}]`, this._gallery).innerHTML = t);
      }, 200);
    }
    _toggleTemplate() {
      this._gallery.style.visibility === "visible"
        ? (_.style(this.currentImg.parentNode, { transform: "scale(0.25)" }),
          setTimeout(() => {
    ...
    _showLoader() {
      _.style(this._loader, { opacity: 1 });
    }
    _hideLoader() {
      _.style(this._loader, { opacity: 0 });
    }
    _hideGallery() {
      _.style(this._gallery, {
        opacity: 0,
        pointerEvents: "none",
        visibility: "hidden",
      });
    ...
    _showGallery() {
      _.style(this._gallery, {
        ...
        setTimeout(() => {
          _.style(this.currentImg.parentNode, { transform: "scale(1)" });
        }, 50);
    }
    _toggleZoom() {
    ...
    _addEvents() {
      ...
      (this._onWindowTouchmove = this._onWindowTouchmove.bind(this)),
        ...
        t.forEach((e) => {
          g.on(e, "mousedown", this._onImgMousedown, { passive: !0 }),
            g.on(e, "touchstart", this._onImgMousedown, { passive: !0 }),
            g.on(e, "mousemove", this._onImgMousemove, { passive: !0 }),
            g.on(e, "touchmove", this._onImgMousemove, { passive: !0 }),
            g.on(e, "wheel", this._onImgWheel, { passive: !0 }),
            g.on(e, "dblclick", this._onImgDoubleClick, { passive: !0 });
        }),
        document.addEventListener("touchmove", this._onWindowTouchmove, {
          passive: !1,
        }),
        g.on(window, "touchstart", this._onWindowTouchstart),
        g.on(window, "mouseup", this._onImgMouseup),
        g.on(window, "touchend", this._onImgTouchend),
        g.on(window, "resize", this._onWindowResize),
        g.on(window, "orientationchange", this._onWindowResize),
        g.on(window, "keyup", this._onKeyupEvent),
        g.on(window, "fullscreenchange", this._onWindowFullscreenChange),
        g.on(this._gallery, "mousemove", this._onAnyImgAction),
        g.on(this._gallery, "click", this._onGalleryClick),
        g.on(this._rightArrow, "keydown", this._onRightArrowKeydownEvent),
        g.on(this._fullscreenBtn, "keydown", this._onFullscreenBtnKeydownEvent);
    }
    _removeEvents() {
      m.find("img", this._galleryContent).forEach((e) => {
        g.off(e, "mousedown", this._onImgMousedown),
          g.off(e, "touchstart", this._onImgMousedown),
          g.off(e, "mousemove", this._onImgMousemove),
          g.off(e, "touchmove", this._onImgMousemove),
          g.off(e, "wheel", this._onImgWheel),
          g.off(e, "dblclick", this._onImgDoubleClick);
      }),
        document.removeEventListener("touchmove", this._onWindowTouchmove, {
          passive: !1,
        }),
        g.off(window, "touchstart", this._onWindowTouchstart),
        g.off(window, "mouseup", this._onImgMouseup),
        g.off(window, "touchend", this._onImgTouchend),
        g.off(window, "resize", this._onWindowResize),
        g.off(window, "orientationchange", this._onWindowResize),
        g.off(window, "keyup", this._onKeyupEvent),
        g.off(window, "fullscreenchange", this._onWindowFullscreenChange),
        g.off(this._gallery, "mousemove", this._onAnyImgAction),
        g.off(this._gallery, "click", this._onGalleryClick),
        g.off(this._rightArrow, "keydown", this._onRightArrowKeydownEvent),
        g.off(
          this._fullscreenBtn,
          "keydown",
          this._onFullscreenBtnKeydownEvent
    ...
    _onMousedown(t) {
      ...
      (this._originalPositionX = parseFloat(this.currentImg.style.left) || 0),
        ...
        (this._mousedownPositionX = s * (1 / this._zoom) - this._positionX),
    ...
    _onMousemove(t) {
      ...
      if ((e && this._resetToolsToggler(), !this._multitouch))
        if (this._zoom !== 1)
          (this._positionX = s * (1 / this._zoom) - this._mousedownPositionX),
            (this._positionY = n * (1 / this._zoom) - this._mousedownPositionY),
            _.style(this.currentImg, {
          ...
          (this._positionX = s * (1 / this._zoom) - this._mousedownPositionX),
            _.style(this.currentImg, { left: `${this._positionX}px` });
        }
    }
    _onMouseup(t) {
    ...
    _checkDoubleTap(t) {
      clearTimeout(this._doubleTapTimer);
      const s = new Date().getTime() - this._tapTime;
      this._tapCounter > 0 && s < 500
    ...
    _hideTools() {
      _.style(this._galleryToolbar, { opacity: 0 }),
        _.style(this._leftArrowWrapper, { opacity: 0 }),
        _.style(this._rightArrowWrapper, { opacity: 0 });
    }
    _showTools() {
      _.style(this._galleryToolbar, { opacity: 1 }),
        _.style(this._leftArrowWrapper, { opacity: 1 }),
        _.style(this._rightArrowWrapper, { opacity: 1 });
    }
    _disableScroll() {
      _.addClass(document.body, "overflow-y-hidden relative"),
        document.documentElement.scrollHeight >
          document.documentElement.clientHeight &&
          _.addClass(document.body, "md:pr-[17px]");
    }
    _enableScroll() {
      setTimeout(() => {
        _.removeClass(document.body, "overflow-y-hidden relative"),
          _.removeClass(document.body, "md:pr-[17px]");
      }, 300);
    }
    _animationStart() {
      (this._animating = !0),
    ...
    _restoreDefaultPosition() {
      ...
      _.style(this.currentImg.parentNode, { left: 0, top: 0 }),
        _.style(this.currentImg, {
        ...
        this._calculateImgSize(t),
        setTimeout(() => {
          _.style(this.currentImg, { transition: "none" });
        }, 500);
    }
    async _triggerEvents(t, e) {
      g.trigger(this._element, `${t}.te.lightbox`),
        e &&
          (await setTimeout(() => {
            g.trigger(this._element, `${e}.te.lightbox`);
          }, 505));
    }
    static getInstance(t) {
      return M.getData(t, rn);
    }
    static getOrCreateInstance(t, e = {}) {
      return (
        this.getInstance(t) || new this(t, typeof e == "object" ? e : null)
    ...
    static toggle() {
      return function (t) {
        const e = m.closest(t.target, `${Pu}`);
        (ps.getInstance(e) || new ps(e)).open(t);
      };
    }
    static jQueryInterface(t, e) {
      return this.each(function () {
        let s = M.getData(this, rn);
        const n = typeof t == "object" && t;
        if (
          !(!s && /dispose/.test(t)) &&
          (s || (s = new ps(this, n)), typeof t == "string")
        ) {
          if (typeof s[t] > "u") throw new TypeError(`No method named "${t}"`);
          s[t](e);
        }
  ...
  const qC = (i, t = "hide") => {
      const e = `click.dismiss${i.EVENT_KEY}`,
        s = i.NAME;
      g.on(document, e, `[data-te-${s}-dismiss]`, function (n) {
        if (
          (["A", "AREA"].includes(this.tagName) && n.preventDefault(), ri(this))
        )
          return;
        const o =
          Pe(this) ||
          this.closest(`.${s}`) ||
          this.closest(`[data-te-${s}-init]`);
        if (!o) return;
      ...
      cc(() => {
        ...
        if (t) {
          ...
          (t.fn[e] = i.jQueryInterface),
            ...
            (t.fn[e].noConflict = () => ((t.fn[e] = s), i.jQueryInterface));
        }
      });
    },
    QC = (i, t) => {
      g.on(document, `click.te.${i.NAME}`, t, function (e) {
        e.preventDefault(), i.getOrCreateInstance(this).toggle();
      });
    },
    JC = (i, t) => {
      g.on(document, `click.te.${i.NAME}.data-api`, t, function (e) {
        if (
          (["A", "AREA"].includes(this.tagName) && e.preventDefault(), ri(this))
        )
          return;
    ...
    tA = (i, t) => {
      g.on(document, `click.te.${i.NAME}.data-api`, t, function (e) {
        ...
        if (
          ...
          return;
        g.one(s, i.EVENT_HIDDEN, () => {
          oe(this) && this.focus();
        });
        const n = m.findOne(i.OPEN_SELECTOR);
        n && n !== s && i.getInstance(n).hide(),
          i.getOrCreateInstance(s).toggle(this);
      });
    },
    eA = (i, t) => {
      g.on(document, `click.te.${i.NAME}`, t, (e) => {
        e.preventDefault();
    ...
    iA = (i, t) => {
      g.on(document, `click.te.${i.NAME}`, t, function (e) {
        ...
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
          g.one(s, i.EVENT_SHOW, (r) => {
            r.defaultPrevented ||
              g.one(s, i.EVENT_HIDDEN, () => {
                oe(this) && this.focus();
              });
          });
        const n = m.findOne(`[${i.OPEN_SELECTOR}="true"]`);
        n && i.getInstance(n).hide(), i.getOrCreateInstance(s).toggle(this);
      });
    },
    sA = (i, t) => {
      g.one(document, "mousedown", t, i.autoInitial(new i()));
    },
    nA = (i, t) => {
      g.on(document, `click.te.${i.NAME}.data-api`, t, function (e) {
        (e.target.tagName === "A" ||
        ...
        const s = Pr(this);
        m.find(s).forEach((o) => {
          i.getOrCreateInstance(o, { toggle: !1 }).toggle();
        });
      });
    },
    oA = (i, t) => {
    ...
    lA = (i, t) => {
      ...
      m.find(t).forEach((o) => {
        if (
          _.getDataAttribute(o, "chart") !== "bubble" &&
          _.getDataAttribute(o, "chart") !== "scatter"
        ) {
          const r = _.getDataAttributes(o),
            a = { data: { datasets: [n(r)] } };
          return (
  ...
  const hl = new cA(),
    ...
    hA = (i) => an[i.NAME] || null,
    dA = (i) => {
      if (!i || hl.isInited(i.NAME)) return;
      hl.add(i.NAME);
      const t = hA(i),
        e = (t == null ? void 0 : t.isToggler) || !1;
      if (
        (ZC(i),
        t != null && t.dismissMethod && qC(i, t.dismissMethod),
        t != null && t.advanced)
      ) {
      ...
      m.find(t == null ? void 0 : t.selector).forEach((s) => {
        let n = i.getInstance(s);
        n || ((n = new i(s)), t != null && t.onInit && n[t.onInit]());
      });
    },
    uA = (i) => {
      i.forEach((t) => dA(t));
    ...
    Bu = (i, t = !1) => {
      const e = Object.keys(an).map((s) => {
        if (!!document.querySelector(an[s].selector)) {
          const o = i[an[s].name];
          return (
            !o &&
              !hl.isInited(s) &&
              t &&
              console.warn(
                `Please import ${an[s].name} from "tw-elements" package and add it to a object parameter inside "initTE" function`
              ),
            o
          );
        }
    ...
    Hu = "sidenav",
    Qo = "te.sidenav",
    pA = "data-te-sidenav-rotate-icon-ref",
    dl = "[data-te-sidenav-toggle-ref]",
    fA = "[data-te-collapse-init]",
    _A = '[data-te-sidenav-slim="true"]',
    gA = '[data-te-sidenav-slim="false"]',
    mA = "[data-te-sidenav-menu-ref]",
    fs = "[data-te-sidenav-collapse-ref]",
    ln = "[data-te-sidenav-link-ref]",
    bA = st() ? 100 : -100,
    vA = st() ? -100 : 100,
    yA = {
  ...
  class Ai {
    constructor(t, e = {}) {
      we(this, "_addBackdropOnInit", () => {
        this._options.sidenavHidden ||
          (this._backdrop.show(),
          g.off(this._element, "transitionend", this._addBackdropOnInit));
      });
      (this._element = t),
        (this._options = e),
        (this._ID = Gt("")),
        ...
        (this.escHandler = (s) => {
          s.keyCode === Hs &&
            this.toggler &&
            oe(this.toggler) &&
            (this._update(!1), g.off(window, "keydown", this.escHandler));
        }),
        (this.hashHandler = () => {
          this._setActiveElements();
        }),
        t && (M.setData(t, Qo, this), this._setup()),
        this.options.sidenavBackdrop &&
          !this.options.sidenavHidden &&
          this.options.sidenavMode === "over" &&
          g.on(this._element, "transitionend", this._addBackdropOnInit),
        (this._didInit = !1),
        this._init();
    }
    static get NAME() {
    ...
    get links() {
      return m.find(ln, this._element);
    }
    get navigation() {
      return m.find(mA, this._element);
    }
    get options() {
      const t = {
        ...xA,
    ...
    get toggler() {
      return m.find(dl).find((e) => {
        const s = _.getDataAttribute(e, "target");
        return m.findOne(s) === this._element;
      });
    }
    ...
    get translation() {
      return this.options.sidenavRight ? vA : bA;
    }
    get width() {
    ...
    dispose() {
      g.off(window, "keydown", this.escHandler),
        this.options.sidenavBackdrop && this._backdrop.dispose(),
        g.off(window, "hashchange", this.hashHandler),
        this._touch.dispose(),
        M.removeData(this._element, Qo),
        (this._element = null);
    }
    ...
    _init() {
      this._didInit ||
        (g.on(document, "click", dl, Ai.toggleSidenav()), (this._didInit = !0));
    }
    ...
    _setModeFromBreakpoints() {
      ...
      const s =
        ...
        a = [s, n, o].filter((l) => l != null && l >= 0).sort(r)[0];
      s > 0 && s === a
        ? ((this._options.sidenavMode = "over"),
    ...
    _collapseItems() {
      this.navigation.forEach((t) => {
        m.find(fs, t).forEach((s) => {
          ae.getInstance(s).hide();
        });
      });
    }
    _getOffsetValue(t, { index: e, property: s, offsets: n }) {
      const o = this._getPxValue(this._initialContentStyle[e][n[s].property]),
        r = t ? n[s].value : 0;
      return o + r;
    }
    _getProperty(...t) {
      return t
        .map((e, s) => (s === 0 ? e : e[0].toUpperCase().concat(e.slice(1))))
        .join("");
    }
    _getPxValue(t) {
    ...
    _handleSwipe(t, e) {
      ...
      this.options.sidenavExpandable
        ...
        : e ||
          ...
          !this.options.sidenavSlim ||
          !this.options.sidenavExpandable
            ? this.toggler && oe(this.toggler) && this.toggle()
            : this.toggleSlim());
    }
    _isActive(t, e) {
      return e
    ...
    _isAllToBeCollapsed() {
      return (
        m
          .find(fA, this._element)
          .filter((s) => s.getAttribute("aria-expanded") === "true").length ===
        0
      );
    }
    _isAllCollapsed() {
      return m.find(fs, this._element).filter((t) => oe(t)).length === 0;
    }
    _initializeBackDrop() {
    ...
    _setupActiveState() {
      this._setActiveElements(),
        this.links.forEach((t) => {
          g.on(t, "click", () => this._setActiveElements(t)),
            g.on(t, "keydown", (e) => {
              e.keyCode === $t && this._setActiveElements(t);
            });
        }),
        g.on(window, "hashchange", this.hashHandler);
    }
    _setupCollapse() {
      this.navigation.forEach((t, e) => {
        m.find(fs, t).forEach((n, o) =>
    ...
    _setupCollapseList({ list: t, index: e, menu: s, menuIndex: n }) {
      ...
      const [r] = m.prev(t, ln);
      _.setDataAttribute(r, "collapse-init", ""),
      ...
      (t.dataset.teSidenavStateShow === "" ||
        ...
        g.on(t, "show.te.collapse", () => this._rotateArrow(r, !1)),
        g.on(t, "hide.te.collapse", () => this._rotateArrow(r, !0)),
        g.on(t, "shown.te.collapse", () => {
          this.options.sidenavMode === "over" &&
            this._focusTrap &&
            this._focusTrap.update();
        }),
        g.on(t, "hidden.te.collapse", () => {
          this._tempSlim &&
    ...
    _setupFocusTrap() {
      this._focusTrap = new Is(
        this._element,
        {
          event: "keydown",
          condition: (t) => t.keyCode === Fs,
          onlyVisible: !0,
        },
        this.toggler
      );
    ...
    _setupInitialStyling() {
      this._setColor(), _.style(this._element, this.sidenavStyle);
    }
    _setupScrolling() {
      let t = this._element;
      if (this.options.sidenavScrollContainer) {
        t = m.findOne(this.options.sidenavScrollContainer, this._element);
        const s = N_(t.parentNode.children)
          .filter((n) => n !== t)
          .reduce((n, o) => n + o.clientHeight, 0);
        _.style(t, { maxHeight: `calc(100% - ${s}px)`, position: "relative" });
      }
      this._perfectScrollbar = new hs(t, {
        suppressScrollX: !0,
    ...
    _setupRippleEffect() {
      this.links.forEach((t) => {
        let e = ze.getInstance(t),
          s = this.options.sidenavColor;
        ...
        (localStorage.theme === "dark" ||
          (!("theme" in localStorage) &&
            window.matchMedia("(prefers-color-scheme: dark)").matches)) &&
          (s = "white"),
          (e = new ze(t, { rippleColor: s }));
      });
    }
    _setupTouch() {
      (this._touch = new By(this._element, "swipe", { threshold: 20 })),
        this._touch.init(),
        g.on(this._element, "swipeleft", (t) =>
          this._handleSwipe(t, this.options.sidenavRight)
        ),
        g.on(this._element, "swiperight", (t) =>
          this._handleSwipe(t, !this.options.sidenavRight)
        );
    }
    _setActive(t, e) {
      t.setAttribute("data-te-sidebar-state-active", ""),
        ...
        (this._activeNode = t);
      const [s] = m.parents(this._activeNode, fs);
      if (!s) {
      ...
      this._setActiveCategory(n),
        !e && !this._slimCollapsed && ae.getInstance(s).show();
    }
    _setActiveCategory(t) {
      this.navigation.forEach((e) => {
        m.find(fs, e).forEach((n) => {
          const [o] = m.prev(n, ln);
          o !== t
    ...
    _setColor() {
      const t = [
        ...
        s = t.includes(e) ? e : "primary";
      t.forEach((n) => {
        this._element.classList.remove(`sidenav-${n}`);
      }),
        _.addClass(this._element, `sidenav-${s}`);
    }
    _setContentOffsets(t, e, s) {
      this._content.forEach((n, o) => {
        const r = this._getOffsetValue(t, {
          ...
          l = {};
        if (
          (s || (l.transition = `all ${this.transitionDuration} linear`),
          ...
          if (s) {
            _.style(n, { transition: this._initialContentStyle[o].transition });
            return;
          }
          g.on(n, "transitionend", () => {
            _.style(n, { transition: this._initialContentStyle[o].transition });
          });
        }
      });
    ...
    _setSlim(t) {
      ...
      this._triggerEvents(...e),
        ...
        _.style(this._element, { width: `${this.width}px` }),
    ...
    _rotateArrow(t, e) {
      const [s] = m.children(t, `[${pA}]`);
      s && (e ? _.removeClass(s, "rotate-180") : _.addClass(s, "rotate-180"));
    }
    _toggleCategory(t, e) {
      t.preventDefault(),
        e.toggle(),
    ...
    _toggleSlimDisplay(t) {
      const e = m.find(_A, this._element),
        s = m.find(gA, this._element),
        n = () => {
          e.forEach((o) => {
            _.style(o, { display: this._slimCollapsed ? "unset" : "none" });
          }),
            s.forEach((o) => {
              _.style(o, { display: this._slimCollapsed ? "none" : "unset" });
            });
        };
      t ? setTimeout(() => n(), this.options.sidenavTransitionDuration) : n();
    }
    async _triggerEvents(t, e) {
      g.trigger(this._element, `${t}.te.sidenav`),
        e &&
          (await setTimeout(() => {
            g.trigger(this._element, `${e}.te.sidenav`);
    ...
    _update(t) {
      t && this._isiPhone() && _.addClass(this._element, "ps--scrolling-y"),
        ...
        t &&
          ...
          g.on(window, "keydown", this.escHandler),
        this.options.sidenavFocusTrap && this._updateFocus(t);
    }
    _updateDisplay(t) {
      const e = t ? 0 : this.translation;
      _.style(this._element, { transform: `translateX(${e}%)` });
    }
    _updateFocus(t) {
      if (
        (this._setTabindex(t),
    ...
    _updateOffsets(t, e = !1) {
      ...
      g.trigger(this._element, "update.te.sidenav", { margin: r, padding: o }),
        this._content &&
    ...
    static toggleSidenav() {
      return function (t) {
        const e = m.closest(t.target, dl),
          s = _.getDataAttributes(e).target;
        m.find(s).forEach((n) => {
          (Ai.getInstance(n) || new Ai(n)).toggle();
        });
      };
    }
    static jQueryInterface(t, e) {
      return this.each(function () {
        let s = M.getData(this, Qo);
        const n = typeof t == "object" && t;
        if (
          !(!s && /dispose/.test(t)) &&
          (s || (s = new Ai(this, n)), typeof t == "string")
        ) {
          if (typeof s[t] > "u") throw new TypeError(`No method named "${t}"`);
          s[t](e);
        }
  ...
  function tr(i) {
    if (Q(i)) return i.map(tr);
    if (F(i)) {
      const t = Object.create(null),
        e = Object.keys(i),
        s = e.length;
      let n = 0;
      for (; n < s; ++n) t[e[n]] = tr(i[e[n]]);
      return t;
    }
    return i;
  }
  ...
  function AA(i, t, e) {
    ...
    F(s) && F(n)
      ? cn(s, n)
      : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = tr(n));
  }
  const Vu = { "": (i) => i, x: (i) => i.x, y: (i) => i.y };
  function Ze(i, t) {
    return (Vu[t] || (Vu[t] = wA(t)))(i);
  }
  function wA(i) {
    const t = kA(i);
    return (e) => {
  ...
  const Wt = (i) => typeof i < "u",
    Qe = (i) => typeof i == "function",
    zu = (i, t) => {
  ...
  function Xu(i, t) {
    ...
    return o < -0.5 * et && (o += q), { angle: o, distance: n };
  }
  function fl(i, t) {
  ...
  const De = (i, t, e, s) =>
      _l(i, e, s ? (n) => i[n][t] <= e : (n) => i[n][t] < e),
    RA = (i, t, e) => _l(i, e, (s) => i[s][t] >= e);
  function PA(i, t, e) {
    let s = 0,
      n = i.length;
    for (; s < n && i[s] < t; ) s++;
  ...
  const gl = (i) => (i === "start" ? "left" : i === "end" ? "right" : "center"),
    ft = (i, t, e) => (i === "start" ? t : i === "end" ? e : (t + e) / 2),
    HA = (i, t, e, s) =>
    ...
    if (i._sorted) {
      ...
      d &&
        (n = ct(
          Math.min(
            De(a, r.axis, c).lo,
            e ? s : De(t, l, r.getPixelForValue(c)).lo
          ),
          0,
          s - 1
        )),
  ...
  const ir = (i) => i === 0 || i === 1,
    ip = (i, t, e) =>
      -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * q) / e)),
    sp = (i, t, e) => Math.pow(2, -10 * i) * Math.sin(((i - t) * q) / e) + 1,
    pn = {
      linear: (i) => i,
      easeInQuad: (i) => i * i,
      easeOutQuad: (i) => -i * (i - 2),
      ...
      easeInElastic: (i) => (ir(i) ? i : ip(i, 0.075, 0.3)),
      easeOutElastic: (i) => (ir(i) ? i : sp(i, 0.075, 0.3)),
      easeInOutElastic(i) {
        return ir(i)
          ? i
          : i < 0.5
          ? 0.5 * ip(i * 2, 0.1125, 0.45)
          : 0.5 + 0.5 * sp(i * 2 - 1, 0.1125, 0.45);
      },
      easeInBack(i) {
      ...
      easeInBounce: (i) => 1 - pn.easeOutBounce(1 - i),
      easeOutBounce(i) {
        return i < 1 / 2.75
          ? 7.5625 * i * i
          : i < 2 / 2.75
      ...
      easeInOutBounce: (i) =>
        i < 0.5
          ? pn.easeInBounce(i * 2) * 0.5
          : pn.easeOutBounce(i * 2 - 1) * 0.5 + 0.5,
    };
  /*!
   * @kurkle/color v0.2.1
  ...
  const Je = (i, t, e) => Math.max(Math.min(i, e), t);
  function _n(i) {
    return Je(fn(i * 2.55), 0, 255);
  }
  function ti(i) {
    return Je(fn(i * 255), 0, 255);
  }
  function Ie(i) {
    return Je(fn(i / 2.55) / 100, 0, 1);
  }
  function np(i) {
    return Je(fn(i * 100), 0, 100);
  }
  const zt = {
      0: 0,
      1: 1,
    ...
    ml = [..."0123456789ABCDEF"],
    FA = (i) => ml[i & 15],
    WA = (i) => ml[(i & 240) >> 4] + ml[i & 15],
    sr = (i) => (i & 240) >> 4 === (i & 15),
    VA = (i) => sr(i.r) && sr(i.g) && sr(i.b) && sr(i.a);
  function zA(i) {
    var t = i.length,
      e;
    return (
        ...
        (t === 4 || t === 5
          ...
          : (t === 7 || t === 9) &&
            (e = {
              ...
              g: (zt[i[3]] << 4) | zt[i[4]],
              b: (zt[i[5]] << 4) | zt[i[6]],
              a: t === 9 ? (zt[i[7]] << 4) | zt[i[8]] : 255,
            })),
      e
    );
  }
  const YA = (i, t) => (i < 255 ? t(i) : "");
  function jA(i) {
    var t = VA(i) ? FA : WA;
    return i ? "#" + t(i.r) + t(i.g) + t(i.b) + YA(i.a, t) : void 0;
  }
  const KA =
  ...
  function vl(i, t, e, s) {
    return (Array.isArray(t) ? i(t[0], t[1], t[2]) : i(t, e, s)).map(ti);
  }
  function yl(i, t, e) {
    return vl(op, i, t, e);
  }
  ...
  let nr;
  function iw(i) {
    nr || ((nr = ew()), (nr.transparent = [0, 0, 0, 0]));
    const t = nr[i.toLowerCase()];
  ...
  function nw(i) {
    ...
    if (t) {
      if (t[7] !== s) {
        const r = +t[7];
        e = t[8] ? _n(r) : Je(r * 255, 0, 255);
      }
      return (
        (s = +t[1]),
        (n = +t[3]),
        (o = +t[5]),
        (s = 255 & (t[2] ? _n(s) : Je(s, 0, 255))),
        (n = 255 & (t[4] ? _n(n) : Je(n, 0, 255))),
        (o = 255 & (t[6] ? _n(o) : Je(o, 0, 255))),
        { r: s, g: n, b: o, a: e }
      );
    }
  }
  function ow(i) {
    return (
      i &&
      (i.a < 255
        ? `rgba(${i.r}, ${i.g}, ${i.b}, ${Ie(i.a)})`
        : `rgb(${i.r}, ${i.g}, ${i.b})`)
    );
  }
  const xl = (i) =>
      i <= 0.0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - 0.055,
    gs = (i) => (i <= 0.04045 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4));
  function rw(i, t, e) {
    const s = gs(Ie(i.r)),
      n = gs(Ie(i.g)),
      o = gs(Ie(i.b));
    return {
      r: ti(xl(s + e * (gs(Ie(t.r)) - s))),
      g: ti(xl(n + e * (gs(Ie(t.g)) - n))),
      b: ti(xl(o + e * (gs(Ie(t.b)) - o))),
      a: i.a + e * (t.a - i.a),
    };
  }
  function or(i, t, e) {
    ...
    return (
      Array.isArray(i)
        ? i.length >= 3 &&
          ...
          i.length > 3 && (t.a = ti(i[3])))
        : ((t = cp(i, { r: 0, g: 0, b: 0, a: 1 })), (t.a = ti(t.a))),
      t
    );
  }
  function aw(i) {
    return i.charAt(0) === "r" ? nw(i) : QA(i);
  }
  class rr {
    constructor(t) {
    ...
    rgbString() {
      return this._valid ? ow(this._rgb) : void 0;
    }
    hexString() {
    ...
    interpolate(t, e) {
      return t && (this._rgb = rw(this._rgb, t._rgb, e)), this;
    }
    clone() {
      return new rr(this.rgb);
    }
    alpha(t) {
      return (this._rgb.a = ti(t)), this;
    }
    clearer(t) {
      const e = this._rgb;
      return (e.a *= 1 - t), this;
    ...
    greyscale() {
      const t = this._rgb,
        e = fn(t.r * 0.3 + t.g * 0.59 + t.b * 0.11);
    ...
    lighten(t) {
      return or(this._rgb, 2, t), this;
    }
    darken(t) {
      return or(this._rgb, 2, -t), this;
    }
    saturate(t) {
      return or(this._rgb, 1, t), this;
    }
    desaturate(t) {
      return or(this._rgb, 1, -t), this;
    }
    rotate(t) {
      return JA(this._rgb, t), this;
    }
  }
  function dp(i) {
    return new rr(i);
  ...
  function Tl(i) {
    return up(i) ? i : dp(i).saturate(0.5).darken(0.1).hexString();
  }
  ...
  function Cl(i, t, e) {
    return typeof t == "string" ? ye(gn(i, t), e) : ye(gn(i, ""), t);
  }
  class lw {
    constructor(t) {
      (this.animation = void 0),
        ...
        (this.hover = {}),
        (this.hoverBackgroundColor = (e, s) => Tl(s.backgroundColor)),
        (this.hoverBorderColor = (e, s) => Tl(s.borderColor)),
        (this.hoverColor = (e, s) => Tl(s.color)),
        (this.indexAxis = "x"),
        (this.interaction = {
          mode: "nearest",
          intersect: !0,
      ...
      Object.defineProperties(o, {
        ...
        [e]: {
          ...
          get() {
            const l = this[a],
              c = r[n];
            return F(l) ? Object.assign({}, c, l) : N(l, c);
          },
          set(l) {
            this[a] = l;
          },
  ...
  function hw(i, t, e, s) {
    ...
    let l, c, h, d, u;
    for (l = 0; l < a; l++)
      if (((d = e[l]), d != null && Q(d) !== !0)) r = ar(i, n, o, r, d);
      else if (Q(d))
        for (c = 0, h = d.length; c < h; c++)
          (u = d[c]), u != null && !Q(u) && (r = ar(i, n, o, r, u));
    i.restore();
    const p = o.length / 2;
    if (p > e.length) {
  ...
  function _p(i, t, e, s, n) {
    ...
    if (!(isNaN(p) || p <= 0)) {
      switch ((i.beginPath(), d)) {
        default:
          n ? i.ellipse(e, s, n / 2, p, 0, 0, q) : i.arc(e, s, p, 0, q),
            i.closePath();
          break;
        case "triangle":
          i.moveTo(e + Math.sin(f) * p, s - Math.cos(f) * p),
            (f += Yu),
            i.lineTo(e + Math.sin(f) * p, s - Math.cos(f) * p),
            (f += Yu),
            i.lineTo(e + Math.sin(f) * p, s - Math.cos(f) * p),
            i.closePath();
          break;
        case "rectRounded":
          (c = p * 0.516),
            ...
            (r = Math.cos(f + hn) * l),
            (a = Math.sin(f + hn) * l),
            i.arc(e - r, s - a, c, f - et, f - nt),
            i.arc(e + a, s - r, c, f - nt, f),
            i.arc(e + r, s + a, c, f, f + nt),
            i.arc(e - a, s + r, c, f + nt, f + et),
            i.closePath();
          break;
        case "rect":
          if (!u) {
        ...
        case "line":
          ...
          break;
        case "dash":
          i.moveTo(e, s), i.lineTo(e + Math.cos(f) * p, s + Math.sin(f) * p);
          break;
      }
  ...
  function Si(i, t, e, s, n, o = {}) {
    ...
    let l, c;
    for (i.save(), i.font = n.string, pw(i, o), l = 0; l < r.length; ++l)
      (c = r[l]),
        a &&
          (o.strokeColor && (i.strokeStyle = o.strokeColor),
          H(o.strokeWidth) || (i.lineWidth = o.strokeWidth),
  ...
  function bn(i, t) {
    ...
    i.arc(e + r.topLeft, s + r.topLeft, r.topLeft, -nt, et, !0),
      i.lineTo(e, s + o - r.bottomLeft),
      i.arc(e + r.bottomLeft, s + o - r.bottomLeft, r.bottomLeft, et, nt, !0),
      ...
      i.arc(e + n - r.topRight, s + r.topRight, r.topRight, 0, -nt, !0),
      i.lineTo(e + r.topLeft, s);
  }
  const _w = new RegExp(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/),
    gw = new RegExp(
  ...
  function wl(i, t) {
    const e = {},
      s = F(t),
      n = s ? Object.keys(t) : t,
      o = F(i) ? (s ? (r) => N(i[r], i[t[r]]) : (r) => i[r]) : () => i;
    for (const r of n) e[r] = bw(o(r));
    return e;
  }
  function gp(i) {
    return wl(i, { top: "y", right: "x", bottom: "y", left: "x" });
  }
  function Oi(i) {
    return wl(i, ["topLeft", "topRight", "bottomLeft", "bottomRight"]);
  }
  function ht(i) {
    const t = gp(i);
  ...
  function kl(i, t = [""], e = i, s, n = () => i[0]) {
    Wt(s) || (s = xp("_fallback", i));
    const o = {
  ...
  function ms(i, t, e, s) {
    const n = {
      ...
      _stack: new Set(),
      _descriptors: mp(i, s),
      setContext: (o) => ms(i, o, e, s),
      override: (o) => ms(i.override(o), t, e, s),
    };
    return new Proxy(n, {
      deleteProperty(o, r) {
  ...
  function mp(i, t = { scriptable: !0, indexable: !0 }) {
    const {
    ...
    return {
      ...
      scriptable: e,
      indexable: s,
      isScriptable: Qe(e) ? e : () => e,
      isIndexable: Qe(s) ? s : () => s,
    };
  }
  const yw = (i, t) => (i ? i + ul(t) : t),
    Sl = (i, t) =>
      F(t) &&
      i !== "adapters" &&
  ...
  function xw(i, t, e) {
    ...
    let a = s[t];
    return (
      Qe(a) && r.isScriptable(t) && (a = Tw(t, a, i, e)),
      Q(a) && a.length && (a = Ew(t, a, i, r.isIndexable)),
      Sl(t, a) && (a = ms(a, n, o && o[t], r)),
      a
    );
  }
  function Tw(i, t, e, s) {
    ...
    return (
      ...
      (t = t(o, r || s)),
      a.delete(i),
      Sl(i, t) && (t = Ol(n._scopes, n, i, t)),
      t
    );
  }
  function Ew(i, t, e, s) {
    const { _proxy: n, _context: o, _subProxy: r, _descriptors: a } = e;
    if (Wt(o.index) && s(i)) t = t[o.index % t.length];
    else if (F(t[0])) {
      const l = t,
  ...
  const Cw = (i, t) =>
    i === !0 ? t : typeof i == "string" ? Ze(t, i) : void 0;
  function Aw(i, t, e, s, n) {
    for (const o of t) {
      const r = Cw(e, o);
      if (r) {
        i.add(r);
        const a = vp(r._fallback, e, n);
        if (Wt(a) && a !== e && a !== s) return a;
      } else if (r === !1 && Wt(s) && e !== s) return null;
    }
    return !1;
  }
  function Ol(i, t, e, s) {
    const n = t._rootScopes,
      o = vp(t._fallback, e, s),
      r = [...i, ...n],
      a = new Set();
    a.add(s);
    let l = yp(a, r, e, o || e, s);
    return l === null ||
      (Wt(o) && o !== e && ((l = yp(a, r, o, l, s)), l === null))
      ? !1
      : kl(Array.from(a), [""], n, o, () => ww(t, e, s));
  }
  function yp(i, t, e, s, n) {
    for (; e; ) e = Aw(i, t, e, s, n);
    return e;
  }
  function ww(i, t, e) {
  ...
  function kw(i, t, e, s) {
    let n;
    for (const o of t)
      if (((n = xp(yw(o, i), e)), Wt(n))) return Sl(i, n) ? Ol(e, s, i, n) : n;
  }
  function xp(i, t) {
    for (const e of t) {
      if (!e) continue;
  ...
  function Tp(i) {
    let t = i._keys;
    return t || (t = i._keys = Sw(i._scopes)), t;
  }
  function Sw(i) {
    const t = new Set();
    for (const e of i)
  ...
  function Ep(i, t, e, s) {
    ...
    let a, l, c, h;
    for (a = 0, l = s; a < l; ++a)
      (c = a + e), (h = t[c]), (r[a] = { r: n.parse(Ze(h, o), c) });
    return r;
  }
  const Ow = Number.EPSILON || 1e-14,
    bs = (i, t) => t < i.length && !i[t].skip && i[t],
    Cp = (i) => (i === "x" ? "y" : "x");
  function Dw(i, t, e, s) {
    const n = i.skip ? t : i,
      o = t,
  ...
  function Mw(i, t, e = "x") {
    ...
    let o,
      ...
      l = bs(i, 0);
    for (let c = 0; c < n; ++c) {
      if (((r = a), (a = l), (l = bs(i, c + 1)), !a)) continue;
      const h = a[e],
        d = a[s];
      r &&
        ((o = (h - r[e]) / 3),
    ...
    for (e = 0, s = i.length; e < s; ++e)
      (r = o),
        ...
        o &&
          ((n = i[e]),
          r &&
            ((n.cp1x = hr(n.cp1x, t.left, t.right)),
            (n.cp1y = hr(n.cp1y, t.top, t.bottom))),
          a &&
            ((n.cp2x = hr(n.cp2x, t.left, t.right)),
            (n.cp2y = hr(n.cp2y, t.top, t.bottom))));
  }
  function Rw(i, t, e, s, n) {
    let o, r, a, l;
    if (
      ...
      for (o = 0, r = i.length; o < r; ++o)
        (a = i[o]),
          (l = Dw(c, a, i[Math.min(o + 1, r - (s ? 0 : 1)) % r], t.tension)),
          (a.cp1x = l.previous.x),
          (a.cp1y = l.previous.y),
          (a.cp2x = l.next.x),
          (a.cp2y = l.next.y),
  ...
  const ur = (i) => window.getComputedStyle(i, null);
  function Pw(i, t) {
    return ur(i).getPropertyValue(t);
  }
  ...
  const Bw = (i, t, e) => (i > 0 || t > 0) && (!e || !e.shadowRoot);
  function Hw(i, t) {
    const e = i.touches,
      s = e && e.length ? e[0] : i,
    ...
    if (t === void 0 || e === void 0) {
      ...
      if (!o) (t = i.clientWidth), (e = i.clientHeight);
        ...
        (t = r.width - c.width - l.width),
          ...
          (s = dr(a.maxWidth, o, "clientWidth")),
          (n = dr(a.maxHeight, o, "clientHeight"));
      }
    }
    return { width: t, height: e, maxWidth: s || er, maxHeight: n || er };
  }
  const Il = (i) => Math.round(i * 10) / 10;
  function Ww(i, t, e, s) {
    const n = ur(i),
      o = Di(n, "margin"),
      r = dr(n.maxWidth, i, "clientWidth") || er,
      a = dr(n.maxHeight, i, "clientHeight") || er,
      l = Fw(i, t, e);
    let { width: c, height: h } = l;
    if (n.boxSizing === "content-box") {
      const d = Di(n, "border", "width"),
        u = Di(n, "padding");
    ...
    return (
      ...
      (c = Il(Math.min(c, r, l.maxWidth))),
      (h = Il(Math.min(h, a, l.maxHeight))),
      c && !h && (h = Il(c / 2)),
      { width: c, height: h }
    );
  }
  ...
  function jw(i, t) {
    ...
    let s = Sp.get(e);
    return s || ((s = new Intl.NumberFormat(i, t)), Sp.set(e, s)), s;
  }
  function vn(i, t, e) {
    return jw(t, e).format(i);
  }
  const Kw = function (i, t) {
      return {
        x(e) {
          return i + i + t - e;
        },
  ...
  function Ip(i) {
    return i === "angle"
      ? { between: un, compare: LA, normalize: Nt }
      : { between: Oe, compare: (t, e) => t - e, normalize: (t) => t };
  }
  function Mp({ start: i, end: t, count: e, loop: s, style: n }) {
    return {
      start: i % e,
      end: t % e,
      loop: s && (t - i + 1) % e === 0,
  ...
  function Lp(i, t, e) {
    ...
    const { property: s, start: n, end: o } = e,
      r = t.length,
      { compare: a, between: l, normalize: c } = Ip(s),
      { start: h, end: d, loop: u, style: p } = Xw(i, t, e),
      f = [];
    let b = !1,
      v = null,
      y,
      ...
      (x = t[S % r]),
        !x.skip &&
          ...
          y !== E &&
            ...
            v !== null &&
              w() &&
              (f.push(Mp({ start: v, end: S, loop: u, count: r, style: p })),
              (v = null)),
            (k = S),
            (E = y)));
    return (
      v !== null &&
        f.push(Mp({ start: v, end: d, loop: u, count: r, style: p })),
      f
    );
  }
  function $p(i, t) {
  ...
  function Zw(i, t) {
    ...
    if (!n) return [];
    const o = !!i._loop,
      { start: r, end: a } = Gw(e, n, o, s);
    if (s === !0) return Rp(i, [{ start: r, end: a, loop: o }], e, t);
    const l = a < r ? a + n : a,
      c = !!i._fullLoop && r === 0 && a === n - 1;
    return Rp(i, qw(e, r, l, c), e, t);
  }
  function Rp(i, t, e, s) {
    return !s || !s.setContext || !e ? t : Qw(i, t, e, s);
  }
  function Qw(i, t, e, s) {
  ...
  class Bp {
    constructor(t, e, s, n) {
      ...
      (this._active = !0),
        (this._fn = t.fn || ek[t.type || typeof r]),
        (this._easing = pn[t.easing] || pn.linear),
  ...
  const ik = ["x", "y", "borderWidth", "radius", "tension"],
    sk = ["color", "borderColor", "backgroundColor"];
  W.set("animation", {
    delay: void 0,
    duration: 1e3,
    easing: "easeOutQuart",
  ...
  const nk = Object.keys(W.animation);
  W.describe("animation", {
    _fallback: !1,
    _indexable: !1,
    _scriptable: (i) => i !== "onProgress" && i !== "onComplete" && i !== "fn",
  }),
    W.set("animations", {
      colors: { type: "color", properties: sk },
      numbers: { type: "number", properties: ik },
    }),
    W.describe("animations", { _fallback: "animation" }),
    W.set("transitions", {
  ...
  class Ml {
    ...
    configure(t) {
      ...
      Object.getOwnPropertyNames(t).forEach((s) => {
        ...
        if (!F(n)) return;
        const o = {};
        for (const r of nk) o[r] = n[r];
        ((Q(n.properties) && n.properties) || [s]).forEach((r) => {
    ...
    _animateOptions(t, e) {
      ...
      return (
        s.$shared &&
          ok(t.options.$animations, s).then(
            () => {
              t.options = s;
            },
            () => {}
    ...
    update(t, e) {
      ...
      if (s.length) return Te.add(this._chart, s), !0;
    }
  }
  function ok(i, t) {
    const e = [],
  ...
  function Yp(i, t) {
    ...
    for (let p = 0; p < d; ++p) {
      ...
      (u = y[c] = uk(n, h, b)),
        (u[a] = v),
        (u._top = zp(u, r, !0, s.type)),
        (u._bottom = zp(u, r, !1, s.type));
    }
  }
  function Ll(i, t) {
    const e = i.scales;
  ...
  const $l = (i) => i === "reset" || i === "none",
    jp = (i, t) => (t ? i : Object.assign({}, i)),
    _k = (i, t, e) =>
      i && !t.hidden && t._stacked && { keys: Fp(e, !0), values: null };
  class Yt {
    constructor(t, e) {
      (this.chart = t),
        (this._ctx = t.ctx),
    ...
    linkScales() {
      const t = this.chart,
        ...
        o = (e.xAxisID = N(s.xAxisID, Ll(t, "x"))),
        r = (e.yAxisID = N(s.yAxisID, Ll(t, "y"))),
        a = (e.rAxisID = N(s.rAxisID, Ll(t, "r"))),
        l = e.indexAxis,
    ...
    _destroy() {
      const t = this._cachedMeta;
      this._data && qu(this._data, this), t._stacked && yn(t);
    }
    _dataCheck() {
      const t = this.getDataset(),
        e = t.data || (t.data = []),
        s = this._data;
      if (F(e)) this._data = ck(e);
      else if (s !== e) {
        if (s) {
          qu(s, this);
        ...
        e && Object.isExtensible(e) && NA(e, this),
          (this._syncList = []),
          (this._data = e);
      }
    }
    ...
    buildOrUpdateElements(t) {
      ...
      this._dataCheck();
      const o = e._stacked;
      (e._stacked = Vp(e.vScale, e)),
        e.stack !== s.stack && ((n = !0), yn(e), (e.stack = s.stack)),
        this._resyncElements(t),
        (n || o !== e._stacked) && Yp(this, e._parsed);
    }
    configure() {
    ...
    parse(t, e) {
      ...
      if (this._parsing === !1) (s._parsed = n), (s._sorted = !0), (u = n);
        ...
        for (h = 0; h < e; ++h)
          (s._parsed[h + t] = d = u[h]), l && (p() && (l = !1), (c = d));
        s._sorted = l;
      }
      r && Yp(this, u);
    }
    ...
    parseObjectData(t, e, s, n) {
      ...
      for (h = 0, d = n; h < d; ++h)
        (u = h + s),
          (p = e[u]),
          (c[h] = { x: o.parse(Ze(p, a), u), y: r.parse(Ze(p, l), u) });
      return c;
    }
    getParsed(t) {
    ...
    applyStack(t, e, s) {
      const n = this.chart,
        o = this._cachedMeta,
        r = e[t.axis],
        a = { keys: Fp(n, !0), values: e._stacks[t.axis] };
      return Wp(a, r, o.index, { mode: s });
    }
    updateRangeFromParsed(t, e, s, n) {
      const o = s[e.axis];
      let r = o === null ? NaN : o;
      const a = n && s._stacks[e.axis];
      n && a && ((n.values = a), (r = Wp(n, o, this._cachedMeta.index))),
    ...
    _update(t) {
      ...
      this.update(t || "default"),
        (e._clip = lk(
          N(this.options.clip, ak(e.xScale, e.yScale, this.getMaxOverflow()))
        ));
    }
    update(t) {}
    draw() {
    ...
    getContext(t, e, s) {
      ...
      if (t >= 0 && t < this._cachedMeta.data.length) {
        ...
        (o = r.$context || (r.$context = fk(this.getContext(), t, r))),
          (o.parsed = this.getParsed(t)),
          (o.raw = n.data[t]),
          (o.index = o.dataIndex = t);
      } else (o = this.$context || (this.$context = pk(this.chart.getContext(), this.index))), (o.dataset = n), (o.index = o.datasetIndex = this.index);
    ...
    _resolveAnimations(t, e, s) {
      ...
      const c = new Ml(n, l && l.animations);
    ...
    includeOptions(t, e) {
      return !e || $l(t) || this.chart._animationsDisabled;
    }
    ...
    updateElement(t, e, s, n) {
      $l(n) ? Object.assign(t, s) : this._resolveAnimations(e, n).update(t, s);
    }
    updateSharedOptions(t, e, s) {
      t && !$l(e) && this._resolveAnimations(void 0, e).update(t, s);
    }
    _setStyle(t, e, s, n) {
      t.active = n;
  ...
  (Yt.defaults = {}),
    (Yt.prototype.datasetElementType = null),
    (Yt.prototype.dataElementType = null);
  function gk(i, t) {
    if (!i._cache.$bar) {
      ...
      i._cache.$bar = Zu(s.sort((n, o) => n - o));
    }
    return i._cache.$bar;
  }
  function mk(i) {
    ...
    const l = () => {
      r === 32767 ||
        r === -32768 ||
        (Wt(a) && (s = Math.min(s, Math.abs(r - a) || s)), (a = r));
    };
  ...
  function Kp(i, t, e, s) {
    return Q(i) ? yk(i, t, e, s) : (t[e.axis] = e.parse(i, s)), t;
  }
  function Up(i, t, e, s) {
    const n = i.iScale,
      o = i.vScale,
  ...
  function Ek(i, t, e, s) {
    ...
    const { start: r, end: a, reverse: l, top: c, bottom: h } = Tk(i);
    n === "middle" &&
      e &&
  ...
  function Xp(i, t, e, s) {
    return s ? ((i = Ck(i, t, e)), (i = Gp(i, e, t))) : (i = Gp(i, t, e)), i;
  }
  function Ck(i, t, e) {
  ...
  function Ak(i, { inflateAmount: t }, e) {
  ...
  class xn extends Yt {
    ...
    parseObjectData(t, e, s, n) {
      ...
      for (u = s, p = s + n; u < p; ++u)
        (b = e[u]),
          (f = {}),
          (f[o.axis] = o.parse(Ze(b, c), u)),
          d.push(Kp(Ze(b, h), f, r, u));
      return d;
    }
    updateRangeFromParsed(t, e, s, n) {
      ...
      for (let p = e; p < e + s; p++) {
        const f = this.getParsed(p),
          ...
          x = {
            ...
            base: b.base,
            enableBorderRadius:
              !y || Rl(f._custom) || r === y._top || r === y._bottom,
            x: c ? b.head : v.center,
            y: c ? v.center : b.head,
        ...
        const E = x.options || t[p].options;
        Ek(x, E, y, r), Ak(x, E, h.ratio), this.updateElement(t[p], p, x, n);
      }
    }
    _getStacks(t, e) {
    ...
    _calculateBarValuePixels(t) {
      ...
      if (
        ...
        (f = xk(f, e, r) * o), h === r && (v -= f / 2);
        const y = e.getPixelForDecimal(0),
          x = e.getPixelForDecimal(1),
          E = Math.min(y, x),
          T = Math.max(y, x);
        (v = Math.max(Math.min(v, T), E)), (p = v + f);
      }
      if (v === e.getPixelForValue(r)) {
        const y = (xe(f) * e.getLineWidthForValue(r)) / 2;
        (v += y), (f -= y);
      }
    ...
    _calculateBarIndexPixels(t, e) {
      const s = e.scale,
        n = this.options,
        o = n.skipNull,
        r = N(n.maxBarThickness, 1 / 0);
      let a, l;
      if (e.grouped) {
        const c = o ? this._getStackCount(t) : e.stackCount,
          h = n.barThickness === "flex" ? vk(t, e, n, c) : bk(t, e, n, c),
  ...
  class Tn extends Yt {
    ...
    parseArrayData(t, e, s, n) {
      ...
      for (let r = 0; r < o.length; r++) {
        const a = e[s + r];
        o[r]._custom = N(a[2], this.resolveDataElementOptions(r + s).radius);
      }
      return o;
    }
    parseObjectData(t, e, s, n) {
    ...
    resolveDataElementOptions(t, e) {
      ...
      const o = n.radius;
      return (
        e !== "active" && (n.radius = 0), (n.radius += N(s && s._custom, o)), n
      );
    }
  }
  (Tn.id = "bubble"),
  ...
  function wk(i, t, e) {
    ...
    if (t < q) {
      const a = i,
        ...
        d = Math.cos(l),
        u = Math.sin(l),
        p = (E, T, C) => (un(E, a, l, !0) ? 1 : Math.max(T, T * e, C, C * e)),
  ...
  class Li extends Yt {
    ...
    update(t) {
      const e = this.chart,
        ...
        l = Math.min(EA(this.options.cutout, a), 1),
        c = this._getRingWeight(this.index),
        { circumference: h, rotation: d } = this._getRotationExtents(),
        { ratioX: u, ratioY: p, offsetX: f, offsetY: b } = wk(d, h, l),
        v = (s.width - r) / u,
        y = (s.height - r) / p,
        x = Math.max(Math.min(v, y) / 2, 0),
        E = Fu(this.options.radius, x),
        T = Math.max(E * l, 0),
        C = (E - T) / this._getVisibleDatasetWeightTotal();
      (this.offsetX = f * E),
        (this.offsetY = b * E),
        (n.total = this.calculateTotal()),
        (this.outerRadius = E - C * this._getRingWeightOffset(this.index)),
    ...
    updateElements(t, e, s, n) {
      ...
      for (x = e; x < e + s; ++x) {
        const E = this._circumference(x, o),
          T = t[x],
          C = {
            x: h + this.offsetX,
            y: d + this.offsetY,
        ...
        v &&
          (C.options =
            b || this.resolveDataElementOptions(x, T.active ? "active" : n)),
          (y += E),
          this.updateElement(T, x, C, n);
      }
    }
    calculateTotal() {
      const t = this._cachedMeta,
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta,
        s = this.chart,
        n = s.data.labels || [],
        o = vn(e._parsed[t], s.options.locale);
  ...
  class En extends Yt {
    ...
    updateElements(t, e, s, n) {
      const o = n === "reset",
        ...
        v = _s(f) ? f : Number.POSITIVE_INFINITY,
      ...
      for (let E = e; E < e + s; ++E) {
        const T = t[E],
          ...
          A = y ? T : {},
          w = H(C[p]),
          S = (A[u] = r.getPixelForValue(C[u], E)),
          k = (A[p] =
            o || w
              ? a.getBasePixel()
              : a.getPixelForValue(l ? this.applyStack(a, C, l) : C[p], E));
        (A.skip = isNaN(S) || isNaN(k) || w),
          (A.stop = E > 0 && Math.abs(C[u] - x[u]) > v),
          b && ((A.parsed = C), (A.raw = c.data[E])),
          d &&
            (A.options =
              h || this.resolveDataElementOptions(E, T.active ? "active" : n)),
          y || this.updateElement(T, E, A, n),
          (x = C);
      }
    }
    getMaxOverflow() {
  ...
  class Cn extends Yt {
    ...
    getLabelAndValue(t) {
      const e = this._cachedMeta,
        s = this.chart,
        n = s.data.labels || [],
        o = vn(e._parsed[t].r, s.options.locale);
      return { label: n[t] || "", value: o };
    }
    parseObjectData(t, e, s, n) {
      return Ep.bind(this)(t, e, s, n);
    }
    update(t) {
      const e = this._cachedMeta.data;
    ...
    updateElements(t, e, s, n) {
      ...
      for (f = e; f < e + s; f++) {
        const v = t[f];
        let y = p,
          x = p + this._computeAngle(f, n, b),
          E = r.getDataVisibility(f)
            ? c.getDistanceFromCenterForValue(this.getParsed(f).r)
            : 0;
        (p = x),
          o && (l.animateScale && (E = 0), l.animateRotate && (y = x = u));
        const T = {
          x: h,
          y: d,
          innerRadius: 0,
    ...
    _computeAngle(t, e, s) {
      return this.chart.getDataVisibility(t)
        ? ee(this.resolveDataElementOptions(t, e).angle || s)
        : 0;
    }
  }
  (Cn.id = "polarArea"),
  ...
  W.set("scale", {
    ...
    W.route("scale.ticks", "color", "", "color"),
    W.route("scale.grid", "color", "", "borderColor"),
    W.route("scale.grid", "borderColor", "", "borderColor"),
    W.route("scale.title", "color", "", "color"),
    W.describe("scale", {
      _fallback: !1,
      _scriptable: (i) =>
        !i.startsWith("before") &&
    ...
    W.describe("scales", { _fallback: "scale" }),
    W.describe("scale.ticks", {
      _scriptable: (i) => i !== "backdropPadding" && i !== "callback",
      _indexable: (i) => i !== "backdropPadding",
    });
  function Sk(i, t) {
    const e = i.options.ticks,
      s = e.maxTicksLimit || Ok(i),
      n = e.major.enabled ? Ik(t) : [],
      o = n.length,
      r = n[0],
      a = n[o - 1],
      l = [];
    if (o > s) return Mk(t, l, n, o / s), l;
    const c = Dk(n, t, s);
    if (o > 0) {
      let h, d;
      const u = o > 1 ? Math.round((a - r) / (o - 1)) : null;
      for (fr(t, l, c, H(u) ? 0 : r - u, r), h = 0, d = o - 1; h < d; h++)
        fr(t, l, c, n[h], n[h + 1]);
      return fr(t, l, c, a, H(u) ? t.length : a + u), l;
    }
    return fr(t, l, c), l;
  }
  function Ok(i) {
  ...
  function fr(i, t, e, s, n) {
    const o = N(s, 0),
      r = Math.min(N(n, i.length), i.length);
    let a = 0,
      l,
      c,
      h;
  ...
  const $k = (i) => (i === "left" ? "right" : i === "right" ? "left" : i),
    Zp = (i, t, e) => (t === "top" || t === "left" ? i[t] + e : i[t] - e);
  function Qp(i, t) {
    const e = [],
      s = i.length / t,
      n = i.length;
  ...
  function Nk(i, t) {
    return ei(i, { scale: t, type: "scale" });
  }
  function Bk(i, t, e) {
    return ei(i, { tick: e, index: t, type: "tick" });
  }
  function Hk(i, t, e) {
    let s = gl(i);
    return ((e && t !== "right") || (!e && t === "right")) && (s = $k(s)), s;
  }
  function Fk(i, t, e, s) {
    ...
    if (i.isHorizontal()) {
      ...
      if (F(e)) {
        const y = Object.keys(e)[0],
          x = e[y];
        p = h[y].getPixelForValue(x) - v + t;
      } else
        e === "center"
          ? (p = (c.left + c.right) / 2 - v + t)
          : (p = Zp(i, e, t));
      (f = ft(s, r, n)), (d = e === "left" ? -nt : nt);
    }
  ...
  class ii extends jt {
    ...
    getUserBounds() {
      ...
      return (
        ...
        { min: Ft(t, s), max: Ft(e, n), minDefined: rt(t), maxDefined: rt(e) }
      );
    }
    getMinMax(t) {
      let {
    ...
    update(t, e, s) {
      ...
      this.beforeUpdate(),
        ...
        this._dataLimitsCached ||
          ...
          (this._range = vw(this, o, n)),
          (this._dataLimitsCached = !0)),
        this.beforeBuildTicks(),
        (this.ticks = this.buildTicks() || []),
        this.afterBuildTicks();
      const l = a < this.ticks.length;
      this._convertTicksToLabels(l ? Qp(this.ticks, a) : this.ticks),
        this.configure(),
    ...
    generateTickLabels(t) {
      ...
      let s, n, o;
      for (s = 0, n = t.length; s < n; s++)
        (o = t[s]), (o.label = G(e.callback, [o.value, s, t], this));
    }
    ...
    calculateLabelRotation() {
      ...
      const h = this._getLabelSizes(),
        d = h.widest.width,
        u = h.highest.height,
        p = ct(this.chart.width - d, 0, this.maxWidth);
      (a = t.offset ? this.maxWidth / s : p / (s - 1)),
        d + 6 > a &&
          ((a = p / (s - (t.offset ? 0.5 : 1))),
          (l =
            this.maxHeight -
            kn(t.grid) -
            e.padding -
            Jp(t.title, this.chart.options.font)),
          (c = Math.sqrt(d * d + u * u)),
          (r = pl(
            Math.min(
              Math.asin(ct((h.highest.height + 6) / a, -1, 1)),
              Math.asin(ct(l / c, -1, 1)) - Math.asin(ct(u / c, -1, 1))
            )
          )),
      ...
      if (r) {
        ...
        if (
          ...
          const {
            ...
            p = s.padding * 2,
            f = ee(this.labelRotation),
            b = Math.cos(f),
            v = Math.sin(f);
          if (a) {
            const y = s.mirror ? 0 : v * d.width + b * u.height;
            t.height = Math.min(this.maxHeight, t.height + y + p);
          } else {
            const y = s.mirror ? 0 : b * d.width + v * u.height;
    ...
    _calculatePadding(t, e, s, n) {
      ...
      if (this.isHorizontal()) {
        ...
        l
          ? c
            ? ((u = n * t.width), (p = s * e.height))
            : ((u = s * t.height), (p = n * e.width))
          : o === "start"
          ? (p = e.width)
          : o === "end"
          ? (u = t.width)
    ...
    _computeLabelSizes(t, e) {
      ...
      for (c = 0; c < e; ++c) {
        if (
          ...
          (y = ar(s, b.data, b.gc, y, u)), (x = v);
        else if (Q(u))
          for (h = 0, d = u.length; h < d; ++h)
            (E = u[h]),
              !H(E) && !Q(E) && ((y = ar(s, b.data, b.gc, y, E)), (x += v));
    ...
    getPixelForDecimal(t) {
      ...
      return $A(this._alignToPixels ? ki(this.chart, e, 0) : e);
    }
    ...
    getContext(t) {
      ...
      if (t >= 0 && t < e.length) {
        const s = e[t];
        return s.$context || (s.$context = Bk(this.getContext(), t, s));
      }
      return (
        this.$context || (this.$context = Nk(this.chart.getContext(), this))
      );
    }
    _tickSize() {
      const t = this.options.ticks,
        e = ee(this.labelRotation),
      ...
      if (r === "top")
        ...
        if (r === "center") y = v((t.top + t.bottom) / 2 + 0.5);
          ...
          const $ = Object.keys(r)[0],
            z = r[$];
          y = v(this.chart.scales[$].getPixelForValue(z));
        }
        (D = t.top), (I = t.bottom), (A = y + b), (S = A + d);
      } else if (e === "y") {
        ...
        (C = y - b), (w = C - d), (k = t.left), (O = t.right);
      }
      const R = N(n.ticks.maxTicksLimit, h),
        X = Math.max(1, Math.ceil(h / R));
      for (x = 0; x < h; x += X) {
        const $ = o.setContext(this.getContext(x)),
          z = $.lineWidth,
          j = $.color,
          Kt = $.borderDash || [],
          se = $.borderDashOffset,
          ...
          oi = $.tickColor,
          Ut = $.tickBorderDash || [],
          Ce = $.tickBorderDashOffset;
        (E = Rk(this, x, a)),
          E !== void 0 &&
            ((T = ki(s, E, z)),
            l ? (C = w = k = O = T) : (A = S = D = I = T),
            u.push({
              tx1: C,
              ty1: A,
              tx2: w,
    ...
    _computeLabelItems(t) {
      ...
      if (n === "top")
        ...
        if (n === "center") A = (t.top + t.bottom) / 2 + p;
          ...
          const $ = Object.keys(n)[0],
            z = n[$];
          A = this.chart.scales[$].getPixelForValue(z) + p;
        }
        ...
        if (n === "center") C = (t.left + t.right) / 2 - p;
          ...
          const $ = Object.keys(n)[0],
            z = n[$];
          C = this.chart.scales[$].getPixelForValue(z);
        }
        w = this._getYAxisLabelAlignment(u).textAlign;
      }
      e === "y" &&
        (l === "start" ? (R = "top") : l === "end" && (R = "bottom"));
      ...
      for (y = 0, x = a.length; y < x; ++y) {
        ...
        r
          ? ((C = S),
            w === "inner" &&
              (y === x - 1
                ? (ne = this.options.reverse ? "left" : "right")
                : y === 0
                ? (ne = this.options.reverse ? "right" : "left")
                : (ne = "center")),
            n === "top"
              ? c === "near" || b !== 0
                ? (I = -O * D + D / 2)
                : c === "center"
                ? (I = -X.highest.height / 2 - z * D + D)
                : (I = -X.highest.height + D / 2)
              : c === "near" || b !== 0
              ? (I = D / 2)
              : c === "center"
              ? (I = X.highest.height / 2 - z * D)
              : (I = X.highest.height - O * D),
            d && (I *= -1))
          : ((A = S), (I = ((1 - O) * D) / 2));
        let oi;
        if ($.showLabelBackdrop) {
          const Ut = ht($.backdropPadding),
            Ce = X.heights[y],
            Ae = X.widths[y];
          let Xt = A + I - Ut.top,
            Re = C - Ut.left;
    ...
    _getXAxisLabelAlignment() {
      ...
      if (-ee(this.labelRotation)) return t === "top" ? "left" : "right";
      let n = "center";
      return (
        e.align === "start"
          ? (n = "left")
    ...
    drawBorder() {
      ...
      let l, c, h, d;
      this.isHorizontal()
        ? ((l = ki(t, this.left, o) - o / 2),
          (c = ki(t, this.right, r) + r / 2),
          (h = d = a))
        : ((h = ki(t, this.top, o) - o / 2),
          (d = ki(t, this.bottom, r) + r / 2),
          (l = c = a)),
        e.save(),
    ...
    drawTitle() {
      ...
      e === "bottom" || e === "center" || F(e)
        ? ((l += r.bottom),
          Q(s.text) && (l += o.lineHeight * (s.text.length - 1)))
        : (l += r.top);
      const {
        titleX: c,
        titleY: h,
  ...
  class _r {
    ...
    register(t) {
      ...
      return (
        o in n ||
          ((n[o] = t),
          Wk(t, r, s),
          this.override && W.override(t.id, t.overrides)),
        r
      );
    }
    get(t) {
    ...
    unregister(t) {
      const e = this.items,
        ...
        n = this.scope;
      s in e && delete e[s],
        n && s in W[n] && (delete W[n][s], this.override && delete wi[s]);
    }
  }
  function Wk(i, t, e) {
    const s = ye(Object.create(null), [
      e ? W.get(e) : {},
      W.get(t),
      i.defaults,
    ]);
    W.set(t, s),
      i.defaultRoutes && Vk(t, i.defaultRoutes),
      i.descriptors && W.describe(t, i.descriptors);
  }
  function Vk(i, t) {
    Object.keys(t).forEach((e) => {
      const s = e.split("."),
  ...
  class Yk {
    constructor() {
      (this.controllers = new _r(Yt, "datasets", !0)),
        (this.elements = new _r(jt, "elements")),
        (this.plugins = new _r(Object, "plugins")),
        (this.scales = new _r(ii, "scales")),
  ...
  class Sn extends Yt {
    ...
    addElements() {
      ...
      !this.datasetElementType &&
        t &&
        (this.datasetElementType = ie.getElement("line")),
        super.addElements();
    }
    updateElements(t, e, s, n) {
      const o = n === "reset",
        ...
        y = _s(b) ? b : Number.POSITIVE_INFINITY,
      ...
      for (let T = e; T < e + s; ++T) {
        const C = t[T],
          ...
          w = x ? C : {},
          S = H(A[f]),
          k = (w[p] = r.getPixelForValue(A[p], T)),
          D = (w[f] =
            o || S
              ? a.getBasePixel()
              : a.getPixelForValue(l ? this.applyStack(a, A, l) : A[f], T));
        (w.skip = isNaN(k) || isNaN(D) || S),
          (w.stop = T > 0 && Math.abs(A[p] - E[p]) > y),
          v && ((w.parsed = A), (w.raw = c.data[T])),
          u &&
            (w.options =
              d || this.resolveDataElementOptions(T, C.active ? "active" : n)),
          x || this.updateElement(C, T, w, n),
          (E = A);
      }
  ...
  var tf = Object.freeze({
    ...
    BarController: xn,
    BubbleController: Tn,
    DoughnutController: Li,
    LineController: En,
    PolarAreaController: Cn,
    PieController: pr,
    RadarController: An,
    ScatterController: Sn,
  });
  function $i() {
    throw new Error(
  ...
  Pl.override = function (i) {
    Object.assign(Pl.prototype, i);
  };
  var ef = { _date: Pl };
  function jk(i, t, e, s) {
    ...
    if (a && t === a.axis && t !== "r" && r && o.length) {
      const l = a._reversePixels ? RA : De;
      if (s) {
        if (n._sharedOptions) {
          const c = o[0],
  ...
  function Uk(i, t, e, s) {
    ...
    function o(r, a, l) {
      const { startAngle: c, endAngle: h } = r.getProps(
        ...
        { angle: d } = Xu(r, { x: t.x, y: t.y });
      un(d, c, h) && n.push({ element: r, datasetIndex: a, index: l });
    }
    return On(i, e, t, o), n;
  }
  function Xk(i, t, e, s, n, o) {
    let r = [];
    const a = Kk(e);
    ...
    function c(h, d, u) {
      ...
      if (!(!!o || i.isPointInArea(f)) && !p) return;
      const v = a(t, f);
      v < l
    ...
    modes: {
      index(i, t, e, s) {
        const n = Ii(t, i),
          ...
          a = e.intersect ? Nl(i, n, o, s, r) : Bl(i, n, o, !1, s, r),
          l = [];
        return a.length
      ...
      dataset(i, t, e, s) {
        const n = Ii(t, i),
          o = e.axis || "xy",
          r = e.includeInvisible || !1;
        let a = e.intersect ? Nl(i, n, o, s, r) : Bl(i, n, o, !1, s, r);
        if (a.length > 0) {
      ...
      nearest(i, t, e, s) {
        const n = Ii(t, i),
          o = e.axis || "xy",
          r = e.includeInvisible || !1;
        return Bl(i, n, o, e.intersect, s, r);
      },
      x(i, t, e, s) {
        const n = Ii(t, i);
        return sf(i, n, "x", e.intersect, s);
      },
      y(i, t, e, s) {
        const n = Ii(t, i);
        return sf(i, n, "y", e.intersect, s);
      },
    },
  };
  const of = ["left", "top", "right", "bottom"];
  function Dn(i, t) {
    return i.filter((e) => e.pos === t);
  }
  function rf(i, t) {
    return i.filter((e) => of.indexOf(e.pos) === -1 && e.box.axis === t);
  }
  function In(i, t) {
    return i.sort((e, s) => {
      const n = t ? s : e,
  ...
  function Jk(i, t, e, s) {
    ...
    o.getPadding && lf(r, o.getPadding());
    const a = Math.max(0, t.outerWidth - af(r, i, "left", "right")),
      l = Math.max(0, t.outerHeight - af(r, i, "top", "bottom")),
      c = a !== i.w,
      h = l !== i.h;
    return (
      (i.w = a),
  ...
  function Mn(i, t, e, s) {
    ...
    for (o = 0, r = i.length, c = 0; o < r; ++o) {
      (a = i[o]),
        (l = a.box),
        l.update(a.width || t.w, a.height || t.h, eS(a.horizontal, t));
      const { same: d, other: u } = Jk(t, e, a, s);
      (c |= d && n.length), (h = h || u), l.fullSize || n.push(a);
    }
    return (c && Mn(n, t, e, s)) || h;
  }
  ...
  function cf(i, t, e, s) {
    ...
    for (const a of i) {
      ...
      if (a.horizontal) {
        const d = t.w * h,
          u = c.size || l.height;
        Wt(c.start) && (r = c.start),
          l.fullSize
            ? gr(l, n.left, r, e.outerWidth - n.right - n.left, u)
            : gr(l, t.left + c.placed, r, d, u),
          (c.start = r),
          (c.placed += d),
          (r = l.bottom);
      } else {
        const d = t.h * h,
          u = c.size || l.width;
        Wt(c.start) && (o = c.start),
          l.fullSize
            ? gr(l, o, n.top, u, e.outerHeight - n.bottom - n.top)
            : gr(l, o, t.top + c.placed, u, d),
          (c.start = o),
          (c.placed += d),
          (o = l.right);
      }
  ...
  var dt = {
    ...
    update(i, t, e, s) {
      if (!i) return;
      const n = ht(i.options.layout.padding),
      ...
      Mn(a.fullSize, p, d, f),
        Mn(l, p, d, f),
        Mn(c, p, d, f) && Mn(l, p, d, f),
        tS(p),
        cf(a.leftAndTop, p, d, f),
        (p.x += p.w),
        (p.y += p.h),
        cf(a.rightAndBottom, p, d, f),
        (i.chartArea = {
          left: p.left,
          top: p.top,
          right: p.left + p.w,
  ...
  const uf = Vw ? { passive: !0 } : !1;
  function nS(i, t, e) {
    i.addEventListener(t, e, uf);
  }
  function oS(i, t, e) {
    i.canvas.removeEventListener(t, e, uf);
  }
  function rS(i, t) {
    const e = iS[i.type] || i.type,
      { x: s, y: n } = Ii(i, t);
    return {
      type: e,
      chart: t,
  ...
  function aS(i, t, e) {
    const s = i.canvas,
      n = new MutationObserver((o) => {
        let r = !1;
        for (const a of o)
          (r = r || br(a.addedNodes, s)), (r = r && !br(a.removedNodes, s));
        r && e();
      });
  ...
  function lS(i, t, e) {
    const s = i.canvas,
      n = new MutationObserver((o) => {
        let r = !1;
        for (const a of o)
          (r = r || br(a.removedNodes, s)), (r = r && !br(a.addedNodes, s));
        r && e();
      });
    return n.observe(document, { childList: !0, subtree: !0 }), n;
  }
  ...
  function cS(i, t) {
    Ln.size || window.addEventListener("resize", ff), Ln.set(i, t);
  }
  function hS(i) {
    Ln.delete(i), Ln.size || window.removeEventListener("resize", ff);
  }
  function dS(i, t, e) {
    const s = i.canvas,
      n = s && Dl(s);
    ...
    return r.observe(n), cS(i, o), r;
  }
  function Fl(i, t, e) {
    e && e.disconnect(), t === "resize" && hS(i);
  }
  function uS(i, t, e) {
    const s = i.canvas,
      n = Ju(
  ...
  class _f extends Hl {
    acquireContext(t, e) {
      ...
      return s && s.canvas === t ? (sS(t, e), s) : null;
    }
    releaseContext(t) {
      const e = t.canvas;
      if (!e[mr]) return !1;
      const s = e[mr].initial;
    ...
    addEventListener(t, e, s) {
      ...
      const n = t.$proxies || (t.$proxies = {}),
        r = { attach: aS, detach: lS, resize: dS }[e] || uS;
      n[e] = r(t, e, s);
    }
    removeEventListener(t, e) {
      const s = t.$proxies || (t.$proxies = {}),
        n = s[e];
      if (!n) return;
      (({ attach: Fl, detach: Fl, resize: Fl })[e] || oS)(t, e, n),
        (s[e] = void 0);
    }
    getDevicePixelRatio() {
  ...
  class pS {
    ...
    _createDescriptors(t, e) {
      const s = t && t.config,
        n = N(s.options && s.options.plugins, {}),
        o = fS(s);
      return n === !1 && !e ? [] : gS(t, o, n, e);
    }
  ...
  function fS(i) {
    const t = {},
      e = [],
      s = Object.keys(ie.plugins.items);
    for (let o = 0; o < s.length; o++) e.push(ie.getPlugin(s[o]));
    const n = i.plugins || [];
  ...
  function gS(i, { plugins: t, localIds: e }, s, n) {
    const o = [],
      r = i.getContext();
    for (const a of t) {
      const l = a.id,
      ...
      c !== null &&
        o.push({
          plugin: a,
          options: mS(i.config, { plugin: a, local: e[l] }, c, r),
        });
    }
    return o;
  }
  function mS(i, { plugin: t, local: e }, s, n) {
  ...
  function Vl(i, t) {
    return i === "x" || i === "y"
      ? i
      : t.axis || yS(t.position) || i.charAt(0).toLowerCase();
  }
  function xS(i, t) {
    const e = wi[i.type] || { scales: {} },
      s = t.scales || {},
      n = Wl(i.type, t),
    ...
    return (
      Object.keys(s).forEach((a) => {
        ...
        const c = Vl(a, l),
          ...
          d = e.scales || {};
        (o[c] = o[c] || a),
          (r[a] = cn(Object.create(null), [{ axis: c }, l, d[c], d[h]]));
      }),
      i.data.datasets.forEach((a) => {
        const l = a.type || i.type,
          c = a.indexAxis || Wl(l, t),
          d = (wi[l] || {}).scales || {};
        Object.keys(d).forEach((u) => {
          const p = bS(u, c),
            f = a[p + "AxisID"] || o[p] || p;
          (r[f] = r[f] || Object.create(null)),
            cn(r[f], [{ axis: p }, s[f], d[u]]);
        });
      }),
      Object.keys(r).forEach((a) => {
        const l = r[a];
        cn(l, [W.scales[l.type], W.scale]);
      }),
      r
    );
  }
  function mf(i) {
    ...
    (t.plugins = N(t.plugins, {})), (t.scales = xS(i, t));
  }
  function bf(i) {
    return (
      (i = i || {}),
  ...
  function TS(i) {
    return (i = i || {}), (i.data = bf(i.data)), mf(i), i;
  }
  const vf = new Map(),
    yf = new Set();
  function vr(i, t) {
    let e = vf.get(i);
    return e || ((e = t()), vf.set(i, e), yf.add(e)), e;
  }
  const $n = (i, t, e) => {
    const s = Ze(t, e);
    s !== void 0 && i.add(s);
  ...
  class ES {
    ...
    update() {
      ...
      this.clearCache(), mf(t);
    }
    clearCache() {
      this._scopeCache.clear(), this._resolverCache.clear();
    }
    datasetScopeKeys(t) {
      return vr(t, () => [[`datasets.${t}`, ""]]);
    }
    datasetAnimationScopeKeys(t, e) {
      return vr(`${t}.transition.${e}`, () => [
    ...
    getOptionScopes(t, e, s) {
      ...
      const l = new Set();
      e.forEach((h) => {
        t && (l.add(t), h.forEach((d) => $n(l, t, d))),
          h.forEach((d) => $n(l, n, d)),
          h.forEach((d) => $n(l, wi[o] || {}, d)),
          h.forEach((d) => $n(l, W, d)),
          h.forEach((d) => $n(l, El, d));
      });
    ...
    chartOptionScopes() {
      ...
      return [t, wi[e] || {}, W.datasets[e] || {}, { type: e }, W, El];
    }
    resolveNamedOptions(t, e, s, n = [""]) {
      const o = { $shared: !0 },
        { resolver: r, subPrefixes: a } = xf(this._resolverCache, t, n);
      let l = r;
      if (AS(r, e)) {
        (o.$shared = !1), (s = Qe(s) ? s() : s);
    ...
    createResolver(t, e, s = [""], n) {
      const { resolver: o } = xf(this._resolverCache, t, s);
      return F(e) ? ms(o, e, void 0, n) : o;
    }
  }
  function xf(i, t, e) {
    let s = i.get(t);
  ...
  const CS = (i) =>
    F(i) && Object.getOwnPropertyNames(i).reduce((t, e) => t || Qe(i[e]), !1);
  function AS(i, t) {
    const { isScriptable: e, isIndexable: s } = mp(i);
    for (const n of t) {
      const o = e(n),
        r = s(n),
        a = (r || o) && i[n];
      if ((o && (Qe(a) || CS(a))) || (r && Q(a))) return !0;
    }
    return !1;
  }
  var wS = "3.9.1";
  const kS = ["top", "bottom", "left", "right", "chartArea"];
  function Tf(i, t) {
    return i === "top" || i === "bottom" || (kS.indexOf(i) === -1 && t === "x");
  }
  function Ef(i, t) {
    return function (e, s) {
  ...
  function Cf(i) {
    ...
    t.notifyPlugins("afterRender"), G(e && e.onComplete, [i], t);
  }
  function SS(i) {
    const t = i.chart,
      e = t.options.animation;
    G(e && e.onProgress, [i], t);
  }
  function Af(i) {
    return (
      Ap() && typeof i == "string"
  ...
  class zl {
    constructor(t, e) {
      ...
      (this.platform = new (s.platform || gf(n))()),
      ...
      if (
        ...
        (this.scales = {}),
        (this._plugins = new pS()),
        (this.$proxies = {}),
        (this._hiddenIndices = {}),
        (this.attached = !1),
        (this._animationsDisabled = void 0),
        (this.$context = void 0),
        (this._doResize = BA((d) => this.update(d), r.resizeDelay || 0)),
        (this._dataChanges = []),
        (yr[this.id] = this),
        !a || !l)
      ) {
      ...
      Te.listen(this, "complete", Cf),
        Te.listen(this, "progress", SS),
        this._initialize(),
    ...
    _initialize() {
      return (
        ...
        this.options.responsive
          ? this.resize()
          : wp(this, this.options.devicePixelRatio),
        this.bindEvents(),
      ...
      e &&
        ...
        U(o, (r) => {
          const a = r.options,
            ...
            c = Vl(l, a),
            h = N(a.type, r.dtype);
          (a.position === void 0 || Tf(a.position, c) !== Tf(r.dposition)) &&
            (a.position = r.dposition),
            (n[l] = !0);
          let d = null;
          if (l in s && s[l].type === h) d = s[l];
          else {
            const u = ie.getScale(h);
    ...
    _updateMetasets() {
      ...
      this._sortedMetasets = t.slice(0).sort(Ef("order", "index"));
    }
    ...
    buildOrUpdateControllers() {
      ...
      for (
        ...
        if (
          ...
          (r.type = a),
          (r.indexAxis = o.indexAxis || Wl(a, this.options)),
          (r.order = o.order || 0),
          (r.index = s),
          (r.label = "" + o.label),
          ...
          const l = ie.getController(a),
            { datasetElementType: c, dataElementType: h } = W.datasets[a];
          Object.assign(l.prototype, {
            dataElementType: ie.getElement(h),
            datasetElementType: c && ie.getElement(c),
          }),
    ...
    _checkEventBindings() {
      const t = this.options,
        ...
        s = new Set(t.events);
      (!zu(e, s) || !!this._responsiveListeners !== t.responsive) &&
    ...
    _getUniformDataChanges() {
      ...
      const e = this.data.datasets.length,
        ...
        n = s(0);
      for (let o = 1; o < e; o++) if (!zu(n, s(o))) return;
      return Array.from(n)
        .map((o) => o.split(","))
    ...
    _updateDatasets(t) {
      if (
        ...
        for (let e = 0, s = this.data.datasets.length; e < s; ++e)
          this._updateDataset(e, Qe(t) ? t({ datasetIndex: e }) : t);
    ...
    _stop() {
      let t, e;
      for (
        this.stop(), Te.remove(this), t = 0, e = this.data.datasets.length;
        t < e;
        ++t
      )
  ...
  const kf = () => U(zl.instances, (i) => i._plugins.invalidate()),
    si = !0;
  Object.defineProperties(zl, {
    defaults: { enumerable: si, value: W },
    instances: { enumerable: si, value: yr },
    overrides: { enumerable: si, value: wi },
    registry: { enumerable: si, value: ie },
    version: { enumerable: si, value: wS },
    getChart: { enumerable: si, value: wf },
    register: {
      enumerable: si,
      value: (...i) => {
        ie.add(...i), kf();
  ...
  function Sf(i, t, e) {
    ...
    i.beginPath(),
      ...
      l > n
        ...
        : i.arc(o, r, n, e + nt, s - nt),
      i.closePath(),
      i.clip();
  }
  function IS(i) {
    return wl(i, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
  }
  function MS(i, t, e, s) {
    const n = IS(i.options.borderRadius),
      o = (e - t) / 2,
      r = Math.min(o, (s * t) / 2),
      a = (l) => {
  ...
  function Yl(i, t, e, s, n, o) {
    ...
    const b = Math.max(0.001, f * d - e / et) / d,
      v = (f - b) / 2,
      y = l + v + p,
      x = n - v - p,
      {
      ...
      X = x - A / I;
    if ((i.beginPath(), o)) {
      if ((i.arc(r, a, d, k, D), T > 0)) {
        const j = ys(S, D, r, a);
        i.arc(j.x, j.y, T, D, x + nt);
      }
      const $ = ys(I, x, r, a);
      if ((i.lineTo($.x, $.y), A > 0)) {
        const j = ys(I, X, r, a);
        i.arc(j.x, j.y, A, x + nt, X + Math.PI);
      }
      if ((i.arc(r, a, u, x - A / u, y + C / u, !0), C > 0)) {
        const j = ys(O, R, r, a);
        i.arc(j.x, j.y, C, R + Math.PI, y - nt);
      }
      const z = ys(w, y, r, a);
      if ((i.lineTo(z.x, z.y), E > 0)) {
        const j = ys(w, k, r, a);
        i.arc(j.x, j.y, E, y - nt, k);
      }
    } else {
      i.moveTo(r, a);
      const $ = Math.cos(k) * d + r,
        z = Math.sin(k) * d + a;
      i.lineTo($, z);
      const j = Math.cos(D) * d + r,
        Kt = Math.sin(D) * d + a;
      i.lineTo(j, Kt);
    }
    i.closePath();
  ...
  function LS(i, t, e, s, n) {
    ...
    return Yl(i, t, e, s, l, n), i.fill(), l;
  }
  function $S(i, t, e) {
    ...
    let h;
    for (
      e && Sf(i, t, o + q), i.beginPath(), i.arc(s, n, c, o + q, o, !0), h = 0;
      h < a;
      ++h
    )
      i.stroke();
  ...
  class xs extends jt {
    ...
    inRange(t, e, s) {
      const n = this.getProps(["x", "y"], s),
        { angle: o, distance: r } = Xu(n, { x: t, y: e }),
        {
          startAngle: a,
          endAngle: l,
          innerRadius: c,
    ...
    draw(t) {
      ...
      if (n) {
        ...
        t.translate(Math.cos(c) * a, Math.sin(c) * a),
          this.circumference >= et && (a = n);
      }
      (t.fillStyle = e.backgroundColor), (t.strokeStyle = e.borderColor);
      const l = LS(t, this, a, o, r);
      RS(t, this, a, o, l, r), t.restore();
    }
  }
  (xs.id = "arc"),
    (xs.defaults = {
    ...
    (xs.defaultRoutes = { backgroundColor: "backgroundColor" });
  function Of(i, t, e = t) {
  ...
  function BS(i, t, e, s) {
    const { points: n, options: o } = t,
      { count: r, start: a, loop: l, ilen: c } = Df(n, e, s),
      h = NS(o);
    ...
    for (p = 0; p <= c; ++p)
      (f = n[(a + (u ? c - p : p)) % r]),
        !f.skip &&
          (d ? (i.moveTo(f.x, f.y), (d = !1)) : h(i, b, f, u, o.stepped),
          (b = f));
    return l && ((f = n[(a + (u ? c : 0)) % r]), h(i, b, f, u, o.stepped)), !!l;
  }
  function HS(i, t, e, s) {
    const n = t.points,
      { count: o, start: r, ilen: a } = Df(n, e, s),
    ...
    const x = (T) => (r + (c ? a - T : T)) % o,
      E = () => {
        b !== v && (i.lineTo(h, v), i.lineTo(h, b), i.lineTo(h, y));
      };
    for (l && ((p = n[x(0)]), i.moveTo(p.x, p.y)), u = 0; u <= a; ++u) {
      if (((p = n[x(u)]), p.skip)) continue;
      const T = p.x,
        C = p.y,
        A = T | 0;
      A === f
        ? (C < b ? (b = C) : C > v && (v = C), (h = (d * h + T) / ++d))
        : (E(), i.lineTo(T, C), (f = A), (d = 0), (b = v = C)),
        (y = C);
    }
    E();
  }
  ...
  const zS = typeof Path2D == "function";
  function YS(i, t, e, s) {
    zS && !t.options.segment ? WS(i, t, e, s) : VS(i, t, e, s);
  }
  class Me extends jt {
    constructor(t) {
      super(),
    ...
    updateControlPoints(t, e) {
      ...
      if (
        ...
        Rw(this._points, s, t, n, e), (this._pointsUpdated = !0);
      }
    }
    set points(t) {
      (this._points = t),
    ...
    get segments() {
      return (
        this._segments || (this._segments = Zw(this, this.options.segment))
      );
    }
    first() {
    ...
    interpolate(t, e) {
      const s = this.options,
        n = t[e],
        o = this.points,
        r = $p(this, { property: e, start: n, end: n });
      if (!r.length) return;
      const a = [],
        l = FS(s);
      let c, h;
    ...
    draw(t, e, s, n) {
      ...
      (this.points || []).length &&
        o.borderWidth &&
        (t.save(), YS(t, this, s, n), t.restore()),
  ...
  class Ts extends jt {
    ...
    inXRange(t, e) {
      return If(this, t, "x", e);
    }
    inYRange(t, e) {
      return If(this, t, "y", e);
    }
    getCenterPoint(t) {
      const { x: e, y: s } = this.getProps(["x", "y"], t);
      return { x: e, y: s };
  ...
  function jS(i, t, e) {
    const s = i.options.borderWidth,
      ...
      o = gp(s);
    return {
      t: ni(n.top, o.top, 0, e),
      r: ni(n.right, o.right, 0, t),
      b: ni(n.bottom, o.bottom, 0, e),
      l: ni(n.left, o.left, 0, t),
    };
  }
  function KS(i, t, e) {
    const { enableBorderRadius: s } = i.getProps(["enableBorderRadius"]),
      ...
      l = s || F(n);
    return {
      topLeft: ni(!l || a.top || a.left, o.topLeft, 0, r),
      topRight: ni(!l || a.top || a.right, o.topRight, 0, r),
      bottomLeft: ni(!l || a.bottom || a.left, o.bottomLeft, 0, r),
      bottomRight: ni(!l || a.bottom || a.right, o.bottomRight, 0, r),
    };
  }
  function US(i) {
    const t = Mf(i),
  ...
  function Kl(i, t, e, s) {
    const n = t === null,
      o = e === null,
      a = i && !(n && o) && Mf(i, s);
    return a && (n || Oe(t, a.left, a.right)) && (o || Oe(e, a.top, a.bottom));
  }
  function XS(i) {
  ...
  class Es extends jt {
    ...
    inRange(t, e, s) {
      return Kl(this, t, e, s);
    }
    inXRange(t, e) {
      return Kl(this, t, null, e);
    }
    inYRange(t, e) {
      return Kl(this, null, t, e);
    }
    getCenterPoint(t) {
      const {
        x: e,
  ...
  function qS(i, t, e, s, n) {
    ...
    for (r[l++] = i[h], d = 0; d < o - 2; d++) {
      let v = 0,
        y = 0,
        x;
      const E = Math.floor((d + 1) * a) + 1 + t,
        T = Math.min(Math.floor((d + 2) * a) + 1, e) + t,
        C = T - E;
      for (x = E; x < T; x++) (v += i[x].x), (y += i[x].y);
      (v /= C), (y /= C);
      const A = Math.floor(d * a) + 1 + t,
        w = Math.min(Math.floor((d + 1) * a) + 1, e) + t,
        { x: S, y: k } = i[h];
      for (p = f = -1, x = A; x < w; x++)
        (f = 0.5 * Math.abs((S - v) * (i[x].y - k) - (S - i[x].x) * (y - k))),
          f > p && ((p = f), (u = i[x]), (b = x));
      (r[l++] = u), (h = b);
    }
    return (r[l++] = i[c]), r;
      ...
      if (C === h)
        ...
        if (!H(d) && !H(u)) {
          const w = Math.min(d, u),
            S = Math.max(d, u);
          w !== p && w !== A && v.push({ ...i[w], x: n }),
            S !== p && S !== A && v.push({ ...i[S], x: n });
        }
        r > 0 && A !== p && v.push(i[A]),
          v.push(a),
          (h = C),
  ...
  function QS(i, t) {
    ...
    return (
      l && (s = ct(De(t, o.axis, r).lo, 0, e - 1)),
      c ? (n = ct(De(t, o.axis, a).hi + 1, s, e) - s) : (n = e - s),
      { start: s, count: n }
    );
  }
  var Pf = {
  ...
  function JS(i, t, e) {
    ...
    for (const a of s) {
      ...
      const d = $p(t, h);
      for (const u of d) {
        const p = Xl(e, o[u.start], o[u.end], u.loop),
          f = Lp(a, n, p);
        for (const b of f)
          r.push({
            source: b,
            target: u,
            start: { [e]: Nf(h, p, "start", Math.max) },
            end: { [e]: Nf(h, p, "end", Math.min) },
          });
      }
    }
    return r;
  ...
  function Bf(i, t) {
    let e = [],
      s = !1;
    return (
      Q(i) ? ((s = !0), (e = i)) : (e = tO(i, t)),
      e.length
        ? new Me({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s })
        : null
    );
  }
  function Hf(i) {
  ...
  function aO(i) {
    const { scale: t, index: e, line: s } = i,
      ...
      r = s.points,
      a = lO(t, e);
    a.push(Bf({ x: null, y: t.bottom }, s));
    for (let l = 0; l < o.length; l++) {
      const c = o[l];
      for (let h = c.start; h <= c.end; h++) cO(n, r[h], a);
    }
    return new Me({ points: n, options: {} });
  }
  function lO(i, t) {
    const e = [],
  ...
  function cO(i, t, e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const o = e[n],
        { first: r, last: a, point: l } = hO(o, t, "x");
      if (!(!l || (r && a))) {
        if (r) s.unshift(l);
  ...
  function dO(i) {
    ...
    if (rt(e)) return uO(t, e);
    if (e === "stack") return aO(i);
    if (e === "shape") return !0;
    const n = pO(i);
    return n instanceof Ff ? n : Bf(n, s);
  }
  function uO(i, t) {
  ...
  function pO(i) {
    return (i.scale || {}).getPointPositionForValue ? _O(i) : fO(i);
  }
  function fO(i) {
  ...
  function gO(i, t) {
    ...
    i.save(),
      l === "x" &&
        o !== n &&
        (Wf(i, s, r.top),
        Vf(i, { line: e, target: s, color: n, scale: a, property: l }),
        i.restore(),
        i.save(),
        Wf(i, s, r.bottom)),
      Vf(i, { line: e, target: s, color: o, scale: a, property: l }),
      i.restore();
  }
  function Wf(i, t, e) {
  ...
  function Vf(i, t) {
    ...
    for (const { source: l, target: c, start: h, end: d } of a) {
      const { style: { backgroundColor: u = o } = {} } = l,
        p = s !== !0;
      i.save(), (i.fillStyle = u), mO(i, r, p && Xl(n, h, d)), i.beginPath();
      const f = !!e.pathSegment(i, l);
      let b;
      if (p) {
        f ? i.closePath() : zf(i, s, d, n);
        const v = !!s.pathSegment(i, c, { move: f, reverse: !0 });
        (b = f && v), b || zf(i, s, h, n);
      }
  ...
  var Yf = {
    ...
    afterDatasetsUpdate(i, t, e) {
      ...
      for (r = 0; r < s; ++r)
        (o = i.getDatasetMeta(r)),
          ...
          n.push(l);
      for (r = 0; r < s; ++r)
        (l = n[r]), !(!l || l.fill === !1) && (l.fill = eO(n, r, e.propagate));
    },
    beforeDraw(i, t, e) {
    ...
    beforeDatasetsDraw(i, t, e) {
      ...
      for (let n = s.length - 1; n >= 0; --n) {
        const o = s[n].$filler;
        Hf(o) && ql(i.ctx, o, i.chartArea);
      }
    },
    beforeDatasetDraw(i, t, e) {
      const s = t.meta.$filler;
      !Hf(s) || e.drawTime !== "beforeDatasetDraw" || ql(i.ctx, s, i.chartArea);
    },
  ...
  class Kf extends jt {
    ...
    fit() {
      ...
      const s = t.labels,
        ...
        { boxWidth: a, itemHeight: l } = jf(s, o);
      let c, h;
      (e.font = n.string),
        this.isHorizontal()
    ...
    _fitRows(t, e, s, n) {
      ...
      return (
        this.legendItems.forEach((f, b) => {
          const v = s + e / 2 + o.measureText(f.text).width;
    ...
    _fitCols(t, e, s, n) {
      ...
      return (
        this.legendItems.forEach((v, y) => {
          const x = s + e / 2 + o.measureText(v.text).width;
          y > 0 &&
            p + n + 2 * a > h &&
            ((d += u + a),
            ...
            b++,
            (u = p = 0)),
            (l[y] = { left: f, top: p, col: b, width: x, height: n }),
            (u = Math.max(u, x)),
            (p += n + a);
        }),
        (d += u),
    ...
    adjustHitBoxes() {
      ...
      const t = this._computeTitleHeight(),
        ...
        r = vs(o, this.left, this.width);
      if (this.isHorizontal()) {
        let a = 0,
          l = ft(s, this.left + n, this.right - this.lineWidths[a]);
        for (const c of e)
          a !== c.row &&
            ((a = c.row),
            (l = ft(s, this.left + n, this.right - this.lineWidths[a]))),
        ...
        let a = 0,
          l = ft(s, this.top + t + n, this.bottom - this.columnSizes[a].height);
        for (const c of e)
          c.col !== a &&
            ((a = c.col),
            (l = ft(
    ...
    _draw() {
      const { options: t, columnSizes: e, lineWidths: s, ctx: n } = this,
        { align: o, labels: r } = t,
        a = W.color,
        l = vs(t.rtl, this.left, this.width),
        c = lt(r.font),
        { color: h, padding: d } = r,
        u = c.size,
        p = u / 2;
      ...
      this.drawTitle(),
        ...
        (n.lineWidth = 0.5),
        (n.font = c.string);
      const { boxWidth: b, boxHeight: v, itemHeight: y } = jf(r, u),
        x = function (w, S, k) {
          if (isNaN(b) || b <= 0 || isNaN(v) || v < 0) return;
          n.save();
          const D = N(k.lineWidth, 1);
          if (
            ((n.fillStyle = N(k.fillStyle, a)),
            (n.lineCap = N(k.lineCap, "butt")),
            (n.lineDashOffset = N(k.lineDashOffset, 0)),
            (n.lineJoin = N(k.lineJoin, "miter")),
            (n.lineWidth = D),
            (n.strokeStyle = N(k.strokeStyle, a)),
            n.setLineDash(N(k.lineDash, [])),
            r.usePointStyle)
          ) {
            const O = {
              ...
              I = l.xPlus(w, b / 2),
              R = S + p;
            _p(n, O, I, R, r.pointStyleWidth && b);
          } else {
            const O = S + Math.max((u - v) / 2, 0),
              I = l.leftForLtr(w, b),
              R = Oi(k.borderRadius);
            n.beginPath(),
              Object.values(R).some((X) => X !== 0)
                ? bn(n, { x: I, y: O, w: b, h: v, radius: R })
                : n.rect(I, O, b, v),
              n.fill(),
              D !== 0 && n.stroke();
          }
      ...
      T
        ? (f = {
            x: ft(o, this.left + d, this.right - s[0]),
            y: this.top + d + C,
            line: 0,
          })
        : (f = {
            x: this.left + d,
            y: ft(o, this.top + C + d, this.bottom - e[0].height),
            line: 0,
          }),
        ...
        l.setWidth(this.width),
          T
            ? S > 0 &&
              ...
              ((R = f.y += A),
              f.line++,
              (I = f.x = ft(o, this.left + d, this.right - s[f.line])))
            : S > 0 &&
              R + A > this.bottom &&
              ((I = f.x = I + e[f.line].width + d),
              f.line++,
              (R = f.y =
                ft(o, this.top + C + d, this.bottom - e[f.line].height)));
        const X = l.x(I);
        x(X, R, w),
          (I = HA(D, I + b + p, T ? I + O : this.right, t.rtl)),
          E(l.x(I), R, w),
          T ? (f.x += O + d) : (f.y += A);
      }),
        Dp(this.ctx, t.textDirection);
    }
    drawTitle() {
      const t = this.options,
        e = t.title,
        ...
        n = ht(e.padding);
      if (!e.display) return;
      const o = vs(t.rtl, this.left, this.width),
        r = this.ctx,
        a = e.position,
        l = s.size / 2,
        c = n.top + l;
    ...
    _getLegendItemAt(t, e) {
      ...
      if (Oe(t, this.left, this.right) && Oe(e, this.top, this.bottom)) {
        for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
          if (
            ((n = o[s]),
            Oe(t, n.left, n.left + n.width) && Oe(e, n.top, n.top + n.height))
          )
    ...
    handleEvent(t) {
      ...
      if (t.type === "mousemove" || t.type === "mouseout") {
        ...
        n && !o && G(e.onLeave, [t, n, this], this),
          (this._hoveredItem = s),
          s && !o && G(e.onHover, [t, s, this], this);
      } else s && G(e.onClick, [t, s, this], this);
    }
  }
  function vO(i, t) {
    return !!(
  ...
  var Uf = {
    ...
    _element: Kf,
    start(i, t, e) {
      const s = (i.legend = new Kf({ ctx: i.ctx, options: e, chart: i }));
  ...
  class Zl extends jt {
    ...
    _drawArgs(t) {
      ...
      return (
        this.isHorizontal()
          ? ((h = ft(a, s, o)), (d = e + t), (c = o - s))
          : (r.position === "left"
              ? ((h = s + t), (d = ft(a, n, e)), (l = et * -0.5))
              : ((h = o - t), (d = ft(a, e, n)), (l = et * 0.5)),
            (c = n - e)),
  ...
  function yO(i, t) {
    const e = new Zl({ ctx: i.ctx, options: t, chart: i });
  ...
  var Gf = {
    id: "subtitle",
    start(i, t, e) {
      const s = new Zl({ ctx: i.ctx, options: e, chart: i });
      dt.configure(i, s, e), dt.addBox(i, s), xr.set(i, s);
    },
    stop(i) {
      dt.removeBox(i, xr.get(i)), xr.delete(i);
    },
    beforeUpdate(i, t, e) {
      const s = xr.get(i);
      dt.configure(i, s, e), (s.options = e);
...
`)
  ...
  function qf(i, t) {
    ...
    let b = f.height,
      v = 0,
      y = s.reduce(
        (T, C) => T + C.before.length + C.lines.length + C.after.length,
        0
      );
    if (
      ...
      b += p * T + (y - p) * l.lineHeight + (y - 1) * t.bodySpacing;
    }
    u &&
      (b += t.footerMarginTop + u * h.lineHeight + (u - 1) * t.footerSpacing);
    let x = 0;
    const E = function (T) {
      v = Math.max(v, e.measureText(T).width + x);
    };
    return (
      e.save(),
      (e.font = c.string),
      U(i.title, E),
      (e.font = l.string),
      U(i.beforeBody.concat(i.afterBody), E),
      (x = t.displayColors ? r + 2 + t.boxPadding : 0),
      U(s, (T) => {
        U(T.before, E), U(T.lines, E), U(T.after, E);
      }),
      (x = 0),
      (e.font = h.string),
      U(i.footer, E),
  ...
  function Zf(i, t, e) {
    const s = e.yAlign || t.yAlign || TO(i, e);
    return { xAlign: e.xAlign || t.xAlign || CO(i, t, e, s), yAlign: s };
  }
  function AO(i, t) {
    let { x: e, width: s } = i;
  ...
  function Qf(i, t, e, s) {
    const { caretSize: n, caretPadding: o, cornerRadius: r } = i,
      { xAlign: a, yAlign: l } = e,
      c = n + o,
      { topLeft: h, topRight: d, bottomLeft: u, bottomRight: p } = Oi(r);
    let f = AO(t, a);
    const b = wO(t, l, c);
    return (
      l === "center"
      ...
      { x: ct(f, 0, s.width - t.width), y: ct(b, 0, s.height - t.height) }
    );
  }
  function Tr(i, t, e) {
  ...
  function kO(i, t, e) {
    return ei(i, { tooltip: t, tooltipItems: e, type: "tooltip" });
  }
  function t_(i, t) {
    const e =
  ...
  class Ql extends jt {
    ...
    _resolveAnimations() {
      ...
      const e = this.chart,
        ...
        o = new Ml(this.chart, n);
      return n._cacheable && (this._cachedAnimations = Object.freeze(o)), o;
    }
    getContext() {
      return (
        this.$context ||
        (this.$context = kO(this.chart.getContext(), this, this._tooltipItems))
      );
    }
    getTitle(t, e) {
      const { callbacks: s } = e,
      ...
      let a = [];
      return (a = Ee(a, Le(n))), (a = Ee(a, Le(o))), (a = Ee(a, Le(r))), a;
    }
    getBeforeBody(t, e) {
      return Jf(e.callbacks.beforeBody.apply(this, [t]));
    }
    getBody(t, e) {
      const { callbacks: s } = e,
        n = [];
      return (
        U(t, (o) => {
          const r = { before: [], lines: [], after: [] },
            a = t_(s, o);
          Ee(r.before, Le(a.beforeLabel.call(this, o))),
            Ee(r.lines, a.label.call(this, o)),
            Ee(r.after, Le(a.afterLabel.call(this, o))),
            n.push(r);
        }),
        n
      );
    ...
    getAfterBody(t, e) {
      return Jf(e.callbacks.afterBody.apply(this, [t]));
    }
    getFooter(t, e) {
      const { callbacks: s } = e,
    ...
    update(t, e) {
      ...
      if (!n.length) this.opacity !== 0 && (o = { opacity: 0 });
        ...
        const a = Rn[s.position].call(this, n, this._eventPosition);
        ...
        const l = (this._size = qf(this, s)),
          c = Object.assign({}, a, l),
          h = Zf(this.chart, s, c),
          d = Qf(s, c, h, this.chart);
    ...
    getCaretPosition(t, e, s) {
      const { xAlign: n, yAlign: o } = this,
        ...
        { topLeft: l, topRight: c, bottomLeft: h, bottomRight: d } = Oi(a),
        { x: u, y: p } = t,
        { width: f, height: b } = e;
      let v, y, x, E, T, C;
      return (
        o === "center"
          ? ((T = p + b / 2),
            n === "left"
              ? ((v = u), (y = v - r), (E = T + r), (C = T - r))
              : ((v = u + f), (y = v + r), (E = T - r), (C = T + r)),
            (x = v))
          : (n === "left"
              ? (y = u + Math.max(l, h) + r)
              : n === "right"
              ...
              : (y = this.caretX),
            o === "top"
              ? ((E = p), (T = E - r), (v = y - r), (x = y + r))
              : ((E = p + b), (T = E + r), (v = y + r), (x = y - r)),
            (C = E)),
        { x1: v, x2: y, x3: x, y1: E, y2: T, y3: C }
      );
    }
    drawTitle(t, e, s) {
      const n = this.title,
    ...
    _drawColorBox(t, e, s, n, o) {
      ...
      if (o.usePointStyle) {
        ...
        const v = n.leftForLtr(p, c - h),
          ...
          x = Oi(r.borderRadius);
        Object.values(x).some((E) => E !== 0)
          ? (t.beginPath(),
            (t.fillStyle = o.multiKeyBackground),
            bn(t, { x: v, y: b, w: c, h: l, radius: x }),
            t.fill(),
            t.stroke(),
            (t.fillStyle = r.backgroundColor),
            t.beginPath(),
            bn(t, { x: y, y: b + 1, w: c - 2, h: l - 2, radius: x }),
            t.fill())
          : ((t.fillStyle = o.multiKeyBackground),
            t.fillRect(v, b, c, l),
    ...
    drawBody(t, e, s) {
      ...
      let u = d.lineHeight,
        p = 0;
      const f = vs(s.rtl, this.x, this.width),
        b = function (S) {
      ...
      for (
        ...
        for (
          y = n[T],
            x = this.labelTextColors[T],
            e.fillStyle = x,
            U(y.before, b),
            E = y.lines,
            a &&
              E.length &&
              (this._drawColorBox(e, t, T, f, s),
    ...
    _updateAnimationTarget(t) {
      const e = this.chart,
        ...
        o = s && s.y;
      if (n || o) {
        const r = Rn[t.position].call(this, this._active, this._eventPosition);
        if (!r) return;
        const a = (this._size = qf(this, t)),
  ...
  var e_ = {
      ...
      positioners: Rn,
      afterInit(i, t, e) {
        e && (i.tooltip = new Ql({ chart: i, options: e }));
      },
      beforeUpdate(i, t, e) {
  ...
  function OO(i, t, e, s) {
    const n = i.indexOf(t);
    if (n === -1) return SO(i, t, e, s);
    const o = i.lastIndexOf(t);
    return n !== o ? e : n;
  }
  const DO = (i, t) => (i === null ? null : ct(Math.round(i), 0, t));
  class Pn extends ii {
    constructor(t) {
      super(t),
    ...
    parse(t, e) {
      ...
      return (
        (e =
          isFinite(e) && s[e] === t ? e : OO(s, t, N(e, t), this._addedLabels)),
        DO(e, s.length - 1)
      );
    }
    determineDataLimits() {
  ...
  (Pn.id = "category"),
    (Pn.defaults = { ticks: { callback: Pn.prototype.getLabelForValue } });
  function IO(i, t) {
    const e = [],
      {
        bounds: n,
    ...
    let C = ju((v - b) / f / p) * p,
      ...
      S,
      k;
    if (C < 1e-14 && !y && !x) return [{ value: b }, { value: v }];
    (k = Math.ceil(v / C) - Math.floor(b / C)),
      ...
      n === "ticks"
        ...
        : ((w = b), (S = v)),
      y && x && o && MA((a - r) / o, C / 1e3)
        ? ((k = Math.round(Math.min((a - r) / C, h))),
          (C = (a - r) / k),
          (w = r),
          (S = a))
        : E
        ? ((w = y ? r : w), (S = x ? a : S), (k = c - 1), (C = (S - w) / k))
        : ((k = (S - w) / C),
          dn(k, Math.round(k), C / 1e3)
            ? (k = Math.round(k))
            : (k = Math.ceil(k)));
    const D = Math.max(Uu(C), Uu(w));
    ...
    for (
      ...
      (u && w !== r
        ? (e.push({ value: r }),
          w < r && O++,
          dn(Math.round((w + O * C) * A) / A, r, s_(r, T, i)) && O++)
        : w < r && O++);
      O < k;
      ++O
    )
      e.push({ value: Math.round((w + O * C) * A) / A });
    return (
      x && u && S !== a
        ? e.length && dn(e[e.length - 1].value, a, s_(a, T, i))
  ...
  function s_(i, t, { horizontal: e, minRotation: s }) {
    const n = ee(s),
  ...
  class Er extends ii {
    ...
    buildTicks() {
      ...
      const n = {
        ...
        r = IO(n, o);
      return (
        t.bounds === "ticks" && Ku(r, this, "value"),
        t.reverse
    ...
    getLabelForValue(t) {
      return vn(t, this.chart.options.locale, this.options.ticks.format);
    }
  }
  class Cr extends Er {
    determineDataLimits() {
    ...
    computeTickLimit() {
      const t = this.isHorizontal(),
        ...
        s = ee(this.options.ticks.minRotation),
  ...
  (Cr.id = "linear"),
    (Cr.defaults = { ticks: { callback: wn.formatters.numeric } });
  function n_(i) {
    return i / Math.pow(10, Math.floor(Vt(i))) === 1;
  }
  function MO(i, t) {
    const e = Math.floor(Vt(t.max)),
      s = Math.ceil(t.max / Math.pow(10, e)),
      n = [];
    let o = Ft(i.min, Math.pow(10, Math.floor(Vt(t.min)))),
      r = Math.floor(Vt(o)),
      a = Math.floor(o / Math.pow(10, r)),
      l = r < 0 ? Math.pow(10, Math.abs(r)) : 1;
    do
      n.push({ value: o, major: n_(o) }),
        ++a,
        a === 10 && ((a = 1), ++r, (l = r >= 0 ? 1 : l)),
        (o = Math.round(a * Math.pow(10, r) * l) / l);
    while (r < e || (r === e && a < s));
    const c = Ft(i.max, o);
    return n.push({ value: c, major: n_(o) }), n;
  }
  class Ar extends ii {
    constructor(t) {
      super(t),
    ...
    parse(t, e) {
      const s = Er.prototype.parse.apply(this, [t, e]);
      if (s === 0) {
        this._zero = !0;
        return;
      }
    ...
    handleTickRangeOptions() {
      ...
      const o = (l) => (s = t ? s : l),
        r = (l) => (n = e ? n : l),
        a = (l, c) => Math.pow(10, Math.floor(Vt(l)) + c);
    ...
    buildTicks() {
      const t = this.options,
        ...
        s = MO(e, this);
      return (
        t.bounds === "ticks" && Ku(s, this, "value"),
        t.reverse
    ...
    getLabelForValue(t) {
      return t === void 0
        ? "0"
        : vn(t, this.chart.options.locale, this.options.ticks.format);
    }
    configure() {
      const t = this.min;
      super.configure(),
      ...
      return (
        ...
        t === null || isNaN(t)
          ...
          : this.getPixelForDecimal(
              t === this.min ? 0 : (Vt(t) - this._startValue) / this._valueRange
            )
      );
    }
    getValueForPixel(t) {
  ...
  (Ar.id = "logarithmic"),
    (Ar.defaults = {
      ticks: { callback: wn.formatters.logarithmic, major: { enabled: !0 } },
    });
  function Jl(i) {
    const t = i.ticks;
    if (t.display && i.display) {
      const e = ht(t.backdropPadding);
      return N(t.font && t.font.size, W.font.size) + e.height;
    }
    return 0;
  }
  function LO(i, t, e) {
    return (
      (e = Q(e) ? e : [e]),
      { w: hw(i, t.string, e), h: e.length * t.lineHeight }
    );
  }
  ...
  function $O(i) {
    const t = {
      ...
      a = r.centerPointLabels ? et / o : 0;
    for (let l = 0; l < o; l++) {
      const c = r.setContext(i.getPointLabelContext(l));
      n[l] = c.padding;
      const h = i.getPointPosition(l, i.drawingArea + n[l], a),
        d = lt(c.font),
        u = LO(i.ctx, d, i._pointLabels[l]);
      s[l] = u;
      const p = Nt(i.getIndexAngle(l) + a),
        f = Math.round(pl(p)),
        b = o_(f, h.x, u.w, 0, 180),
        v = o_(f, h.y, u.h, 90, 270);
      RO(e, t, p, b, v);
    }
    i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b),
      (i._pointLabelItems = PO(i, s, n));
  }
  ...
  function PO(i, t, e) {
    const s = [],
      ...
      r = Jl(o) / 2,
      a = i.drawingArea,
      l = o.pointLabels.centerPointLabels ? et / n : 0;
    for (let c = 0; c < n; c++) {
      const h = i.getPointPosition(c, a + r + e[c], l),
        d = Math.round(pl(Nt(h.angle + nt))),
        u = t[c],
        p = HO(h.y, u.h, d),
        f = NO(d),
        b = BO(h.x, u.w, f);
  ...
  function FO(i, t) {
    ...
    for (let n = t - 1; n >= 0; n--) {
      const o = s.setContext(i.getPointLabelContext(n)),
        ...
        { backdropColor: f } = o;
      if (!H(f)) {
        const b = Oi(o.borderRadius),
          v = ht(o.backdropPadding);
        e.fillStyle = f;
        const y = h - v.left,
          x = d - v.top,
          E = u - h + v.width,
        ...
        Object.values(b).some((C) => C !== 0)
          ? (e.beginPath(),
            bn(e, { x: y, y: x, w: E, h: T, radius: b }),
            e.fill())
          : e.fillRect(y, x, E, T);
      }
      Si(e, i._pointLabels[n], a, l + r.lineHeight / 2, r, {
        color: o.color,
        textAlign: c,
        textBaseline: "middle",
      });
  ...
  function VO(i, t, e) {
    return ei(i, { label: e, index: t, type: "pointLabel" });
  }
  class Cs extends Er {
    constructor(t) {
      super(t),
    ...
    setDimensions() {
      const t = (this._padding = ht(Jl(this.options) / 2)),
    ...
    computeTickLimit() {
      return Math.ceil(this.drawingArea / Jl(this.options));
    }
    generateTickLabels(t) {
      Er.prototype.generateTickLabels.call(this, t),
        (this._pointLabels = this.getLabels()
          .map((e, s) => {
            const n = G(this.options.pointLabels.callback, [e, s], this);
            return n || n === 0 ? n : "";
          })
    ...
    drawGrid() {
      ...
      let r, a, l;
      if (
        (e.pointLabels.display && FO(this, o),
        n.display &&
    ...
    drawLabels() {
      ...
      t.save(),
        ...
        this.ticks.forEach((a, l) => {
          ...
          Si(t, a.label, 0, -o, h, { color: c.color });
        }),
        t.restore();
    }
    drawTitle() {}
  ...
  (Cs.id = "radialLinear"),
    ...
    (Cs.descriptors = { angleLines: { _fallback: "grid" } });
  const wr = {
  ...
  function a_(i, t) {
    ...
    return (
      ...
      rt(r) || (r = typeof s == "string" ? e.parse(r, s) : e.parse(r)),
      r === null
        ? null
        : (n &&
            (r =
  ...
  function YO(i, t, e, s, n) {
    for (let o = kt.length - 1; o >= kt.indexOf(e); o--) {
      const r = kt[o];
      if (wr[r].common && i._adapter.diff(n, s, r) >= t - 1) return r;
    }
    return kt[e ? kt.indexOf(e) : 0];
  }
  function jO(i) {
    for (let t = kt.indexOf(i) + 1, e = kt.length; t < e; ++t)
      if (wr[kt[t]].common) return kt[t];
  }
  function c_(i, t, e) {
    if (!e) i[t] = !0;
    else if (e.length) {
      const { lo: s, hi: n } = _l(e, t),
        o = e[s] >= t ? e[s] : e[n];
      i[o] = !0;
    }
  }
  ...
  class As extends ii {
    ...
    init(t, e) {
      const s = t.time || (t.time = {}),
        n = (this._adapter = new ef._date(t.adapters.date));
      n.init(e),
        cn(s.displayFormats, n.formats()),
        (this._parseOpts = {
          parser: s.parser,
          round: s.round,
    ...
    parse(t, e) {
      return t === void 0 ? null : a_(this, t);
    }
    beforeLayout() {
    ...
    determineDataLimits() {
      ...
      (!r || !a) &&
        ...
        (t.bounds !== "ticks" || t.ticks.source !== "labels") &&
          l(this.getMinMax(!1))),
        (n = rt(n) && !isNaN(n) ? n : +e.startOf(Date.now(), s)),
        (o = rt(o) && !isNaN(o) ? o : +e.endOf(Date.now(), s) + 1),
    ...
    buildTicks() {
      const t = this.options,
        ...
        s = t.ticks,
        n =
          s.source === "labels" ? this.getLabelTimestamps() : this._generate();
      t.bounds === "ticks" &&
        n.length &&
      ...
      return (
        (this._unit =
          e.unit ||
          (s.autoSkip
            ? l_(e.minUnit, this.min, this.max, this._getLabelCapacity(o))
            : YO(this, a.length, e.minUnit, this.min, this.max))),
        (this._majorUnit =
          !s.major.enabled || this._unit === "year" ? void 0 : jO(this._unit)),
        this.initOffsets(n),
        t.reverse && a.reverse(),
        h_(this, a, this._majorUnit)
      );
    }
    afterAutoSkip() {
    ...
    _generate() {
      const t = this._adapter,
        ...
        n = this.options,
        o = n.time,
        r = o.unit || l_(o.minUnit, e, s, this._getLabelCapacity(e)),
        a = N(o.stepSize, 1),
      ...
      for (u = d, p = 0; u < s; u = +t.add(u, a, r), p++) c_(h, u, f);
      return (
        (u === s || n.bounds === "ticks" || p === 1) && c_(h, u, f),
        Object.keys(h)
          .sort((b, v) => b - v)
          .map((b) => +b)
      );
    ...
    _getLabelSize(t) {
      const e = this.options.ticks,
        ...
        n = ee(this.isHorizontal() ? e.maxRotation : e.minRotation),
        o = Math.cos(n),
        r = Math.sin(n),
    ...
    _getLabelCapacity(t) {
      const e = this.options.time,
        ...
        o = this._tickFormatFunction(t, 0, h_(this, [t], this._majorUnit), n),
    ...
    getLabelTimestamps() {
      ...
      for (e = 0, s = n.length; e < s; ++e) t.push(a_(this, n[e]));
  ...
  function kr(i, t, e) {
    let s = 0,
      ...
      l;
    e
      ? (t >= i[s].pos && t <= i[n].pos && ({ lo: s, hi: n } = De(i, "pos", t)),
        ({ pos: o, time: a } = i[s]),
        ({ pos: r, time: l } = i[n]))
      : (t >= i[s].time &&
          t <= i[n].time &&
          ({ lo: s, hi: n } = De(i, "time", t)),
        ({ time: o, pos: a } = i[s]),
        ({ time: r, pos: l } = i[n]));
    const c = r - o;
  ...
  class Sr extends As {
    ...
    getValueForPixel(t) {
      const e = this._offsets,
        s = this.getDecimalForPixel(t) / e.factor - e.end;
      return kr(this._table, s * this._tableRange + this._minPos, !0);
    }
  }
  (Sr.id = "timeseries"), (Sr.defaults = As.defaults);
  var d_ = Object.freeze({
    __proto__: null,
    CategoryScale: Pn,
    LinearScale: Cr,
    LogarithmicScale: Ar,
    RadialLinearScale: Cs,
    TimeScale: As,
    TimeSeriesScale: Sr,
  });
...
`)
      ...
      textSize: function (i, t, e) {
        ...
        return (i.font = o), { height: n * e.lineHeight, width: r };
      },
      ...
      arrayDiff: function (i, t) {
        ...
        for (n = 0, r = t.length; n < r; ++n)
          (a = t[n]),
            (o = e.indexOf(a)),
            o === -1 ? s.push([a, 1]) : e.splice(o, 1);
        for (n = 0, r = e.length; n < r; ++n) s.push([e[n], -1]);
        return s;
      },
      rasterize: function (i) {
        return Math.round(i * u_) / u_;
      },
    };
  function tc(i, t) {
    var e = t.x,
  ...
  function Or(i, t, e) {
    var s = GO;
    return (
      i < e.left ? (s |= p_) : i > e.right && (s |= f_),
      t < e.top ? (s |= g_) : t > e.bottom && (s |= __),
      s
    );
  }
  function qO(i, t) {
    for (
      ...
      (l = r || a),
        l & g_
          ? ((c = e + ((n - e) * (t.top - s)) / (o - s)), (h = t.top))
          : l & __
          ? ((c = e + ((n - e) * (t.bottom - s)) / (o - s)), (h = t.bottom))
          : l & f_
          ? ((h = s + ((o - s) * (t.right - e)) / (n - e)), (c = t.right))
          : l & p_ &&
            ((h = s + ((o - s) * (t.left - e)) / (n - e)), (c = t.left)),
        l === r
          ? ((e = c), (s = h), (r = Or(e, s, t)))
          : ((n = c), (o = h), (a = Or(n, o, t)));
    return { x0: e, x1: n, y0: s, y1: o };
  }
  function Dr(i, t) {
    var e = t.anchor,
      s = i,
      ...
      o;
    return (
      t.clamp && (s = qO(s, t.area)),
      e === "start"
        ? ((n = s.x0), (o = s.y0))
        : e === "end"
        ? ((n = s.x1), (o = s.y1))
        : ((n = (s.x0 + s.x1) / 2), (o = (s.y0 + s.y1) / 2)),
      XO(n, o, i.vx, i.vy, t.align)
    );
  }
  var Ir = {
      arc: function (i, t) {
        var e = (i.startAngle + i.endAngle) / 2,
          s = Math.cos(e),
          n = Math.sin(e),
          o = i.innerRadius,
          r = i.outerRadius;
      ...
      point: function (i, t) {
        var e = tc(i, t.origin),
          s = e.x * i.options.radius,
          n = e.y * i.options.radius;
        return Dr(
          {
            x0: i.x - s,
            y0: i.y - n,
      ...
      bar: function (i, t) {
        ...
        return (
          i.horizontal
            ? ((s = Math.min(i.x, i.base)), (o = Math.abs(i.base - i.x)))
            : ((n = Math.min(i.y, i.base)), (r = Math.abs(i.base - i.y))),
          Dr({ x0: s, y0: n + r, x1: s + o, y1: n, vx: e.x, vy: e.y }, t)
        );
      },
  ...
  function tD(i, t, e, s, n, o) {
    ...
    if (o) {
      ...
      i.moveTo(t, c),
        l < h && c < d
          ? (i.arc(l, c, a, -Math.PI, -r),
            i.arc(h, c, a, -r, 0),
            i.arc(h, d, a, 0, r),
            i.arc(l, d, a, r, Math.PI))
          : l < h
          ? (i.moveTo(l, e),
            i.arc(h, c, a, -r, r),
            i.arc(l, c, a, r, Math.PI + r))
          : c < d
          ? (i.arc(l, c, a, -Math.PI, 0), i.arc(l, d, a, 0, Math.PI))
          : i.arc(l, c, a, -Math.PI, Math.PI),
        i.closePath(),
        i.moveTo(t, e);
    } else i.rect(t, e, s, n);
  }
    ...
    if (!(!l || (!r && !d)))
      for (
        e = iD(e, n, a),
          ...
          i.shadowBlur = s.textShadowBlur,
          i.shadowColor = s.textShadowColor,
          r && (i.fillStyle = o),
          d && ((i.lineJoin = "round"), (i.lineWidth = h), (i.strokeStyle = c)),
          u = 0,
          l = t.length;
        u < l;
        ++u
  ...
  ye(m_.prototype, {
    _modelize: function (i, t, e, s) {
      var n = this,
        o = n._index,
        r = lt(tt([e.font, {}], s, o)),
        a = tt([e.color, W.color], s, o);
      return {
        align: tt([e.align, "center"], s, o),
        anchor: tt([e.anchor, "center"], s, o),
        area: s.chart.chartArea,
        backgroundColor: tt([e.backgroundColor, null], s, o),
        borderColor: tt([e.borderColor, null], s, o),
        borderRadius: tt([e.borderRadius, 0], s, o),
        borderWidth: tt([e.borderWidth, 0], s, o),
        clamp: tt([e.clamp, !1], s, o),
        clip: tt([e.clip, !1], s, o),
        color: a,
        display: i,
        font: r,
        lines: t,
        offset: tt([e.offset, 4], s, o),
        opacity: tt([e.opacity, 1], s, o),
        origin: QO(n._el, s),
        padding: ht(tt([e.padding, 4], s, o)),
        positioner: JO(n._el),
        rotation: tt([e.rotation, 0], s, o) * (Math.PI / 180),
        size: Nn.textSize(n._ctx, t, r),
        textAlign: tt([e.textAlign, "start"], s, o),
        textShadowBlur: tt([e.textShadowBlur, 0], s, o),
        textShadowColor: tt([e.textShadowColor, a], s, o),
        textStrokeColor: tt([e.textStrokeColor, a], s, o),
        textStrokeWidth: tt([e.textStrokeWidth, 0], s, o),
      };
    },
    update: function (i) {
      var t = this,
        ...
        a,
        l,
        c = tt([o.display, !0], i, n);
      c &&
        ((r = i.dataset.data[n]),
        (a = N(G(o.formatter, [r, i]), r)),
        (l = H(a) ? [] : Nn.toTextLines(a)),
        l.length && ((e = t._modelize(c, l, o, i)), (s = ZO(e)))),
        (t._model = e),
        (t._rects = s);
    },
    geometry: function () {
    ...
    draw: function (i, t) {
      ...
      this.visible() &&
        ...
        n.clip &&
          ((r = n.area),
          s.beginPath(),
          s.rect(r.left, r.top, r.right - r.left, r.bottom - r.top),
          s.clip()),
        (s.globalAlpha = Nn.bound(0, n.opacity, 1)),
        s.translate($e(t.x), $e(t.y)),
        s.rotate(n.rotation),
        eD(s, o.frame, n),
        nD(s, n.lines, o.text, n),
        s.restore());
    },
  });
  var oD = Number.MIN_SAFE_INTEGER || -9007199254740991,
    rD = Number.MAX_SAFE_INTEGER || 9007199254740991;
  function Bn(i, t, e) {
    var s = Math.cos(e),
      n = Math.sin(e),
      o = t.x,
  ...
  function Mr(i, t) {
    var e = t.x - i.x,
      s = t.y - i.y,
      n = Math.sqrt(e * e + s * s);
    return { vx: (t.x - i.x) / n, vy: (t.y - i.y) / n, origin: i, ln: n };
  }
  var v_ = function () {
  ...
  ye(v_.prototype, {
    ...
    update: function (i, t, e) {
      (this._rotation = e),
        (this._rect = { x: t.x + i.x, y: t.y + i.y, w: t.w, h: t.h });
    },
    contains: function (i) {
      var t = this,
        e = 1,
    ...
    intersects: function (i) {
      var t = this._points(),
        e = i._points(),
        s = [Mr(t[0], t[1]), Mr(t[0], t[3])],
        n,
        o,
        r;
      for (
        this._rotation !== i._rotation &&
          s.push(Mr(e[0], e[1]), Mr(e[0], e[3])),
          n = 0;
        n < s.length;
        ++n
      )
        if (
          ((o = b_(t, s[n])), (r = b_(e, s[n])), o.max < r.min || r.max < o.min)
        )
          return !1;
      return !0;
    },
    _points: function () {
      ...
      return [
        Bn({ x: t.x, y: t.y }, s, e),
        Bn({ x: t.x + t.w, y: t.y }, s, e),
        Bn({ x: t.x + t.w, y: t.y + t.h }, s, e),
        Bn({ x: t.x, y: t.y + t.h }, s, e),
      ];
    },
  });
  function y_(i, t, e) {
    var s = t.positioner(i, t),
      n = s.vx,
      o = s.vy;
    if (!n && !o) return { x: s.x, y: s.y };
    var r = e.w,
      a = e.h,
      l = t.rotation,
  ...
  function lD(i) {
    ...
    for (t = 0, e = i.length; t < e; ++t)
      (s = i[t]),
        (n = s.$layout),
        n._visible &&
          ((a = new Proxy(s._el, { get: (l, c) => l.getProps([c], !0)[c] })),
          (o = s.geometry()),
          (r = y_(a, s.model(), o)),
          n._box.update(r, o, s.rotation()));
    return aD(i, function (l, c) {
      var h = l._hidable,
        d = c._hidable;
  ...
  function dD(i, t) {
    ...
    return e === !1
      ...
      : (e === !0 && (e = {}),
        ...
        r.length
          ? r.forEach(function (a) {
              o[a] && n.push(ye({}, [t, o[a], { _key: a }]));
            })
          : n.push(t),
        (s = n.reduce(function (a, l) {
          return (
            U(l.listeners || {}, function (c, h) {
              (a[h] = a[h] || {}), (a[h][l._key || x_] = c);
            }),
            delete l.listeners,
            a
          );
        }, {})),
        { labels: n, listeners: s });
  }
  function ec(i, t, e, s) {
    if (t) {
      var n = e.$context,
      ...
      t[o._set] &&
        ((r = t[o._set][o._key]),
        r && G(r, [n, s]) === !0 && ((i[St]._dirty = !0), e.update(n)));
    }
  }
  function uD(i, t, e, s, n) {
    var o, r;
    (!e && !s) ||
      (e ? (s ? e !== s && (r = o = !0) : (r = !0)) : (o = !0),
      r && ec(i, t.leave, e, n),
      o && ec(i, t.enter, s, n));
  }
  function pD(i, t) {
    var e = i[St],
      ...
      o;
    if (!(!s.enter && !s.leave)) {
      if (t.type === "mousemove") o = Hn.lookup(e._labels, t);
      else if (t.type !== "mouseout") return;
      (n = e._hovered), (e._hovered = o), uD(i, s, n, o, t);
    }
  }
  function fD(i, t) {
    var e = i[St],
      s = e._listeners.click,
      n = s && Hn.lookup(e._labels, t);
    n && ec(i, s, n, t);
  }
  var _D = {
    id: "datalabels",
    ...
    afterDatasetUpdate: function (i, t, e) {
      ...
      for (h.save(), d = 0, p = c.length; d < p; ++d)
        if (
          ((y = c[d]),
          (y[St] = []),
          r && y && i.getDataVisibility(d) && !y.skip)
        )
          for (u = 0, f = l.labels.length; u < f; ++u)
            (b = l.labels[u]),
              (v = b._key),
              (x = new m_(b, h, y, d)),
              (x.$groups = { _set: s, _key: v || x_ }),
              (x.$context = {
                active: !1,
                chart: i,
                dataIndex: d,
              ...
              o.push(x);
      h.restore(),
        ye(n._listeners, l.listeners, {
          merger: function (E, T, C) {
            (T[E] = T[E] || {}), (T[E][t.index] = C[E]), (n._listened = !0);
          },
        });
    },
    afterUpdate: function (i) {
      i[St]._labels = Hn.prepare(i[St]._datasets);
    },
    afterDatasetsDraw: function (i) {
      Hn.draw(i, i[St]._labels);
    },
    ...
    afterEvent: function (i) {
      var t = i[St],
        e = t._actives,
        s = (t._actives = i.getActiveElements()),
        n = Nn.arrayDiff(e, s),
        o,
        r,
        a,
      ...
      for (o = 0, r = n.length; o < r; ++o)
        if (((c = n[o]), c[1]))
          for (d = c[0].element[St] || [], a = 0, l = d.length; a < l; ++a)
            (h = d[a]), (h.$context.active = c[1] === 1), h.update(h.$context);
      (t._dirty || n.length) && (Hn.update(t._labels), i.render()),
        delete t._dirty;
    },
  };
  const gD = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: _D },
      Symbol.toStringTag,
      { value: "Module" }
    )
  );
